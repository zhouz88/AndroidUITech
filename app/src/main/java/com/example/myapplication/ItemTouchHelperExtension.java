...
public class ItemTouchHelperExtension extends RecyclerView.ItemDecoration
    ...
    private void closeOpenedPreItem() {
        ...
        final ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view, "translationX", view.getTranslationX(), 0f);
        objectAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                mRecoverAnimations.remove(objectAnimator);
            }
        });
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = 100;
            mMaxSwipeVelocity = 100;
            setupCallbacks();
