...
public class ActivityManager {
    ...
    @UnsupportedAppUsage(maxTargetSdk = VERSION_CODES.R, trackingBug = 170729553)
    @TestApi
     ...
     * apps targeting {@link VERSION_CODES#S} or higher will crash if they try to send such
     ...
     * it bumps its targetSdk to {@link VERSION_CODES#S} or higher.
     *
     * @hide
     */
    @TestApi
    ...
    public static class TaskDescription implements Parcelable {
        ...
        public static final @NonNull Creator<TaskDescription> CREATOR
    ...
    public static class RecentTaskInfo extends TaskInfo implements Parcelable {
         ...
         *
         * @deprecated As of {@link VERSION_CODES#Q}, use
         ...
         *
         * @deprecated As of {@link VERSION_CODES#Q}, currently always null.
         */
        @Deprecated
         ...
         *
         * @deprecated As of {@link VERSION_CODES#Q}, currently always 0.
         */
        @Deprecated
        ...
        public static final @NonNull Creator<RecentTaskInfo> CREATOR
        ...
        public void dump(PrintWriter pw, String indent) {
            ...
            if (taskDescription != null) {
                pw.print("   ");
                final TaskDescription td = taskDescription;
     ...
     * that have set their
     * {@link Intent#FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS} flag.
     */
     ...
     *
     * @deprecated As of {@link VERSION_CODES#LOLLIPOP}, this method is
    ...
    public static class RunningTaskInfo extends TaskInfo implements Parcelable {
        ...
        public static final @NonNull Creator<RunningTaskInfo> CREATOR = new Creator<RunningTaskInfo>() {
     ...
     */
    public int addAppTask(@NonNull android.app.Activity activity, @NonNull Intent intent,
     ...
     * purposes of control flow will be incorrect.</p>
     *
     * @deprecated As of {@link VERSION_CODES#LOLLIPOP}, this method
     ...
     * as per {@link Context#startActivity(Intent, Bundle)
    ...
    public static class RunningServiceInfo implements Parcelable {
        ...
        public static final @NonNull Creator<RunningServiceInfo> CREATOR = new Creator<RunningServiceInfo>() {
     ...
     *
     * @deprecated As of {@link VERSION_CODES#O}, this method
    ...
    public static class MemoryInfo implements Parcelable {
        ...
        public static final @NonNull Creator<MemoryInfo> CREATOR
    ...
    public static class ProcessErrorStateInfo implements Parcelable {
        ...
        public static final @NonNull Creator<ProcessErrorStateInfo> CREATOR =
     ...
     *
     * <p>As of {@link VERSION_CODES#TIRAMISU Android TIRAMISU}, for regular apps
    ...
    public static class RunningAppProcessInfo implements Parcelable {
        ...
        /**
         * @deprecated Pre-{@link VERSION_CODES#P} version of
         * {@link #IMPORTANCE_TOP_SLEEPING}.  As of Android
         * {@link VERSION_CODES#P}, this is considered much less
         ...
         * before {@link VERSION_CODES#O}.  Since the {@link VERSION_CODES#O} SDK,
         ...
         * on Android versions below {@link VERSION_CODES#O}.
         *
         * <p>On Android version {@link VERSION_CODES#O} and later, this value will still be
         * returned for apps with the target API level below {@link VERSION_CODES#O}.
         * For apps targeting version {@link VERSION_CODES#O} and later,
         ...
         * on Android versions below {@link VERSION_CODES#O}.
         *
         * <p>On Android version {@link VERSION_CODES#O} after, this value will still be
         * returned for apps with the target API level below {@link VERSION_CODES#O}.
         * For apps targeting version {@link VERSION_CODES#O} and later,
        ...
        public static final @NonNull Creator<RunningAppProcessInfo> CREATOR =
     ...
     * are complete.
     *
     * <p class="note"> Note: callback will not wait for {@link android.app.Activity#reportFullyDrawn} to occur.
     * Timestamp for fully drawn may be added after callback occurs. Set callback after invoking
     * {@link android.app.Activity#reportFullyDrawn} if timestamp for fully drawn is required.</p>
     *
     ...
     * with flag {@link Context#BIND_EXTERNAL_SERVICE}, the process of that external
     ...
     *                    {@link Manifest.permission#DUMP} in order to retrieve it.
     ...
     * {@link ApplicationExitInfo#getProcessStateSummary()
     ...
     * manner, excessive calls to this API could result a {@link RuntimeException}.
     * </p>
     *
     ...
     *
     * <p>The caller must hold the {@link Manifest.permission#PACKAGE_USAGE_STATS}
     * permission to use this feature.</p>
     *
     * @throws IllegalArgumentException If the listener is already registered.
     * @throws SecurityException If the caller does not hold
     * {@link Manifest.permission#PACKAGE_USAGE_STATS}.
     * @hide
     */
    @SystemApi
    @RequiresPermission(Manifest.permission.PACKAGE_USAGE_STATS)
     ...
     * a user-facing process management UI.</b></p>
     *
     * <p>As of {@link VERSION_CODES#Q Android Q}, for regular apps this method
     ...
     * Also of {@link VERSION_CODES#Q Android Q} the sample rate allowed
     ...
     * {@link Manifest.permission#FORCE_STOP_PACKAGES} to be able to
     * call this method.
     *
     ...
     * {@link Manifest.permission#INTERACT_ACROSS_USERS_FULL} to be able to run as a
     * different user than their current process; otherwise they must hold
     * {@link Manifest.permission#INTERACT_ACROSS_USERS}.
    ...
    public static void broadcastStickyIntent(Intent intent, int appOp, Bundle options, int userId) {
        try {
            getService().broadcastIntentWithFeature(
                    null, null, intent, null, null, android.app.Activity.RESULT_OK, null, null,
    ...
    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    @TestApi
    @RequiresPermission(Manifest.permission.SET_ACTIVITY_WATCHER)
     ...
     * {@link PackageManager#getHoldLockToken()}.
     * @hide
     */
    @TestApi
     ...
     */
    @SystemApi
    @RequiresPermission(Manifest.permission.LOG_FOREGROUND_RESOURCE_USE)
