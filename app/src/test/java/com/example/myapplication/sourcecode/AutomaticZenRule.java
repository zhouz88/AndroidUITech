...
public final class AutomaticZenRule implements Parcelable {
    ...
    public AutomaticZenRule(Parcel source) {
        ...
        conditionId = getTrimmedUri(source.readParcelable(null, Uri.class));
        owner = getTrimmedComponentName(
                source.readParcelable(null, ComponentName.class));
    ...
    public static final @NonNull Creator<AutomaticZenRule> CREATOR
