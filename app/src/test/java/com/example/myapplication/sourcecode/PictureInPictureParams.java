...
public final class PictureInPictureParams implements Parcelable {
    ...
    public static class Builder {
         ...
         * {@link android.app.Activity#getMaxNumPictureInPictureActions()} actions, then the input list
         ...
         * custom action must close the activity quickly using {@link android.app.Activity#finish()}.
         * Otherwise, the system will forcibly close the PiP as if no custom close action was
         * provided.
         *
         * If the action matches one set via {@link Builder#setActions(List)}
         ...
         * {@link android.app.Activity#enterPictureInPictureMode(PictureInPictureParams)}.
         *
         * If true, {@link android.app.Activity#onPictureInPictureRequested()} will never be called.
         *
         ...
         *
         * Setting a title via {@link Builder#setTitle(CharSequence)} should
         * be prioritized.
         *
     ...
     * @see Builder#setAspectRatio(Rational)
     */
    @Nullable
     ...
     *
     * @return aspect ratio as the desired width / height or {@code null} if not set.
     * @see Builder#setExpandedAspectRatio(Rational)
     */
    @Nullable
     ...
     * @see Builder#setCloseAction(RemoteAction)
     */
    @Nullable
     ...
     * @see Builder#setSourceRectHint(Rect)
     */
    @Nullable
     ...
     * picture-in-picture mode.
     * @see Builder#setAutoEnterEnabled(boolean)
     */
     ...
     * picture-in-picture mode.
     * @see Builder#setSeamlessResizeEnabled(boolean)
     */
    ...
    public static final @NonNull Creator<PictureInPictureParams> CREATOR =
