 ...
 *
 * <p>The following example adds a {@code RemoteInput} to a {@link android.app.Notification.Action},
...
public final class RemoteInput implements Parcelable {
    ...
    public static Bundle getResultsFromIntent(Intent intent) {
        ...
        return clipDataIntent.getExtras().getParcelable(EXTRA_RESULTS_DATA, Bundle.class);
    }
    ...
    public static final @NonNull Creator<RemoteInput> CREATOR = new Creator<RemoteInput>() {
        @Override
