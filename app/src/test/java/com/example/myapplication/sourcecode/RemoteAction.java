...
public final class RemoteAction implements Parcelable {
    ...
    RemoteAction(Parcel in) {
        ...
        mActionIntent = android.app.PendingIntent.CREATOR.createFromParcel(in);
        mEnabled = in.readBoolean();
        mShouldShowIcon = in.readBoolean();
    }

    public RemoteAction(@NonNull Icon icon, @NonNull CharSequence title,
            @NonNull CharSequence contentDescription, @NonNull android.app.PendingIntent intent) {
    ...
    public static final @NonNull Creator<RemoteAction> CREATOR =
