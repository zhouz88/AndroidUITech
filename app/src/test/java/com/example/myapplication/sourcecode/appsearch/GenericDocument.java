 ...
 *
 * <p>Documents contain structured data conforming to their {@link android.app.appsearch.AppSearchSchema} type. Each
 * document is uniquely identified by a namespace and a String ID within that namespace.
 *
 * <p>Documents are constructed by using the {@link Builder}.
 *
...
public class GenericDocument {
     ...
     * android.app.appsearch.AppSearchSchema.StringPropertyConfig#getIndexingType} value is anything other than {@link
     * android.app.appsearch.AppSearchSchema.StringPropertyConfig#INDEXING_TYPE_NONE}.
     */
    ...
    /** Returns the {@link android.app.appsearch.AppSearchSchema} type of the {@link GenericDocument}. */
    @NonNull
     ...
     * {@link GenericDocument} objects of the same {@link android.app.appsearch.AppSearchSchema} type.
     *
     * <p>Results may be sorted by score using {@link android.app.appsearch.SearchSpec.Builder#setRankingStrategy}.
    ...
    public Object getProperty(@NonNull String path) {
        ...
        Object rawValue =
                getRawPropertyFromRawDocument(new android.app.appsearch.PropertyPath(path), /*pathIndex=*/ 0, mBundle);
    ...
    public static class Builder<BuilderType extends Builder> {
         ...
         * @param schemaType the {@link android.app.appsearch.AppSearchSchema} type of the {@link GenericDocument}. The
        ...
        /**
         * Creates a new {@link Builder} from the given Bundle.
         *
         ...
         * android.app.appsearch.AppSearchSchema} object previously provided to {@link AppSearchSession#setSchema}.
         *
         * @hide
         */
        @CanIgnoreReturnValue
         ...
         *     property as given in {@link android.app.appsearch.AppSearchSchema.PropertyConfig#getName}.
