...
/** Exception thrown by {@link android.app.sdksandbox.SdkSandboxManager#requestSurfacePackage} */
public final class RequestSurfacePackageException extends Exception {

    private final @android.app.sdksandbox.SdkSandboxManager.RequestSurfacePackageErrorCode int
    ...
    public RequestSurfacePackageException(
            @android.app.sdksandbox.SdkSandboxManager.RequestSurfacePackageErrorCode int requestSurfacePackageErrorCode,
     ...
     *
     * @return The result code from {@link android.app.sdksandbox.SdkSandboxManager#requestSurfacePackage}
     */
