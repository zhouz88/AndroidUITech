...
public abstract class JobService extends Service {
     ...
     *
     * <p class="note">
     * Any {@link android.app.job.JobInfo.Builder#setUserInitiated(boolean) user-initiated job}
     ...
     *     extras configured with {@link android.app.job.JobInfo.Builder#setExtras(android.os.PersistableBundle)}.
     ...
     * @see android.app.job.JobInfo.Builder#setRequiredNetwork(android.net.NetworkRequest)
