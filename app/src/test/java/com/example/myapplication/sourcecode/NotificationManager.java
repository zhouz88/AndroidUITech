...
public class NotificationManager {
    ...
    /**
     * Intent that is broadcast when a {@link android.app.NotificationChannel} is blocked
     * (when {@link android.app.NotificationChannel#getImportance()} is {@link #IMPORTANCE_NONE}) or unblocked
     ...
     * {@link android.app.NotificationChannel} which has a new blocked state.
     *
     ...
     * of the {@link android.app.NotificationChannelGroup} which has a new blocked state.
     *
    ...
    /**
     * Intent that is broadcast when a {@link android.app.NotificationChannelGroup} is
     * {@link android.app.NotificationChannelGroup#isBlocked() blocked} or unblocked.
     *
    ...
    /**
     * Intent that is broadcast when the status of an {@link android.app.AutomaticZenRule} has changed.
     *
     ...
     * the {@link android.app.AutomaticZenRule}.
     *
     * <p>
     ...
     * {@link android.app.AutomaticZenRule} (see {@link #addAutomaticZenRule(android.app.AutomaticZenRule)}) that has
     * changed.
     */
     ...
     * provided, contains the id of the {@link android.app.AutomaticZenRule} (as returned from
     * {@link NotificationManager#addAutomaticZenRule(android.app.AutomaticZenRule)}) for which configuration
     ...
     * not be used with {@link Service#startForeground(int, android.app.Notification) Service.startForeground}
     ...
     *        application.
     * @param notification A {@link android.app.Notification} object describing what to show the user. Must not
     *        be null.
     */
     ...
     * @param notification A {@link android.app.Notification} object describing what to
     ...
     */
    @UnsupportedAppUsage
    public void notifyAsUser(String tag, int id, android.app.Notification notification, UserHandle user)
    {
        INotificationManager service = getService();
    ...
    private void fixLegacySmallIcon(android.app.Notification n, String pkg) {
     ...
     *  {@link Service#startForeground(int, android.app.Notification) foreground service} or a
     ...
     *                      {@link #notifyAsPackage(String, String, int, android.app.Notification).
     * @param tag A string identifier for this notification.  May be {@code null}.
     ...
     * <p>From Android {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, apps may not have
    ...
    /**
     * Creates a group container for {@link android.app.NotificationChannel} objects.
     *
     ...
     */
    public void createNotificationChannelGroup(@NonNull android.app.NotificationChannelGroup group) {
     ...
     */
    public void createNotificationChannelGroups(@NonNull List<android.app.NotificationChannelGroup> groups) {
        INotificationManager service = getService();
        try {
     ...
     *                 thrown.
     */
    public void createNotificationChannel(@NonNull android.app.NotificationChannel channel) {
     ...
     */
    public void createNotificationChannels(@NonNull List<android.app.NotificationChannel> channels) {
        INotificationManager service = getService();
        try {
     ...
     * package (see {@link Context#createPackageContext(String, int)}).</p>
     */
    public @Nullable android.app.NotificationChannel getNotificationChannel(@NonNull String channelId,
     ...
     */
    public List<android.app.NotificationChannelGroup> getNotificationChannelGroups() {
        INotificationManager service = getService();
        try {
    ...
    public void updateNotificationChannel(@NonNull String pkg, int uid,
            @NonNull android.app.NotificationChannel channel) {
        INotificationManager service = getService();
        try {
     ...
     * </p>
     */
    public @NonNull Policy getConsolidatedNotificationPolicy() {
        INotificationManager service = getService();
        try {
     ...
     */
    public Map<String, android.app.AutomaticZenRule> getAutomaticZenRules() {
        INotificationManager service = getService();
        try {
            List<ZenModeConfig.ZenRule> rules = service.getZenRules();
            Map<String, android.app.AutomaticZenRule> ruleMap = new HashMap<>();
            for (ZenModeConfig.ZenRule rule : rules) {
                android.app.AutomaticZenRule azr = new android.app.AutomaticZenRule(rule.name, rule.component,
     ...
     */
    public android.app.AutomaticZenRule getAutomaticZenRule(String id) {
        INotificationManager service = getService();
        try {
     ...
     */
    public String addAutomaticZenRule(android.app.AutomaticZenRule automaticZenRule) {
        INotificationManager service = getService();
        try {
     ...
     */
    public boolean updateAutomaticZenRule(String id, android.app.AutomaticZenRule automaticZenRule) {
        INotificationManager service = getService();
        try {
    ...
    /**
     * Informs the notification manager that the state of an {@link android.app.AutomaticZenRule} has changed.
     ...
     *
     * @see Builder#setBubbleMetadata(android.app.Notification.BubbleMetadata)
     */
     ...
     * long as the user hasn't excluded it ({@link android.app.NotificationChannel#canBubble()}).
     *
     * <p>
    ...
    public static class Policy implements Parcelable {
        ...
        /**
         * Whether {@link android.app.Notification#fullScreenIntent full screen intents} from
         * notifications intercepted by DND are blocked.
         */
        public static final int SUPPRESSED_EFFECT_FULL_SCREEN_INTENT = 1 << 2;

        /**
         * Whether {@link android.app.NotificationChannel#shouldShowLights() notification lights} from
         * notifications intercepted by DND are blocked.
         */
        ...
        public static final @NonNull Creator<Policy> CREATOR
                = new Creator<Policy>() {
            @Override
     ...
     * {@link NotificationManager#notifyAsPackage(String, String, int, android.app.Notification)}.
     * </p>
     *
