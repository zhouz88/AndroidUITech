package com.example.myapplication.sourcecode.assist;
...
public class AssistStructure implements Parcelable {
        ...
        void initializeFromParcelWithoutChildren(Parcel in, @Nullable PooledStringReader preader,
            ...
            if (autofillFlags != 0) {
                ...
                if ((autofillFlags & AUTOFILL_FLAGS_HAS_AUTOFILL_VALUE) != 0) {
                    mAutofillValue = in.readParcelable(null, AutofillValue.class);
                }
                ...
                if ((autofillFlags & AUTOFILL_FLAGS_HAS_HTML_INFO) != 0) {
                    mHtmlInfo = in.readParcelable(null, HtmlInfo.class);
                }
            ...
            if ((flags&FLAGS_HAS_LOCALE_LIST) != 0) {
                mLocaleList = in.readParcelable(null, LocaleList.class);
            }
    ...
    public static final class ViewNodeParcelable implements Parcelable {
        ...
        @NonNull
        public static final Creator<ViewNodeParcelable> CREATOR =
                new Creator<ViewNodeParcelable>() {
                    @Override
    ...
    private static final class HtmlInfoNode extends HtmlInfo implements Parcelable {
        ...
        public static final @NonNull Creator<HtmlInfoNode> CREATOR = new Creator<HtmlInfoNode>() {
            @Override
    ...
    public static final @NonNull Creator<AssistStructure> CREATOR
