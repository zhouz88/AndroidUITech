...
package com.example.myapplication.sourcecode.ambientcontext;
...
public final class AmbientContextEventRequest implements Parcelable {
    ...
    public static final @NonNull Creator<AmbientContextEventRequest> CREATOR =
            new Creator<AmbientContextEventRequest>() {
        @Override
