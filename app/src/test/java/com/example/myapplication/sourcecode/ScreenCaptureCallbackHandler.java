...
public class ScreenCaptureCallbackHandler {
    ...
    private final ArrayMap<android.app.Activity.ScreenCaptureCallback, ScreenCaptureRegistration>
    ...
    private static class ScreenCaptureRegistration {
        ...
        ScreenCaptureRegistration(Executor executor, android.app.Activity.ScreenCaptureCallback callback) {
    ...
    private static class ScreenCaptureObserver extends IScreenCaptureObserver.Stub {
        ArrayMap<android.app.Activity.ScreenCaptureCallback, ScreenCaptureRegistration> mRegistrations;

        ScreenCaptureObserver(
                ArrayMap<android.app.Activity.ScreenCaptureCallback, ScreenCaptureRegistration>
                        registrations) {
    ...
    public void registerScreenCaptureCallback(
            ...
            @NonNull android.app.Activity.ScreenCaptureCallback callback) {
