...
public final class NotificationChannelGroup implements Parcelable {
    ...
    private List<android.app.NotificationChannel> mChannels = new ArrayList();
     ...
     */
    public List<android.app.NotificationChannel> getChannels() {
        return mChannels;
    }

    /**
     * Returns whether or not notifications posted to {@link android.app.NotificationChannel channels} belonging
     * to this group are blocked. This value is independent of
     * {@link NotificationManager#areNotificationsEnabled()} and
     * {@link android.app.NotificationChannel#getImportance()}.
     */
     ...
     * @hide
     */
    public void addChannel(android.app.NotificationChannel channel) {
     ...
     * @hide
     */
    public void setChannels(List<android.app.NotificationChannel> channels) {
        mChannels = channels;
    }
