...
public class JobParameters implements Parcelable {
    ...
    /**
     * The job is in the {@link UsageStatsManager#STANDBY_BUCKET_RESTRICTED}
     * bucket.
     *
     * @hide
     */
     ...
     * object passed to {@link android.app.job.JobService#onStartJob(JobParameters)}.
     */
    public static final int STOP_REASON_UNDEFINED = 0;
    /**
     * The job was cancelled directly by the app, either by calling
     * {@link android.app.job.JobScheduler#cancel(int)}, {@link android.app.job.JobScheduler#cancelAll()}, or by scheduling a
     ...
     * {@link android.app.job.JobScheduler} and {@link android.app.job.JobInfo} for the execution time limits.
     */
    ...
    /**
     * @return The reason {@link android.app.job.JobService#onStopJob(JobParameters)} was called on this job. Will
     * be {@link #STOP_REASON_UNDEFINED} if {@link android.app.job.JobService#onStopJob(JobParameters)} has not
     * yet been called.
     */
    @StopReason
     ...
     * {@link android.app.job.JobInfo.Builder#setExtras(PersistableBundle)}. This will
     ...
     * {@link android.app.job.JobInfo.Builder#setTransientExtras(Bundle)}. This will
     * never be null. If you did not set any extras this will be an empty bundle.
     */
     ...
     *
     * @see android.app.job.JobInfo.Builder#setExpedited(boolean)
     */
     ...
     *
     * @see android.app.job.JobInfo.Builder#setUserInitiated(boolean)
     */
     ...
     * such as allowing a {@link android.app.job.JobInfo#NETWORK_TYPE_UNMETERED} job to run over
    ...
    /**
     * Dequeue the next pending {@link android.app.job.JobWorkItem} from these JobParameters associated with their
     ...
     * you should not call {@link android.app.job.JobService#jobFinished(JobParameters, boolean)} yourself
     * (otherwise you risk losing an upcoming JobWorkItem that is being enqueued at the same time).
     *
     * <p>Once you are done with the {@link android.app.job.JobWorkItem} returned by this method, you must call
     ...
     * {@link android.app.job.JobService#onStopJob(JobParameters)} in order to have the job rescheduled, and by
     ...
     *      service}
     *
     * @return Returns a new {@link android.app.job.JobWorkItem} if there is one pending, otherwise null.
     ...
     */
    public @Nullable android.app.job.JobWorkItem dequeueWork() {
        try {
    ...
    /**
     * Report the completion of executing a {@link android.app.job.JobWorkItem} previously returned by
