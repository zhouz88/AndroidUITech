...
public final class NotificationChannel implements Parcelable {
    ...
    private AudioAttributes mAudioAttributes = android.app.Notification.AUDIO_ATTRIBUTES_DEFAULT;
     ...
     * whether they appear in a redacted form. See e.g. {@link android.app.Notification#VISIBILITY_SECRET}.
     *
     * Only modifiable by the system and notification ranker.
     */
    ...
    private void populateFromXml(TypedXmlPullParser parser, boolean forRestore,
        ...
        setBypassDnd(android.app.Notification.PRIORITY_DEFAULT
                != safeInt(parser, ATT_PRIORITY, android.app.Notification.PRIORITY_DEFAULT));
    ...
    private void writeXml(TypedXmlSerializer out, boolean forBackup, @Nullable Context context)
        ...
        if (canBypassDnd()) {
            out.attributeInt(null, ATT_PRIORITY, android.app.Notification.PRIORITY_MAX);
        }
    ...
    public JSONObject toJson() throws JSONException {
        ...
        if (canBypassDnd()) {
            record.put(ATT_PRIORITY, android.app.Notification.PRIORITY_MAX);
        }
        if (getLockscreenVisibility() != DEFAULT_VISIBILITY) {
    ...
    public static final @NonNull Creator<NotificationChannel> CREATOR =
