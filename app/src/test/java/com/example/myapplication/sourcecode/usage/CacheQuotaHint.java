...
public final class CacheQuotaHint implements Parcelable {
    ...
    @Nullable public android.app.usage.UsageStats getUsageStats() {
        return mUsageStats;
    }
    ...
    public static final class Builder {
        ...
        public @NonNull Builder setUsageStats(@Nullable android.app.usage.UsageStats stats) {
            mUsageStats = stats;
            return this;
        }
    ...
    public static final @NonNull Creator<CacheQuotaHint> CREATOR =
            new Creator<CacheQuotaHint>() {
                ...
                public CacheQuotaHint createFromParcel(Parcel in) {
                    ...
                    return builder.setVolumeUuid(in.readString())
                            ...
                            .setUsageStats(in.readParcelable(UsageStats.class.getClassLoader(), UsageStats.class))
                            .build();
                }
