...
public abstract class FragmentManager {
     ...
     */
    public abstract void putFragment(Bundle bundle, String key, android.app.Fragment fragment);

    /**
     * Retrieve the current Fragment instance for a reference previously
     * placed with {@link #putFragment(Bundle, String, android.app.Fragment)}.
     *
     ...
     * the given reference.
     */
    public abstract android.app.Fragment getFragment(Bundle bundle, String key);
     ...
     */
    public abstract List<android.app.Fragment> getFragments();
     ...
     * that is it can't use {@link #putFragment(Bundle, String, android.app.Fragment)} to
     ...
     * {@link android.app.Fragment#getChildFragmentManager() child FragmentManager} will be called first
    ...
    public abstract static class FragmentLifecycleCallbacks {
        /**
         * Called right before the fragment's {@link android.app.Fragment#onAttach(Context)} method is called.
         ...
         */
        public void onFragmentPreAttached(FragmentManager fm, android.app.Fragment f, Context context) {}
         ...
         */
        public void onFragmentAttached(FragmentManager fm, android.app.Fragment f, Context context) {}

        /**
         * Called right before the fragment's {@link android.app.Fragment#onCreate(Bundle)} method is called.
         ...
         */
        public void onFragmentPreCreated(FragmentManager fm, android.app.Fragment f,
                Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link android.app.Fragment#onCreate(Bundle)}. This will only happen once for any given
         ...
         * @param savedInstanceState Saved instance bundle from a previous instance
         */
        public void onFragmentCreated(FragmentManager fm, android.app.Fragment f, Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link android.app.Fragment#onActivityCreated(Bundle)}. This will only happen once for any given
         * fragment instance, though the fragment may be attached and detached multiple times.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         * @param savedInstanceState Saved instance bundle from a previous instance
         */
        public void onFragmentActivityCreated(FragmentManager fm, android.app.Fragment f,
                Bundle savedInstanceState) {}

        /**
         * Called after the fragment has returned a non-null view from the FragmentManager's
         * request to {@link android.app.Fragment#onCreateView(LayoutInflater, ViewGroup, Bundle)}.
         *
         * @param fm Host FragmentManager
         ...
         * @param savedInstanceState Saved instance bundle from a previous instance
         */
        public void onFragmentViewCreated(FragmentManager fm, android.app.Fragment f, View v,
                                          Bundle savedInstanceState) {}
         ...
         * @param f Fragment changing state
         */
        public void onFragmentStarted(FragmentManager fm, android.app.Fragment f) {}
         ...
         * @param f Fragment changing state
         */
        public void onFragmentResumed(FragmentManager fm, android.app.Fragment f) {}
         ...
         * @param f Fragment changing state
         */
        public void onFragmentPaused(FragmentManager fm, android.app.Fragment f) {}
         ...
         * @param f Fragment changing state
         */
        public void onFragmentStopped(FragmentManager fm, android.app.Fragment f) {}
         ...
         */
        public void onFragmentSaveInstanceState(FragmentManager fm, android.app.Fragment f, Bundle outState) {}
         ...
         * @param f Fragment changing state
         */
        public void onFragmentViewDestroyed(FragmentManager fm, android.app.Fragment f) {}
        ...
        /**
         * Called after the fragment has returned from the FragmentManager's call to
         * {@link android.app.Fragment#onDetach()}.
         *
         * @param fm Host FragmentManager
         * @param f Fragment changing state
         */
        public void onFragmentDetached(FragmentManager fm, android.app.Fragment f) {}
    }
}
...
final class FragmentManagerState implements Parcelable {
    ...
    public static final @android.annotation.NonNull Creator<FragmentManagerState> CREATOR
...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    @UnsupportedAppUsage
    SparseArray<android.app.Fragment> mActive;
    @UnsupportedAppUsage
    final ArrayList<android.app.Fragment> mAdded = new ArrayList<>();
    ArrayList<BackStackRecord> mBackStack;
    ArrayList<android.app.Fragment> mCreatedMenus;
    
    // Must be accessed while locked.
    ArrayList<BackStackRecord> mBackStackIndices;
    ArrayList<Integer> mAvailBackStackIndices;

    ArrayList<android.app.FragmentManager.OnBackStackChangedListener> mBackStackChangeListeners;
    final CopyOnWriteArrayList<Pair<android.app.FragmentManager.FragmentLifecycleCallbacks, Boolean>>
    ...
    ArrayList<android.app.Fragment> mTmpAddedFragments;
    ...
    public void addOnBackStackChangedListener(android.app.FragmentManager.OnBackStackChangedListener listener) {
        if (mBackStackChangeListeners == null) {
            mBackStackChangeListeners = new ArrayList<android.app.FragmentManager.OnBackStackChangedListener>();
        }
    ...
    public List<android.app.Fragment> getFragments() {
        ...
        synchronized (mAdded) {
            return (List<android.app.Fragment>) mAdded.clone();
        }
    }
        ...
        if (mActive != null) {
            ...
            if (N > 0) {
                writer.print(prefix); writer.print("Active Fragments in ");
                        ...
                        writer.println(":");
                for (int i=0; i<N; i++) {
                    android.app.Fragment f = mActive.valueAt(i);
    ...
    Animator loadAnimator(android.app.Fragment fragment, int transit, boolean enter,
                          int transitionStyle) {
    ...
    void moveToState(android.app.Fragment f, int newState, int transit, int transitionStyle,
                     boolean keepActive) {
        ...
        if (f.mRemoving && newState > f.mState) {
            if (f.mState == android.app.Fragment.INITIALIZING && f.isInBackStack()) {
        ...
        if (f.mState <= newState) {
            ...
            switch (f.mState) {
                case android.app.Fragment.INITIALIZING:
                    if (newState > android.app.Fragment.INITIALIZING) {
                        ...
                        if (f.mTarget != null) {
                            ...
                            if (f.mTarget.mState < android.app.Fragment.CREATED) {
                                moveToState(f.mTarget, android.app.Fragment.CREATED, 0, 0, true);
                            }
                        }
    ...
    void ensureInflatedFragmentView(android.app.Fragment f) {
     ...
     * animations run during the {@link #showFragment(android.app.Fragment)} or {@link #hideFragment(android.app.Fragment)}
     * calls. After fragments are brought to their final state in
     * {@link #moveFragmentToExpectedState(android.app.Fragment)} the fragments that have been shown or
     ...
     */
    void completeShowHideFragment(final android.app.Fragment fragment) {
     ...
     */
    void moveFragmentToExpectedState(final android.app.Fragment f) {
        if (f == null) {
            return;
        }
        ...
        if (f.mRemoving) {
            if (f.isInBackStack()) {
                nextState = Math.min(nextState, android.app.Fragment.CREATED);
            } else {
                nextState = Math.min(nextState, android.app.Fragment.INITIALIZING);
            }
        }
        ...
        if (f.mView != null) {
            ...
            android.app.Fragment underFragment = findFragmentUnder(f);
     ...
     * {@link #completeShowHideFragment(android.app.Fragment)}.
     *
     ...
     * {@link android.app.Fragment#startPostponedEnterTransition()}
     */
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records,
        ...
        android.app.Fragment oldPrimaryNav = getPrimaryNavigationFragment();
        ...
        if (allowReordering) {
            ArraySet<android.app.Fragment> addedFragments = new ArraySet<>();
     ...
     */
    private void makeRemovedFragmentsInvisible(ArraySet<android.app.Fragment> fragments) {
        final int numAdded = fragments.size();
        for (int i = 0; i < numAdded; i++) {
            final android.app.Fragment fragment = fragments.valueAt(i);
            if (!fragment.mAdded) {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> records,
            ArrayList<Boolean> isRecordPop, int startIndex, int endIndex,
            ArraySet<android.app.Fragment> added) {
        int postponeIndex = endIndex;
    ...
    private void completeExecute(BackStackRecord record, boolean isPop, boolean runTransitions,
        ...
        if (mActive != null) {
            ...
            for (int i = 0; i < numActive; i++) {
                ...
                android.app.Fragment fragment = mActive.valueAt(i);
     ...
     */
    private android.app.Fragment findFragmentUnder(android.app.Fragment f) {
        final ViewGroup container = f.mContainer;
        final View view = f.mView;
        ...
        for (int i = fragmentIndex - 1; i >= 0; i--) {
            android.app.Fragment underFragment = mAdded.get(i);
     ...
     * postponed with {@link android.app.Fragment#postponeEnterTransition()}. They will later be made
     * invisible by changing their transitionAlpha to 0 if they have been removed when postponed.
     */
    private void addAddedFragments(ArraySet<android.app.Fragment> added) {
        if (mCurState < android.app.Fragment.CREATED) {
            return;
        }
        // We want to leave the fragment in the started state
        final int state = Math.min(mCurState, android.app.Fragment.STARTED);
        final int numAdded = mAdded.size();
        for (int i = 0; i < numAdded; i++) {
            android.app.Fragment fragment = mAdded.get(i);
    ...
    private static void setRetaining(FragmentManagerNonConfig nonConfig) {
        ...
        List<android.app.Fragment> fragments = nonConfig.getFragments();
        if (fragments != null) {
    ...
    void saveNonConfig() {
        ArrayList<android.app.Fragment> fragments = null;
    ...
    Bundle saveFragmentBasicState(android.app.Fragment f) {
        Bundle result = null;
    ...
    void restoreAllState(Parcelable state, FragmentManagerNonConfig nonConfig) {
        ...
        if (nonConfig != null) {
            List<android.app.Fragment> nonConfigFragments = nonConfig.getFragments();
        ...
        for (int i=0; i<fms.mActive.length; i++) {
            ...
            if (fs != null) {
                ...
                android.app.Fragment f = fs.instantiate(mHost, mContainer, mParent, childNonConfig);
    ...
    public void dispatchCreate() {
        mStateSaved = false;
        dispatchMoveToState(android.app.Fragment.CREATED);
    }
    
    public void dispatchActivityCreated() {
        mStateSaved = false;
        dispatchMoveToState(android.app.Fragment.ACTIVITY_CREATED);
    }
    
    public void dispatchStart() {
        mStateSaved = false;
        dispatchMoveToState(android.app.Fragment.STARTED);
    }
    
    public void dispatchResume() {
        mStateSaved = false;
        dispatchMoveToState(android.app.Fragment.RESUMED);
    }
    ...
    public void dispatchStop() {
        dispatchMoveToState(android.app.Fragment.STOPPED);
    }
    ...
    public void dispatchDestroy() {
        mDestroyed = true;
        execPendingActions();
        dispatchMoveToState(android.app.Fragment.INITIALIZING);
        mHost = null;
        mContainer = null;
        mParent = null;
    }
    ...
    public boolean dispatchCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        boolean show = false;
        ArrayList<android.app.Fragment> newMenus = null;
        for (int i = 0; i < mAdded.size(); i++) {
            android.app.Fragment f = mAdded.get(i);
            if (f != null) {
                if (f.performCreateOptionsMenu(menu, inflater)) {
                    show = true;
                    if (newMenus == null) {
                        newMenus = new ArrayList<android.app.Fragment>();
                    }
                    newMenus.add(f);
                }
            }
    ...
    @SuppressWarnings("ReferenceEquality")
    public void setPrimaryNavigationFragment(android.app.Fragment f) {
    ...
    void dispatchOnFragmentPreAttached(android.app.Fragment f, Context context, boolean onlyRecursive) {
        if (mParent != null) {
        ...
        for (Pair<android.app.FragmentManager.FragmentLifecycleCallbacks, Boolean> p : mLifecycleCallbacks) {
    ...
    void dispatchOnFragmentAttached(android.app.Fragment f, Context context, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentPreCreated(android.app.Fragment f, Bundle savedInstanceState,
    ...
    void dispatchOnFragmentCreated(android.app.Fragment f, Bundle savedInstanceState, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentActivityCreated(android.app.Fragment f, Bundle savedInstanceState,
                                           boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentViewCreated(android.app.Fragment f, View v, Bundle savedInstanceState,
                                       boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentStarted(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentResumed(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentPaused(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentStopped(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentSaveInstanceState(android.app.Fragment f, Bundle outState, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentViewDestroyed(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentDestroyed(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentDetached(android.app.Fragment f, boolean onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        android.app.Fragment fragment = id != View.NO_ID ? findFragmentById(id) : null;
     ...
     * {@link android.app.Fragment#startPostponedEnterTransition()} is called or a transaction is started
     * that interacts with this one, based on interactions with the fragment container.
     */
    static class StartEnterTransitionListener
            implements android.app.Fragment.OnStartEnterTransitionListener {
        ...
        /**
         * Called from {@link android.app.Fragment#startPostponedEnterTransition()}, this decreases the
        ...
        /**
         * Called from {@link android.app.Fragment#
