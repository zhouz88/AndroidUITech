...
/**
 * A SliceItem is a single unit in the tree structure of a {@link android.app.slice.Slice}.
 *
 ...
 * are defined on {@link android.app.slice.Slice}.
 */
public final class SliceItem implements Parcelable {
    ...
    /**
     * A {@link SliceItem} that contains a {@link android.app.slice.Slice}
     */
     ...
     * item contains a {@link android.app.slice.Slice} that the action applies to.
     */
     ...
     * @hide
     */
    protected @android.app.slice.Slice.SliceHint
    String[] mHints;
     ...
     */
    public SliceItem(Object obj, @SliceType String format, String subType,
            @android.app.slice.Slice.SliceHint String[] hints) {
        mHints = hints;
        mFormat = format;
        mSubType = subType;
        mObj = obj;
     ...
     * @hide
     */
    public SliceItem(PendingIntent intent, android.app.slice.Slice slice, String format, String subType,
                     @android.app.slice.Slice.SliceHint String[] hints) {
     ...
     */
    public @NonNull @android.app.slice.Slice.SliceHint List<String> getHints() {
     ...
     * many {@link #FORMAT_TEXT} items, but only some of them may be {@link android.app.slice.Slice#SUBTYPE_MESSAGE}.
     * @see #getFormat()
     */
    ...
    public PendingIntent getAction() {
        return ((Pair<PendingIntent, android.app.slice.Slice>) mObj).first;
    }
    ...
    public android.app.slice.Slice getSlice() {
        if (FORMAT_ACTION.equals(getFormat())) {
            return ((Pair<PendingIntent, android.app.slice.Slice>) mObj).second;
        }
        return (android.app.slice.Slice) mObj;
    }
     ...
     */
    public boolean hasHint(@android.app.slice.Slice.SliceHint String hint) {
     ...
     * @hide
     */
    public boolean hasHints(@android.app.slice.Slice.SliceHint String[] hints) {
     ...
     * @hide
     */
    public boolean hasAnyHints(@android.app.slice.Slice.SliceHint String[] hints) {
    ...
    private static void writeObj(Parcel dest, int flags, Object obj, String type) {
        switch (getBaseType(type)) {
            ...
            case FORMAT_BUNDLE:
                ...
                break;
            case FORMAT_ACTION:
                ((Pair<PendingIntent, android.app.slice.Slice>) obj).first.writeToParcel(dest, flags);
                ((Pair<PendingIntent, android.app.slice.Slice>) obj).second.writeToParcel(dest, flags);
                break;
            case FORMAT_TEXT:
    ...
    private static Object readObj(String type, Parcel in) {
        switch (getBaseType(type)) {
            case FORMAT_SLICE:
                return android.app.slice.Slice.CREATOR.createFromParcel(in);
            case FORMAT_TEXT:
    ...
    public static final @NonNull Creator<SliceItem> CREATOR = new Creator<SliceItem>() {
        @Override
