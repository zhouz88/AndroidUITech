...
public final class BackupRestoreEventLogger {
     ...
     *
     * This method should be called from a {@link android.app.backup.BackupAgent} implementation during an ongoing
     * backup operation.
     *
     ...
     * increase the total count of items associated with this data type by {@code count}.
     *
     * This method should either be called from a {@link android.app.backup.BackupAgent} implementation during an
