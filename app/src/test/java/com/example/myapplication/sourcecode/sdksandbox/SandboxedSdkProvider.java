...
public abstract class SandboxedSdkProvider {
     ...
     * @return Returns a {@link android.app.sdksandbox.SandboxedSdk}, passed back to the client. The IBinder used to create
     *     the {@link android.app.sdksandbox.SandboxedSdk} object will be used by the client to call into the SDK.
     */
    public abstract @NonNull android.app.sdksandbox.SandboxedSdk onLoadSdk(@NonNull Bundle params) throws LoadSdkException;
    /**
