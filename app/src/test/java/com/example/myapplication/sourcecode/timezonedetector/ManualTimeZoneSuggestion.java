...
package com.example.myapplication.sourcecode.timezonedetector;
...
public final class ManualTimeZoneSuggestion implements Parcelable {
    ...
    private static ManualTimeZoneSuggestion createFromParcel(Parcel in) {
        ...
        ArrayList<String> debugInfo = (ArrayList<String>) in.readArrayList(null /* classLoader */, String.class);
