 ...
 * will also be given to the app. Apps should only return a {@link android.app.slice.Slice} with a
...
public final class SliceSpec implements Parcelable {
    ...
    public static final @NonNull Creator<SliceSpec> CREATOR = new Creator<SliceSpec>() {
        @Override
