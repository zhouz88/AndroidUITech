...
public class TaskStackBuilder {
     ...
     * {@link android.app.Activity#getParentActivityIntent() getParentActivityIntent()} method of the activity
    ...
    /**
     * Obtain a {@link android.app.PendingIntent} for launching the task constructed by this builder so far.
     *
     * @param requestCode Private request code for the sender
     * @param flags May be {@link android.app.PendingIntent#FLAG_ONE_SHOT},
     *              {@link android.app.PendingIntent#FLAG_NO_CREATE}, {@link android.app.PendingIntent#FLAG_CANCEL_CURRENT},
     *              {@link android.app.PendingIntent#FLAG_UPDATE_CURRENT}, or any of the flags supported by
     *              {@link Intent#fillIn(Intent, int)} to control which unspecified parts of the
     *              intent that can be supplied when the actual send happens.
     *
     * @return The obtained PendingIntent
     */
    public android.app.PendingIntent getPendingIntent(int requestCode, @android.app.PendingIntent.Flags int flags) {
    ...
    public android.app.PendingIntent getPendingIntent(int requestCode, @android.app.PendingIntent.Flags int flags,
        ...
        return android.app.PendingIntent.getActivities(mSourceContext, requestCode, getIntents(),
                flags, options);
    }
     ...
     */
    @SuppressWarnings("AndroidFrameworkPendingIntentMutability")
    public android.app.PendingIntent getPendingIntent(int requestCode, int flags, Bundle options,
                                                      UserHandle user) {
        if (mIntents.isEmpty()) {
            throw new IllegalStateException(
                    "No intents added to TaskStackBuilder; cannot getPendingIntent");
