...
/** The response class of {@link android.app.appsearch.AppSearchSession#setSchema} */
public class SetSchemaResponse {
     ...
     *
     * <ul>
     *   <li>{@link MigrationFailure} is generated in {@link android.app.appsearch.AppSearchSession} which will be the SDK
     ...
     * {@link android.app.appsearch.GenericDocument} but fail.
     *
     * <p>{@link MigrationFailure} contains the namespace, id and schemaType of the post-migrated
     * {@link android.app.appsearch.GenericDocument} and the error reason. Mostly it will be mismatch the schema it
     * migrated to.
     */
    @NonNull
     ...
     * was not present in the {@link android.app.appsearch.SetSchemaRequest} object provided in the {@link
     * android.app.appsearch.AppSearchSession#setSchema} call.
     *
     ...
     * android.app.appsearch.AppSearchSession#setSchema} call.
     *
     * <p>A "migrated" type is a schema type that has triggered a {@link android.app.appsearch.Migrator} instance to
     ...
     * android.app.appsearch.AppSearchSession#setSchema} call were incompatible with the pre-existing schema.
     *
    ...
    /**
     * The class represents a post-migrated {@link android.app.appsearch.GenericDocument} that failed to be saved by
    ...
    public static class MigrationFailure {
        ...
        public MigrationFailure(
                ...
                @NonNull android.app.appsearch.AppSearchResult<?> failedResult) {
            mBundle = new Bundle();
        ...
        /** Returns the namespace of the {@link android.app.appsearch.GenericDocument} that failed to be migrated. */
        @NonNull
        public String getNamespace() {
            return mBundle.getString(NAMESPACE_FIELD, /*defaultValue=*/ "");
        }

        /** Returns the id of the {@link android.app.appsearch.GenericDocument} that failed to be migrated. */
        @NonNull
        public String getDocumentId() {
            return mBundle.getString(DOCUMENT_ID_FIELD, /*defaultValue=*/ "");
        }

        /** Returns the schema type of the {@link android.app.appsearch.GenericDocument} that failed to be migrated. */
        @NonNull
        ...
        /**
         * Returns the {@link android.app.appsearch.AppSearchResult} that indicates why the post-migration {@link
         * GenericDocument} failed to be indexed.
         */
        @NonNull
        public android.app.appsearch.AppSearchResult<Void> getAppSearchResult() {
