...
public class FragmentController {
     ...
     * */
    public void attachHost(android.app.Fragment parent) {
     ...
     */
    @Deprecated
    public void restoreAllState(Parcelable state, List<android.app.Fragment> nonConfigList) {
     ...
     */
    @Deprecated
    public List<android.app.Fragment> retainNonConfig() {
     ...
     *
     * @see android.app.Fragment#onMultiWindowModeChanged
     ...
     *
     * @see android.app.Fragment#onPictureInPictureModeChanged
