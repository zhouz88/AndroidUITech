 ...
 */
package com.example.myapplication.sourcecode.prediction;
...
public final class AppPredictor {
     ...
     */
    public void unregisterPredictionUpdates(@NonNull Callback callback) {
        synchronized (mRegisteredCallbacks) {
    ...
    @GuardedBy("mRegisteredCallbacks")
    private void unregisterPredictionUpdatesLocked(@NonNull Callback callback) {
        if (mIsClosed.get()) {
            throw new IllegalStateException("This client has already been destroyed.");
        }
