 ...
 * {@link android.app.AppOpsManager.OnOpNotedCallback#onNoted(SyncNotedAppOp) two way binder call} or
 * when the app
 * {@link android.app.AppOpsManager.OnOpNotedCallback#onSelfNoted(SyncNotedAppOp) notes an app-op for
 * itself}.
 */
@Immutable
@DataClass(
...
public final class SyncNotedAppOp implements Parcelable {
    ...
    private final @IntRange(from = 0L, to = android.app.AppOpsManager._NUM_OP - 1) int mOpCode;
    ...
    public SyncNotedAppOp(int opMode, @IntRange(from = 0L) int opCode,
        ...
        com.android.internal.util.AnnotationValidations.validate(
                ...
                "from", 0,
                "to", android.app.AppOpsManager._NUM_OP - 1);
    ...
    public SyncNotedAppOp(@IntRange(from = 0L) int opCode, @Nullable String attributionTag) {
        this(android.app.AppOpsManager.MODE_IGNORED, opCode, attributionTag, ActivityThread
                .currentPackageName());
    }
    ...
    public SyncNotedAppOp(@IntRange(from = 0L) int opCode, @Nullable String attributionTag,
        ...
        this(android.app.AppOpsManager.MODE_IGNORED, opCode, attributionTag, packageName);
    }
    ...
    public @NonNull String getOp() {
        return android.app.AppOpsManager.opToPublicName(mOpCode);
    }
