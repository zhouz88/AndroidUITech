...
public final class ConversationChannel implements Parcelable {
    ...
    private List<android.app.people.ConversationStatus> mStatuses;
    ...
    public ConversationChannel(ShortcutInfo shortcutInfo, int uid,
            ...
            List<android.app.people.ConversationStatus> statuses) {
        mShortcutInfo = shortcutInfo;
        mUid = uid;
        mNotificationChannel = parentNotificationChannel;
        mNotificationChannelGroup = parentNotificationChannelGroup;
    ...
    public ConversationChannel(Parcel in) {
        mShortcutInfo = in.readParcelable(ShortcutInfo.class.getClassLoader(), ShortcutInfo.class);
        mUid = in.readInt();
        mNotificationChannel = in.readParcelable(NotificationChannel.class.getClassLoader(), NotificationChannel.class);
        mNotificationChannelGroup =
                in.readParcelable(NotificationChannelGroup.class.getClassLoader(), NotificationChannelGroup.class);
        mLastEventTimestamp = in.readLong();
        mHasActiveNotifications = in.readBoolean();
        mHasBirthdayToday = in.readBoolean();
        mStatuses = new ArrayList<>();
        in.readParcelableList(mStatuses, android.app.people.ConversationStatus.class.getClassLoader(), android.app.people.ConversationStatus.class);
    }
