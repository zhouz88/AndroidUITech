...
public class Fragment implements ComponentCallbacks2, OnCreateContextMenuListener {
    @UnsupportedAppUsage(maxTargetSdk = VERSION_CODES.P, trackingBug = 115609023)
     ...
     */
    final public android.app.Activity getActivity() {
     ...
     * <li> {@link #onAttach(android.app.Activity)} and {@link #onActivityCreated(Bundle)} <b>will</b>
     * still be called.
     * </ul>
     */
    ...
    /**
     * Call {@link android.app.Activity#startActivity(Intent)} from the fragment's
     * containing Activity.
     *
    ...
    /**
     * Call {@link android.app.Activity#startActivity(Intent, Bundle)} from the fragment's
     * containing Activity.
     *
     * @param intent The intent to start.
    ...
    /**
     * Call {@link android.app.Activity#startActivityForResult(Intent, int)} from the fragment's
     * containing Activity.
     */
    ...
    /**
     * Call {@link android.app.Activity#startActivityForResult(Intent, int, Bundle)} from the fragment's
     * containing Activity.
     */
    ...
    /**
     * @hide
     * Call {@link android.app.Activity#startActivityForResultAsUser(Intent, int, UserHandle)} from the
    ...
    void restoreChildFragmentState(@Nullable Bundle savedInstanceState, boolean provideNonConfig) {
        if (savedInstanceState != null) {
            Parcelable p = savedInstanceState.getParcelable(android.app.Activity.FRAGMENTS_TAG);
            if (p != null) {
                if (mChildFragmentManager == null) {
                    instantiateChildFragmentManager();
                }
     ...
     * {@link android.app.Activity#onPrepareOptionsMenu(Menu) Activity.onPrepareOptionsMenu}
     * for more information.
     *
