...
public class Notification implements Parcelable
{
     ...
     * @see Builder#setForegroundServiceBehavior(int)
     ...
     * {@link Builder#setBubbleMetadata(BubbleMetadata)} to
     ...
     * associated with a {@link MediaStyle} notification. This will show in the media
     ...
     * switcher of the media controls for a {@link MediaStyle} notification.
     * @hide
     */
    @TestApi
     ...
     * media controls output switcher chip, associated with a {@link MediaStyle}
     ...
     * to attach actions.
     * <p>
     * As of Android {@link Build.VERSION_CODES#S}, apps targeting API level {@link
     * Build.VERSION_CODES#S} or higher won't be able to start activities while
    ...
    public static class Action implements Parcelable {
        ...
        public static final class Builder {
             ...
             * <p>As of Android {@link Build.VERSION_CODES#N},
             ...
             * Construct a new builder for {@link Action} object.
             *
             * <p>As of Android {@link Build.VERSION_CODES#S}, apps targeting API level
             * {@link Build.VERSION_CODES#S} or higher won't be able to start activities
             ...
             *
             * <p>As of Android {@link Build.VERSION_CODES#N}, action button icons
             ...
             * device.
             *
             * <p>When the {@code title} is a {@link Spanned}, any colors set by a
        ...
        public static final @NonNull Creator<Action> CREATOR =
                new Creator<Action>() {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /**
             * Set a hint that this Action will launch an {@link android.app.Activity} directly, telling the
            ...
            /**
             * Get a hint that this Action will launch an {@link android.app.Activity} directly, telling the
             * platform that it can generate the appropriate transitions
    ...
    public void visitUris(@NonNull Consumer<Uri> visitor) {
        ...
        if (extras != null) {
            ...
            ArrayList<Person> people = extras.getParcelableArrayList(EXTRA_PEOPLE_LIST, Person.class);
     ...
     */
    public static final @NonNull Creator<Notification> CREATOR
     ...
     */
    public @NonNull List<Action> getContextualActions() {
    ...
    public static class Builder {
         ...
         * itself.
         *
         * <p>As of {@link Build.VERSION_CODES#HONEYCOMB}, if this field is unset and you
         ...
         * <p>
         * As of Android {@link Build.VERSION_CODES#S}, apps targeting API level
         * {@link Build.VERSION_CODES#S} or higher won't be able to start activities
         * while processing broadcast receivers or services in response to notification action
         * clicks. To launch an activity in those cases, provide a {@link PendingIntent} to the
         * activity itself.
         * <p>
         * As of Android {@link Build.VERSION_CODES#N},
         * action button icons will not be displayed on action buttons, but are still required
         * and are available to
         * {@link android.service.notification.NotificationListenerService notification listeners},
         * which may display them in other contexts, for example on a wearable device.
         ...
         */
        private @NonNull List<Action> getNonContextualActions() {
         ...
         */
        private @ColorInt int getStandardActionColor(StandardTemplateParams p) {
    ...
    void reduceImageSizes(Context context) {
        ...
        boolean isLowRam = android.app.ActivityManager.isLowRamDeviceStatic();
     ...
     *         {@link Builder#setForegroundServiceBehavior(int)
     ...
     *
     * <p>
     * If the app is targeting Android {@link Build.VERSION_CODES#P} and above, it is
     ...
     *
     * <p>
     * From Android {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, messaging style
     * notifications that are associated with a valid conversation shortcut
     * (via {@link Builder#setShortcutId(String)}) are displayed in a dedicated
    ...
    public static class MessagingStyle extends Style {
         ...
         * user. Any messages added with {@link #addMessage(Message)}
         ...
         * enforced starting in Android {@link Build.VERSION_CODES#P}.
         */
         ...
         * if a valid shortcutId is added via {@link Builder#setShortcutId(String)}.
         ...
         * {@link Builder#setLargeIcon(Bitmap)}, otherwise it will be hidden.
         *
     ...
     * {@link Builder#setStyle(android.app.Notification.Style)} like so:
     * <pre class="prettyprint">
     * Notification noti = new Notification.Builder()
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromExtras(Bundle extras) {
            ...
            mVerificationIcon = extras.getParcelable(EXTRA_VERIFICATION_ICON, Icon.class);
    ...
    public static final class BubbleMetadata implements Parcelable {
         ...
         *
         * @see Builder#setAutoExpandBubble(boolean)
         */
         ...
         *
         * @see Builder#setSuppressNotification(boolean)
         */
         ...
         *
         * @see Builder#setSuppressableBubble(boolean)
         */
        ...
        public void setSuppressNotification(boolean suppressed) {
            if (suppressed) {
                mFlags |= BubbleMetadata.FLAG_SUPPRESS_NOTIFICATION;
            } else {
                mFlags &= ~BubbleMetadata.FLAG_SUPPRESS_NOTIFICATION;
            }
        }
        ...
        public void setSuppressBubble(boolean suppressed) {
            if (suppressed) {
                mFlags |= BubbleMetadata.FLAG_SUPPRESS_BUBBLE;
            } else {
                mFlags &= ~BubbleMetadata.FLAG_SUPPRESS_BUBBLE;
            }
        }
        ...
        public static final @NonNull Creator<BubbleMetadata> CREATOR =
                new Creator<BubbleMetadata>() {
        ...
        public static final class Builder {
            ...
            /**
             * Creates a {@link Builder} based on a {@link ShortcutInfo}. To create
             ...
             * {@link android.app.Activity#isLaunchedFromBubble()} will return with {@code true}.
             * </p>
             *
            ...
            /**
             * Creates a {@link Builder} based on the provided intent and icon.
             *
            ...
            @NonNull
            @Deprecated
            public Builder createShortcutBubble(@NonNull String shortcutId) {
                if (!TextUtils.isEmpty(shortcutId)) {
            ...
            @NonNull
            @Deprecated
            public Builder createIntentBubble(@NonNull PendingIntent intent,
                    @NonNull Icon icon) {
                if (intent == null) {
             ...
             */
            @NonNull
            public Builder setDesiredHeight(@Dimension(unit = DP) int height) {
             ...
             * {@link android.app.Activity#setLocusContext(LocusId, Bundle)}
             */
            @NonNull
    ...
    public static final class WearableExtender implements Extender {
        ...
        /**
         * Set a hint that this notification's content intent will launch an {@link android.app.Activity}
