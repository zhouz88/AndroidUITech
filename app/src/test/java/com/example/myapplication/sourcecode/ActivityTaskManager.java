...
public class ActivityTaskManager {
    ...
    public static int getMaxRecentTasksStatic() {
        if (sMaxRecentTasks < 0) {
            return sMaxRecentTasks = android.app.ActivityManager.isLowRamDeviceStatic() ? 36 : 48;
        }
    ...
    public static boolean supportsMultiWindow(Context context) {
        ...
        return (!android.app.ActivityManager.isLowRamDeviceStatic() || isWatch)
     ...
     * @hide
     */
    public List<android.app.ActivityManager.RunningTaskInfo> getTasks(int maxNum) {
     ...
     * @hide
     */
    public List<android.app.ActivityManager.RunningTaskInfo> getTasks(
