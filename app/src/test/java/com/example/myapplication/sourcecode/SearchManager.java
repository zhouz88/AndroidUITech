...
public class SearchManager
     ...
     */
    public android.app.SearchableInfo getSearchableInfo(ComponentName componentName) {
        try {
     ...
     */
    @UnsupportedAppUsage
    public Cursor getSuggestions(android.app.SearchableInfo searchable, String query) {
     ...
     */
    @UnsupportedAppUsage
    public Cursor getSuggestions(android.app.SearchableInfo searchable, String query, int limit) {
        if (searchable == null) {
            return null;
        }
