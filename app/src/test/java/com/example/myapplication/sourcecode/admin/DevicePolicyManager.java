...
import android.app.admin.ProvisioningIntentHelper;
 ...
 *
 * <p><b>Note: </b>on
 * {@link PackageManager#FEATURE_AUTOMOTIVE automotive builds}, some methods can
...
public class DevicePolicyManager {
     ...
     *
     * <p>In version {@link Build.VERSION_CODES#LOLLIPOP}, this intent must contain the
     * extra {@link #EXTRA_PROVISIONING_DEVICE_ADMIN_PACKAGE_NAME}.
     * As of {@link Build.VERSION_CODES#M}, it should contain the extra
     ...
     * the primary profile.
     *
     * <p>From version {@link Build.VERSION_CODES#O}, when managed provisioning has
     ...
     * device owner.
     *
     * <p>From version {@link Build.VERSION_CODES#O}, when device owner provisioning has
     * completed, along with the above broadcast, activity intent
     ...
     * that the user backed-out of provisioning, or some precondition for provisioning wasn't met.
     *
     * @deprecated to support {@link Build.VERSION_CODES#S} and later, admin apps must
     ...
     * to additionally support pre-{@link Build.VERSION_CODES#S}, admin apps must also
     ...
     * {@link permission#BIND_DEVICE_ADMIN}, and the process must hold
     * {@link permission#DISPATCH_PROVISIONING_MESSAGE} to be launched.
     ...
     *
     * <p>From version {@link Build.VERSION_CODES#Q}, the admin app can choose
     ...
     * {@link permission#DISPATCH_PROVISIONING_MESSAGE}.
     *
     * <p>If a device policy management role holder (DPMRH) updater is present on the device, an
     * internet connection attempt must be made prior to launching this intent. If internet
     * connection could not be established, provisioning will fail unless {@link
     ...
     * @hide
     */
    @RequiresPermission(permission.LAUNCH_DEVICE_MANAGER_SETUP)
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    @SystemApi
     ...
     * {@link PackageManager#GET_SIGNING_CERTIFICATES}.
     *
    ...
    /**
     * An extra of type {@link PersistableBundle} that allows the provisioning initiator
     ...
     * Starting from {@link Build.VERSION_CODES#M}, if used with
     ...
     * the permission {@link permission#BIND_DEVICE_ADMIN}.
     */
    @Deprecated
    ...
    /**
     * An {@link Account} extra holding the account to migrate during managed
    ...
    /**
     * @deprecated From {@link Build.VERSION_CODES#O}, never used while provisioning the
     * device.
     */
    @Deprecated
     ...
     * provisioning via an NFC bump. It can also be used for QR code provisioning.
     *
     * <p><strong>Note:</strong> for devices running {@link Build.VERSION_CODES#LOLLIPOP}
     * and {@link Build.VERSION_CODES#LOLLIPOP_MR1} only SHA-1 hash is supported.
     * Starting from {@link Build.VERSION_CODES#M}, this parameter accepts SHA-256 in
     * addition to SHA-1. From {@link Build.VERSION_CODES#Q}, only SHA-256 hash is
     * supported.
     */
     ...
     *
     * <p>From {@link Build.VERSION_CODES#N} onwards, this is also supported for an
     * intent with action {@link #ACTION_PROVISION_MANAGED_PROFILE}.
     *
     ...
     * <p>As of {@link Build.VERSION_CODES#S}, this constant is no longer used in favor
     ...
     * Build.VERSION_CODES#Q}</li></ul>
     *
     * <p>
     * As of {@link Build.VERSION_CODES#M}, the properties should contain
     ...
     * @hide
     */
    @RequiresPermission(permission.MANAGE_FACTORY_RESET_PROTECTION)
    @SystemApi
     ...
     * owner built against {@link Build.VERSION_CODES#M} or before,
     ...
     * {@link android.app.admin.DeviceAdminReceiver#onSecurityLogsAvailable} callback. There can be at most one app
     ...
     * The service must be protected with the {@link permission#BIND_DEVICE_ADMIN}
     * permission.
     */
     ...
     * extra in the intent result. The values of this {@link PersistableBundle} will be
     ...
     * {@link #ACTION_GET_PROVISIONING_MODE} activity.
     *
     * @deprecated from {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, the flag wouldn't
     ...
     * @hide
     */
    @RequiresPermission(permission.DISPATCH_PROVISIONING_MESSAGE)
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    @SystemApi
     ...
     * @hide
     */
    @RequiresPermission(anyOf = {permission.MANAGE_USERS,
     ...
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. Must be an
     *            active administrator, or an exception will be thrown.
     * @param usesPolicy Which uses-policy to check, as defined in {@link android.app.admin.DeviceAdminInfo}.
     ...
     * <p>
     * Apps targeting {@link Build.VERSION_CODES#R} and below can call this method on the
     * {@link DevicePolicyManager} instance returned by
     * {@link #getParentProfileInstance(ComponentName)} in order to set restrictions on the parent
     * profile. Apps targeting {@link Build.VERSION_CODES#S} and above, with the
     ...
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver } this request is associated with.
     ...
     *             does not use {@link android.app.admin.DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD} or if the
     *             calling app is targeting {@link Build.VERSION_CODES#S} and above,
     ...
     * {@link Build.VERSION_CODES#R} and above enforces this constraint without settings
     ...
     *     does not use {@link android.app.admin.DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     * @throws IllegalStateException if the calling app is targeting SDK level
     *     {@link Build.VERSION_CODES#R} and above and didn't set a sufficient password
     ...
     * SDK level {@link Build.VERSION_CODES#R} and above enforces this constraint without
     ...
     * profile.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. Null if the
     ...
     * @throws SecurityException if {@code admin} is not an active administrator or {@code admin}
     *             does not use {@link android.app.admin.DeviceAdminInfo#USES_POLICY_EXPIRE_PASSWORD}
     */
    @RequiresFeature(PackageManager.FEATURE_SECURE_LOCK_SCREEN)
     ...
     *     {@link android.app.admin.DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     ...
     * method. On Android {@link Build.VERSION_CODES#S} and above, the calling
     ...
     *             that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WATCH_LOGIN}
     */
    @RequiresFeature(PackageManager.FEATURE_SECURE_LOCK_SCREEN)
    @RequiresPermission(value = MANAGE_DEVICE_POLICY_LOCK_CREDENTIALS, conditional = true)
     ...
     * {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WATCH_LOGIN} and
     ...
     * {@link android.app.admin.DeviceAdminReceiver#onPasswordFailed(Context, Intent)} instead. Do not
     ...
     *            {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WATCH_LOGIN} and
     *            {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WIPE_DATA}, or if {@code admin} is null and the
     ...
     *
     * <p> Before {@link Build.VERSION_CODES#N}, this API is available to device admin,
     * profile owner and device owner. Starting from {@link Build.VERSION_CODES#N},
     ...
     *
     * <p> Between {@link Build.VERSION_CODES#O},
     * {@link Build.VERSION_CODES#P} and {@link Build.VERSION_CODES#Q},
     * profile owner and devices owner targeting SDK level {@link Build.VERSION_CODES#O}
     ...
     *
     * <p><em>Starting from {@link Build.VERSION_CODES#R}, this API is no longer
     ...
     * {@link Build.VERSION_CODES#O} or above, or they will receive a silent failure
     ...
     * {@link Build.VERSION_CODES#N} or above, and returns {@code false} otherwise. Only
     ...
     *         current constraints.
     * @throws SecurityException if the calling application does not own an active administrator
     *             that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_RESET_PASSWORD}
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_RESET_PASSWORD}
     ...
     * not the permission {@link permission#MANAGE_DEVICE_POLICY_RESET_PASSWORD}.
     */
    @RequiresFeature(PackageManager.FEATURE_SECURE_LOCK_SCREEN)
    @RequiresPermission(value = MANAGE_DEVICE_POLICY_RESET_PASSWORD, conditional = true)
     ...
     * permission {@link permission#MANAGE_DEVICE_POLICY_RESET_PASSWORD}
     ...
     * effect immediately.
     * <p>
     * A calling device admin must have requested {@link android.app.admin.DeviceAdminInfo#USES_POLICY_FORCE_LOCK}
     * to be able to call this method; if it has not, a security exception will be thrown.
     * <p>
     * This method can be called on the {@link DevicePolicyManager} instance returned by
     * {@link #getParentProfileInstance(ComponentName)} in order to set restrictions on the parent
     ...
     *             {@link android.app.admin.DeviceAdminInfo#USES_POLICY_FORCE_LOCK}
     */
     ...
     * <p>
     * From version {@link Build.VERSION_CODES#R} onwards, the caller must either have
     ...
     * {@link Build.VERSION_CODES#R}, the device needed the device admin feature,
     ...
     * <p>
     * NOTE: on {@link PackageManager#FEATURE_AUTOMOTIVE automotive builds}, this
     ...
     *
     * @throws SecurityException if the calling application does not own an active administrator
     *             that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_FORCE_LOCK}
     */
    @RequiresPermission(value = MANAGE_DEVICE_POLICY_LOCK, conditional = true)
    public void lockNow() {
        lockNow(0);
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_LOCK} permission.
     * <p>
     * From version {@link Build.VERSION_CODES#R} onwards, the caller must either have
     * the LOCK_DEVICE permission or the device must have the device admin feature; if neither is
     * true, then the method will return without completing any action. Before version
     ...
     * @throws SecurityException if the calling application does not own an active administrator
     *             that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_FORCE_LOCK} and the does not hold
     *             the {@link permission#MANAGE_DEVICE_POLICY_LOCK} permission, or
     ...
     *                           administrator
     *                           that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WIPE_DATA} and is
     *                           not granted the
     *                           {@link permission#MASTER_CLEAR} or
     *                           {@link permission#MANAGE_DEVICE_POLICY_WIPE_DATA}
     *                            permissions.
     ...
     * @throws SecurityException if the calling application does not own an active administrator
     *            that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WIPE_DATA} and is not granted the
     *            {@link permission#MASTER_CLEAR} or
     *            {@link permission#MANAGE_DEVICE_POLICY_WIPE_DATA} permissions.
     ...
     * {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WIPE_DATA} to be able to call this method; if it has
     * not, a security exception will be thrown.
     *
     * @param flags Bit mask of additional options: currently supported flags are
     *              {@link #WIPE_EXTERNAL_STORAGE}, {@link #WIPE_RESET_PROTECTION_DATA},
     *              {@link #WIPE_EUICC} and {@link #WIPE_SILENTLY}.
     * @throws SecurityException if the calling application does not own an active administrator
     *                       that uses {@link android.app.admin.DeviceAdminInfo#USES_POLICY_WIPE_DATA} and is not
     *                       granted the {@link permission#MASTER_CLEAR}
     *                       or both the
     *                       {@link permission#MANAGE_DEVICE_POLICY_WIPE_DATA} and
     *                       {@link permission#MANAGE_DEVICE_POLICY_ACROSS_USERS}
     *                       permissions.
     * @see #wipeData(int)
     * @see #wipeData(int, CharSequence)
     */
     ...
     * {@link permission#MASTER_CLEAR}, in which case, it can pass {@code null}
     * as the ComponentName.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with or
     ...
     * {@link permission#TRIGGER_LOST_MODE} permission.
     *
     ...
     */
    @SystemApi
    @RequiresPermission(permission.TRIGGER_LOST_MODE)
     ...
     * {@link Build.VERSION_CODES#LOLLIPOP} since keyguard widget is only supported
     ...
     * @deprecated This flag was added in version {@link Build.VERSION_CODES#N}, but it
     ...
     *             {@link android.app.admin.DeviceAdminInfo#USES_ENCRYPTED_STORAGE}
     */
    @Deprecated
     ...
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.  If null,
     ...
     *    {@link permission#MANAGE_DEVICE_POLICY_CERTIFICATES} permission</li>
     * </ul>
     * All apps within the profile will be able to access the certificate and use the private key,
     * given direct user approval.
     *
     * <p>From Android {@link Build.VERSION_CODES#S}, the credential management app
     ...
     *         {@link permission#MANAGE_DEVICE_POLICY_CERTIFICATES} permission.
     * @see #setDelegatedScopes
     * @see #DELEGATION_CERT_INSTALL
     */
     ...
     *        {@link KeyChain#getCertificateChain}.
     * @param alias The private key alias under which to install the certificate. If a certificate
     *        with that alias already exists, it will be overwritten.
     ...
     *         owner, or {@code admin} is null and the calling application does not have the
     *         {@link permission#MANAGE_DEVICE_POLICY_CERTIFICATES} permission.
     * @see KeyChain#getCertificateChain
     * @see #setDelegatedScopes
     * @see #DELEGATION_CERT_INSTALL
     */
    @RequiresPermission(value = MANAGE_DEVICE_POLICY_CERTIFICATES, conditional = true)
     ...
     * let an application call {@link KeyChain#getPrivateKey} without having to
     * call {@link KeyChain#choosePrivateKeyAlias} first.
     *
     * The grantee app will receive the {@link KeyChain#ACTION_KEY_ACCESS_CHANGED}
     * broadcast when access to a key is granted.
     *
     * Starting from {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} throws an
     ...
     * Calls by the application to {@link KeyChain#getPrivateKey}
     ...
     * installer.
     * <p>
     * <b>Note:</b>Starting from {@link Build.VERSION_CODES#N}, if the caller
     * application's target SDK version is {@link Build.VERSION_CODES#N} or newer, the
     ...
     *
     * @deprecated From {@link Build.VERSION_CODES#O}. Use {@link #setDelegatedScopes}
     ...
     * @throws SecurityException if {@code admin} is not a device or a profile owner.
     *
     * @deprecated From {@link Build.VERSION_CODES#O}. Use {@link #getDelegatePackages}
     * with the {@link #DELEGATION_CERT_INSTALL} scope instead.
     */
    @Deprecated
     ...
     *         {@link permission#BIND_VPN_SERVICE};</li>
     *     <li>target {@link Build.VERSION_CODES#N API 24} or above; and</li>
     ...
     * <p> Starting from {@link Build.VERSION_CODES#S API 31} calling this method with
    ...
    */
     ...
     * {@link Build.VERSION_CODES#Q}. On Android
     * {@link Build.VERSION_CODES#Q} devices, legacy device admins targeting SDK
     * version {@link Build.VERSION_CODES#P} or below can still call this API to
     * disable camera, while legacy device admins targeting SDK version
     * {@link Build.VERSION_CODES#Q} will receive a SecurityException. Starting
     * from Android {@link Build.VERSION_CODES#R}, requests to disable camera from
     * legacy device admins targeting SDK version {@link Build.VERSION_CODES#P} or
     ...
     * Bundle, android.app.admin.TargetUser, android.app.admin.PolicyUpdateResult)} will notify the admin on whether the policy was
     ...
     * <li> The {@link android.app.admin.TargetUser} that this policy relates to
     * <li> The {@link android.app.admin.PolicyUpdateResult}, which will be
     * {@link android.app.admin.PolicyUpdateResult#RESULT_POLICY_SET} if the policy was successfully set or the
     * reason the policy failed to be set
     * (e.g. {@link android.app.admin.PolicyUpdateResult#RESULT_FAILURE_CONFLICTING_ADMIN_POLICY})
     * </ul>
     * If there has been a change to the policy,
     * {@link PolicyUpdateReceiver#onPolicyChanged(Context, String, Bundle, android.app.admin.TargetUser,
     * android.app.admin.PolicyUpdateResult)} will notify the admin of this change. This callback will contain the
     * same parameters as PolicyUpdateReceiver#onPolicySetResult and the {@link android.app.admin.PolicyUpdateResult}
     * will contain the reason why the policy changed.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with or null if
                     the caller is not a device admin
     * @param disabled Whether or not the camera should be disabled.
     * @throws SecurityException if {@code admin} is not an active administrator or does not use
     *             {@link android.app.admin.DeviceAdminInfo#USES_POLICY_DISABLE_CAMERA}.
     */
     ...
     * <p>
     * From version {@link Build.VERSION_CODES#M} disabling screen capture also blocks
     ...
     * {@link permission#READ_NEARBY_STREAMING_POLICY READ_NEARBY_STREAMING_POLICY}
     * permission.
     */
    @RequiresPermission(
            value = permission.READ_NEARBY_STREAMING_POLICY,
            conditional = true)
     ...
     * @deprecated From {@link Build.VERSION_CODES#R}. Use {@link #setAutoTimeEnabled}
     ...
     * @deprecated From {@link Build.VERSION_CODES#R}. Use {@link #getAutoTimeEnabled}
     */
    @Deprecated
     ...
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with or Null if the
     *              caller is not a device admin.
     ...
     * <p>
     * Calling this from a managed profile before version {@link Build.VERSION_CODES#M}
     * will throw a security exception. From version {@link Build.VERSION_CODES#M} the
     ...
     * </ul>
     * <p>
     * From version {@link Build.VERSION_CODES#R} the profile owner of an
     ...
     * @throws SecurityException if {@code admin} is not an active administrator or does not use
     *             {@link android.app.admin.DeviceAdminInfo#USES_POLICY_DISABLE_KEYGUARD_FEATURES}
     */
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_PACKAGE_STATE}.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. Null if the
     *              caller is not a device admin.
     ...
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associate with.
     ...
     * @hide
     */
    @RequiresPermission(value = permission.INTERACT_ACROSS_USERS,
            conditional = true)
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_LOCK_TASK}. to set a default activity
     ...
     * permission {@link permission#MANAGE_DEVICE_POLICY_LOCK_TASK}.
     */
     ...
     * permission {@link permission#MANAGE_DEVICE_POLICY_LOCK_TASK} to remove all
     ...
     * String, Bundle, android.app.admin.TargetUser, android.app.admin.PolicyUpdateResult)} will notify the admin on whether the policy
     ...
     * <li> The {@link android.app.admin.TargetUser} that this policy relates to
     * <li> The {@link android.app.admin.PolicyUpdateResult}, which will be
     * {@link android.app.admin.PolicyUpdateResult#RESULT_POLICY_SET} if the policy was successfully cleared or the
     ...
     * personal profile.
     * <p>
     * Starting from Android {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, the profile
     ...
     * that method.
     *
     * @deprecated From {@link Build.VERSION_CODES#O}. Use {@link #getDelegatedScopes}
     * instead.
     */
    @Deprecated
     ...
     * {@link #getApplicationRestrictions}.
     *
     * <p>Starting from Android Version {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
     ...
     * thrown.
     * <p>
     * Starting with {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, calling this function
     * is similar to calling {@link #setManagedProfileCallerIdAccessPolicy(android.app.admin.PackagePolicy)}
     * with a {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_BLOCKLIST} policy type when {@code disabled} is
     * false or a {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_ALLOWLIST} policy type when
     * {@code disabled} is true.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
     * @param disabled If true caller-Id information in the managed profile is not displayed.
     * @throws SecurityException if {@code admin} is not a profile owner.
     * @deprecated starting with {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, use
     * {@link #setManagedProfileCallerIdAccessPolicy(android.app.admin.PackagePolicy)} instead
     */
    @Deprecated
     ...
     * thrown.
     * <p>
     * Starting with {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
     * this will return true when
     * {@link #setManagedProfileCallerIdAccessPolicy(android.app.admin.PackagePolicy)}
     * has been set with a non-null policy whose policy type is NOT
     * {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_BLOCKLIST}
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
     * @throws SecurityException if {@code admin} is not a profile owner.
     * @deprecated starting with {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, use
     ...
     *
     * <p>A {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_ALLOWLIST} policy type will limit the credential
     * providers that the user can use to the list of packages in the policy.
     *
     * <p>A {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_ALLOWLIST_AND_SYSTEM} policy type
     * allows access from the OEM default credential providers and the allowlist of credential
     * providers.
     *
     * <p>A {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_BLOCKLIST} policy type will block the credential
     ...
     * managed profile
     */
    public void setCredentialManagerPolicy(@Nullable android.app.admin.PackagePolicy policy) {
     ...
     * configured.
     */
    public @Nullable android.app.admin.PackagePolicy getCredentialManagerPolicy() {
     ...
     * <p>
     * A {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_ALLOWLIST_AND_SYSTEM} policy type
     * allows access from the OEM default packages for the Sms, Dialer and Contact roles,
     * in addition to the packages specified in {@link android.app.admin.PackagePolicy#getPackageNames()}
     *
     ...
     */
    public void setManagedProfileCallerIdAccessPolicy(@Nullable android.app.admin.PackagePolicy policy) {
     ...
     */
    public @Nullable android.app.admin.PackagePolicy getManagedProfileCallerIdAccessPolicy() {
     ...
     * @throws SecurityException if caller is not a profile owner of a managed profile
     */
    public void setManagedProfileContactsAccessPolicy(@Nullable android.app.admin.PackagePolicy policy) {
     ...
     */
    public @Nullable android.app.admin.PackagePolicy getManagedProfileContactsAccessPolicy() {
     ...
     *
     * Starting with {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, calling this function
     * is similar to calling {@link #setManagedProfileContactsAccessPolicy(android.app.admin.PackagePolicy)} with a
     * {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_BLOCKLIST} policy type when {@code disabled} is false
     * or a {@link android.app.admin.PackagePolicy#PACKAGE_POLICY_ALLOWLIST} policy type when {@code disabled}
     * is true.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     *
     * @deprecated From {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} use
     * {@link #setManagedProfileContactsAccessPolicy(android.app.admin.PackagePolicy)}
     */
    @Deprecated
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_INPUT_METHODS} permission to set
     ...
     *                              hold the {@link permission#MANAGE_DEVICE_POLICY_INPUT_METHODS}
     ...
     *
     * <p>On {@link Build.VERSION_CODES#Q} and later devices, this method returns the
     ...
     * <p>From {@link Build.VERSION_CODES#P} onwards, if targeting
     * {@link Build.VERSION_CODES#P}, throws {@link UserOperationException} instead of
     * returning {@code null} on failure.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
     * @param name The user's name.
     * @param profileOwner Which {@link android.app.admin.DeviceAdminReceiver} will be profile owner. Has to be in the
     ...
     * targeting {@link Build.VERSION_CODES#P} and running on
     ...
     * <p>
     * See the constants in {@link UserManager} for the list of restrictions that can
     ...
     *
     * <p>For callers targeting Android {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} or
     ...
     * exception will be thrown.
     *
     * <p> See the constants in {@link UserManager} for the list of restrictions that can
     * be enforced device-wide. These constants will also state in their documentation which
     * permission is required to manage the restriction using this API.
     * <p>
     * After the user restriction policy has been set,
     * {@link PolicyUpdateReceiver#onPolicySetResult(Context, String, Bundle, android.app.admin.TargetUser,
     * android.app.admin.PolicyUpdateResult)} will notify the admin on whether the policy was successfully set or not.
     ...
     * {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} or above.
     */
     ...
     * <p>
     * See the constants in {@link UserManager} for the list of restrictions. These
     ...
     * Android {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, were this API returns
     ...
     * <p>
     * From {@link Build.VERSION_CODES#N} the profile or device owner can still use
     ...
     * task. From {@link Build.VERSION_CODES#M} removing packages from the lock task
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_LOCK_TASK}. See
     ...
     * been set, {@link PolicyUpdateReceiver#onPolicySetResult(Context, String, Bundle, android.app.admin.TargetUser,
     * android.app.admin.PolicyUpdateResult)} will notify the admin on whether the policy was successfully set or not.
     * This callback will contain:
     * <ul>
     ...
     * permission {@link permission#MANAGE_DEVICE_POLICY_LOCK_TASK}. See
     * {@link #isAffiliatedUser}.
     ...
     * android.app.admin.TargetUser, android.app.admin.PolicyUpdateResult)} will notify the admin on whether the policy was
     * successfully set or not. This callback will contain:
     * <ul>
     * <li> The policy identifier {@link DevicePolicyIdentifiers#LOCK_TASK_POLICY}
     * <li> The {@link android.app.admin.TargetUser} that this policy relates to
     ...
     * <p> Before Android version {@link Build.VERSION_CODES#TIRAMISU}:
     * this method can be called by the profile owner of a managed profile.
     * <p> Starting from Android version {@link Build.VERSION_CODES#TIRAMISU}:
     * This method can be called by the profile owner of a managed profile
     * or device owner.
     *
     ...
     * <p>
     * Called by device owner to update {@link Settings.Global} settings.
     * Validation that the value of the setting is in the correct form for the setting type should
     * be performed by the caller.
     * <p>
     * The settings that can be updated with this method are:
     * <ul>
     * <li>{@link Settings.Global#ADB_ENABLED} : use
     ...
     * <li>{@link Settings.Global#STAY_ON_WHILE_PLUGGED_IN} This setting is only
     * available from {@link Build.VERSION_CODES#M} onwards and can only be set if
     * {@link #setMaximumTimeToLock} is not used to set a timeout.</li>
     * <li>{@link Settings.Global#WIFI_DEVICE_OWNER_CONFIGS_LOCKDOWN}</li> This
     * setting is only available from {@link Build.VERSION_CODES#M} onwards.</li>
     * </ul>
     * <p>
     * The following settings used to be supported, but can be controlled in other ways:
     * <ul>
     * <li>{@link Settings.Global#AUTO_TIME} : Use {@link #setAutoTimeEnabled} and
     * {@link UserManager#DISALLOW_CONFIG_DATE_TIME} instead.</li>
     * <li>{@link Settings.Global#AUTO_TIME_ZONE} : Use
     * {@link #setAutoTimeZoneEnabled} and {@link UserManager#DISALLOW_CONFIG_DATE_TIME}
     * instead.</li>
     * <li>{@link Settings.Global#DATA_ROAMING} : Use
     * {@link UserManager#DISALLOW_DATA_ROAMING} instead.</li>
     * </ul>
     * <p>
     * Changing the following settings has no effect as of {@link Build.VERSION_CODES#M}:
     * <ul>
     ...
     * <li>{@link Settings.Global#WIFI_SLEEP_POLICY}. No longer has effect.</li>
     * </ul>
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
    ...
    /**
     * Called by a device or profile owner to update {@link Settings.System}
     ...
     * this method are:
     * <ul>
     * <li>{@link Settings.System#SCREEN_BRIGHTNESS}</li>
     * <li>{@link Settings.System#SCREEN_BRIGHTNESS_MODE}</li>
     * <li>{@link Settings.System#SCREEN_OFF_TIMEOUT}</li>
     * </ul>
     * <p>
     *
     * @see Settings.System#SCREEN_OFF_TIMEOUT
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
     * @param setting The name of the setting to update.
     * @param value The value to update the setting to.
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     ...
     * {@link Settings.Global#WIFI_DEVICE_OWNER_CONFIGS_LOCKDOWN} and calling
     ...
     * to this API.
     *
     * @param admin             admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated
     ...
     * {@link Settings.Global#AUTO_TIME} is 0, otherwise {@code false}
     * will be returned.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. Null if the
     *               caller is not a device admin.
     ...
     * effect if called when {@link Settings.Global#AUTO_TIME_ZONE}
     ...
     * {@link PackageManager#FEATURE_AUTOMOTIVE automotive builds}, calls to
     ...
     * <p>
     *
     * Called by profile or device owners to update {@link Settings.Secure}
     * settings. Validation that the value of the setting is in the correct form for the setting
     * type should be performed by the caller.
     * <p>
     ...
     * <ul>
     * <li>{@link Settings.Secure#LOCATION_MODE}, but see note below.</li>
     * </ul>
     *
     * <strong>Note: Starting from Android O, apps should no longer call this method with the
     * setting {@link Settings.Secure#INSTALL_NON_MARKET_APPS}, which is
     ...
     * If any app targeting {@link Build.VERSION_CODES#O} or higher calls this method
     * with {@link Settings.Secure#INSTALL_NON_MARKET_APPS},
     ...
     * setting {@link Settings.Secure#LOCATION_MODE}, which is deprecated. Instead,
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_APPS_CONTROL}.
     * <p>
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner or holder of the
     * permission {@link permission#MANAGE_DEVICE_POLICY_APPS_CONTROL}.
     * @see #setDelegatedScopes
     ...
     * <p>
     * <strong>Note:</strong> Starting from {@link Build.VERSION_CODES#LOLLIPOP_MR1}, the
     ...
     *              from {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} admin will be
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_PROFILE_INTERACTION} to enable
     ...
     * permission {@link permission#MANAGE_DEVICE_POLICY_PROFILE_INTERACTION}.
    ...
    /**
     * Called by the profile owner of a managed profile or a holder of the permission
     * {@link permission#MANAGE_DEVICE_POLICY_PROFILE_INTERACTION} to disable
    ...
    /**
     * Called by the profile owner of a managed profile or a holder of the permission
     * {@link permission#MANAGE_DEVICE_POLICY_PROFILE_INTERACTION} to query
     ...
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. All
    ...
    public void setSystemUpdatePolicy(@NonNull ComponentName admin, android.app.admin.SystemUpdatePolicy policy) {
     ...
     */
    @TestApi
    @RequiresPermission(permission.CLEAR_FREEZE_PERIOD)
     ...
     *
     * <p>
     * As of {@link Build.VERSION_CODES#P}, this call also dismisses the
     ...
     */
    @SystemApi
    @RequiresPermission(permission.NOTIFY_PENDING_SYSTEM_UPDATE)
    public void notifyPendingSystemUpdate(long updateReceivedTime) {
        throwIfParentInstance("notifyPendingSystemUpdate");
        if (mService != null) {
            try {
                mService.notifyPendingSystemUpdate(android.app.admin.SystemUpdateInfo.of(updateReceivedTime));
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
     ...
     * built with a {@code targetSdkVersion} of {@link Build.VERSION_CODES#M} or later.
     *
     * <p>
     * NOTE: On devices running {@link Build.VERSION_CODES#S} and above, an auto-grant
     ...
     * <p/>
     * Device admins with a {@code targetSdkVersion} &lt; {@link Build.VERSION_CODES#Q}
     * cannot grant and revoke permissions for applications built with a {@code targetSdkVersion}
     * &lt; {@link Build.VERSION_CODES#M}.
     * <p/>
     * Admins with a {@code targetSdkVersion} &ge; {@link Build.VERSION_CODES#Q} can
     ...
     * {@link Build.VERSION_CODES#M} the app-op matching the permission is set to
     * {@link android.app.AppOpsManager#MODE_IGNORED}, but the permission stays granted.
     * <p>
     * NOTE: On devices running {@link Build.VERSION_CODES#S} and above, control over
...
//    @RequiresPermission(value = MANAGE_DEVICE_POLICY_WIFI, conditional = true)
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_SUPPORT_MESSAGE} to get the short
     * support message.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. Null if the
     *               caller is not a device admin.
     ...
     * the permission {@link permission#MANAGE_DEVICE_POLICY_SUPPORT_MESSAGE}..
     */
    @RequiresPermission(value = MANAGE_DEVICE_POLICY_SUPPORT_MESSAGE, conditional = true)
     ...
     * been notified via {@link android.app.admin.DeviceAdminReceiver#onSecurityLogsAvailable}.
     *
     ...
     */
    @TestApi
    @RequiresPermission(permission.FORCE_DEVICE_POLICY_MANAGER_LOGS)
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     * @deprecated From {@link Build.VERSION_CODES#R}, the organization color is never
     ...
     * permission {@link permission#MANAGE_DEVICE_POLICY_ORGANIZATION_IDENTITY
    ...
    /**
      ...
      *
      * <p>The caller must hold the {@link permission#MANAGE_USERS}
      * permission.
      *
      * <p>Not for use by third-party applications.
      *
     ...
     *
     * <p>The caller must hold the {@link permission#MANAGE_USERS} permission.
     *
     * <p>Not for use by third-party applications.
     *
     ...
     * a managed profile.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with. Can only
     ...
     *
     * <p> {@link android.app.admin.NetworkEvent} can be one of {@link DnsEvent} or {@link ConnectEvent}.
     *
     ...
     * batchToken provided by {@link android.app.admin.DeviceAdminReceiver#onNetworkLogsAvailable}.
     * See {@link DevicePolicyManager#setAffiliationIds}.
     *
     * @param admin Which {@link android.app.admin.DeviceAdminReceiver} this request is associated with, or
     *        {@code null} if called by a delegated app.
     * @param batchToken A token of the batch to retrieve
     * @return A new batch of network logs which is a list of {@link android.app.admin.NetworkEvent}. Returns
     ...
     * <p>
     * The service must be protected by {@link permission#BIND_DEVICE_ADMIN}.
     ...
     * {@link permission#INTERACT_ACROSS_USERS_FULL} permission.
     *
     ...
     *
     * @param admin which {@link android.app.admin.DeviceAdminReceiver} this request is associated with.
     * @param target which {@link android.app.admin.DeviceAdminReceiver} we want the new administrator to be.
     ...
     * additionally check the system version with {@link Build#FINGERPRINT} or {@link
     * Build.VERSION}. If an error occurs during processing the OTA before the reboot,
     ...
     * InstallSystemUpdateCallback#UPDATE_ERROR_BATTERY_LOW}.
     *
     * @param admin The {@link android.app.admin.DeviceAdminReceiver} that this request is associated with. Null if
     *              the caller is not a device admin
     ...
     * When called by an app targeting SDK level {@link Build.VERSION_CODES#Q} or
     * below, will behave the same as {@link #setProfileOwnerOnOrganizationOwnedDevice}.
     *
     * When called by an app targeting SDK level {@link Build.VERSION_CODES#R}
    ...
    @Deprecated
    @SystemApi
    @RequiresPermission(value = permission.GRANT_PROFILE_OWNER_DEVICE_IDS_ACCESS,
            conditional = true)
     ...
     * {@link Settings.Secure#CROSS_PROFILE_CALENDAR_ENABLED}
     ...
     *
     * @param admin the {@link android.app.admin.DeviceAdminReceiver} this request is associated with
     ...
     * {@link  permission#MANAGE_DEVICE_POLICY_APP_EXEMPTIONS} permission, to
     ...
     *             {@link  permission#MANAGE_DEVICE_POLICY_APP_EXEMPTIONS}
     * @throws NameNotFoundException If either the package is not installed or the package is not
     *              visible to the caller.
     * @hide
     */
    @SystemApi
    @RequiresPermission(permission.MANAGE_DEVICE_POLICY_APP_EXEMPTIONS)
     ...
     * {@link  permission#MANAGE_DEVICE_POLICY_APP_EXEMPTIONS} permission.
     *
     ...
     * {@link permission#MANAGE_DEVICE_POLICY_APPS_CONTROL} to disable user
     ...
     * {@link android.app.admin.DeviceAdminReceiver#onComplianceAcknowledgementRequired(Context, Intent)} callback in
     ...
     * {@link android.app.admin.DeviceAdminReceiver#onComplianceAcknowledgementRequired(Context, Intent)}, otherwise
     ...
     * @see android.app.admin.DeviceAdminReceiver#onComplianceAcknowledgementRequired(Context, Intent)
     */
     ...
     * {@link android.app.admin.DeviceAdminReceiver#onComplianceAcknowledgementRequired(Context, Intent)} callback.
     ...
     * identifiers by calling e.g. {@link Build#getSerial()}, in addition to using
     ...
     * before calling this method.
     *
     * <p>Holders of {@link permission#PROVISION_DEMO_DEVICE} can call this API
     ...
     *
     * @param admin The {@link android.app.admin.DeviceAdminReceiver} that is the device owner.
    ...
    /**
     * Called by device owner or profile owner of an organization-owned managed profile to
     * specify the Wi-Fi SSID policy ({@link android.app.admin.WifiSsidPolicy}).
     ...
     */
    @RequiresPermission(value = MANAGE_DEVICE_POLICY_WIFI, conditional = true)
    public void setWifiSsidPolicy(@Nullable android.app.admin.WifiSsidPolicy policy) {
     ...
     *
     * @see #setWifiSsidPolicy(android.app.admin.WifiSsidPolicy)
     ...
     */
    @TestApi
    @RequiresPermission(permission.MANAGE_ROLE_HOLDERS)
