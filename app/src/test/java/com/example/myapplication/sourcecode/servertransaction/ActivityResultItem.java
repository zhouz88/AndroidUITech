...
public class ActivityResultItem extends ActivityTransactionItem {
    ...
    /**
     * Correct the lifecycle of activity result after {@link Build.VERSION_CODES#S} to
    ...
    public static final @NonNull Creator<ActivityResultItem> CREATOR =
            new Creator<ActivityResultItem>() {
