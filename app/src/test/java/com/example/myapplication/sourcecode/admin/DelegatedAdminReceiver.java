...
public class DelegatedAdminReceiver extends BroadcastReceiver {
     ...
     * possible to retrieve the security logs. See {@link android.app.admin.DevicePolicyManager#setAffiliationIds}.
     *
     * <p> This callback is only applicable if the delegated app has
     * {@link android.app.admin.DevicePolicyManager#DELEGATION_SECURITY_LOGGING} capability. Additionally, it must
