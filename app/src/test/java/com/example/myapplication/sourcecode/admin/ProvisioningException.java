...
/**
 * Thrown to indicate a failure during {@link android.app.admin.DevicePolicyManager#provisionFullyManagedDevice} and
 * {@link android.app.admin.DevicePolicyManager#createAndProvisionManagedProfile}.
 *
 * @hide
 *
 */
...
public class ProvisioningException extends AndroidException {
    ...
    /**
     * Service-specific error code for {@link android.app.admin.DevicePolicyManager#provisionFullyManagedDevice} and
     * {@link android.app.admin.DevicePolicyManager#createAndProvisionManagedProfile}:
     ...
     * Service-specific error code for {@link android.app.admin.DevicePolicyManager#provisionFullyManagedDevice} and
     * {@link android.app.admin.DevicePolicyManager#createAndProvisionManagedProfile}:
     * Indicates the call to {@link android.app.admin.DevicePolicyManager#checkProvisioningPrecondition} returned an
     * error code.
     */
    public static final int ERROR_PRE_CONDITION_FAILED = 1;

    /**
     * Service-specific error code for {@link android.app.admin.DevicePolicyManager#createAndProvisionManagedProfile}:
    ...
    /**
     * Service-specific error code for {@link android.app.admin.DevicePolicyManager#provisionFullyManagedDevice}:
    ...
    /**
     * Service-specific error codes for {@link android.app.admin.DevicePolicyManager#createAndProvisionManagedProfile}
