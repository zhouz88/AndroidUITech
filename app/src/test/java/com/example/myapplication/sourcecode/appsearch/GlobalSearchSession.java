...
public class GlobalSearchSession implements Closeable {
    ...
    static void createGlobalSearchSession(
            ...
            @NonNull Consumer<android.app.appsearch.AppSearchResult<GlobalSearchSession>> callback) {
    ...
    /**
     * Retrieves {@link android.app.appsearch.GenericDocument} documents, belonging to the specified package name and
     ...
     *                     values are the returned {@link android.app.appsearch.GenericDocument}s on success, or a failed
     ...
     *                     {@link android.app.appsearch.BatchResultCallback#onSystemError} will be invoked with a
     *                     {@link Throwable}.
     */
     ...
     * android.app.appsearch.SetSchemaRequest.Builder#setSchemaTypeVisibilityForPackage} when building a schema.
     *
     ...
     *
     * <p>See {@link android.app.appsearch.AppSearchSession#search} for a detailed explanation on forming a query string.
     *
     ...
     *
     * <p>See {@link android.app.appsearch.AppSearchSession#reportUsage} for a general description of document usage, as
     ...
     * {@link android.app.appsearch.AppSearchSession#reportUsage} and may be accessed using the constants
     * {@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_SYSTEM_USAGE_COUNT} and
     ...
     *                 invoked with an {@link android.app.appsearch.AppSearchResult} whose value is {@code null}. The
     *                 callback will be invoked with an {@link android.app.appsearch.AppSearchResult} of
     *                 {@link android.app.appsearch.AppSearchResult#RESULT_SECURITY_ERROR} if this API is invoked by an
     ...
     *
     * @param packageName  the package that owns the requested {@link android.app.appsearch.AppSearchSchema} instances.
     * @param databaseName the database that owns the requested {@link AppSearchSchema} instances.
     * @return The pending {@link android.app.appsearch.GetSchemaResponse} containing the schemas that the caller has
    ...
    public void getSchema(
            ...
            @NonNull String databaseName,
            @NonNull @CallbackExecutor Executor executor,
            @NonNull Consumer<android.app.appsearch.AppSearchResult<android.app.appsearch.GetSchemaResponse>> callback) {
        Objects.requireNonNull(packageName);
        Objects.requireNonNull(databaseName);
        Objects.requireNonNull(executor);
        Objects.requireNonNull(callback);
                    ...
                    new IAppSearchResultCallback.Stub() {
                        ...
                        public void onResult(AppSearchResultParcel resultParcel) {
                            safeExecute(executor, callback, () -> {
                                ...
                                if (result.isSuccess()) {
                                    android.app.appsearch.GetSchemaResponse response = new GetSchemaResponse(
        ...
        synchronized (mObserverCallbacksLocked) {
            ...
            if (stub == null) {
                ...
                stub = new IAppSearchObserverProxy.Stub() {
                     ...
                     */
                    private void suppressingErrorCallback(@NonNull android.app.appsearch.AppSearchResult<?> unused) {
                    }
                };
            }
