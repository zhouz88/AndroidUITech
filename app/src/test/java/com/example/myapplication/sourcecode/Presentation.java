 ...
 * display will result in {@link WindowManager.InvalidDisplayException} being thrown
...
public class Presentation extends android.app.Dialog {
     ...
     * The presentation will create its own context (see {@link #getContext()}) based
     * on this context and information about the associated display.
     * From {@link Build.VERSION_CODES#S}, the presentation will create its own window
     ...
     * {@link WindowManager.InvalidDisplayException} when invoking {@link #show()}.
     * @param display The display to which the presentation should be attached.
