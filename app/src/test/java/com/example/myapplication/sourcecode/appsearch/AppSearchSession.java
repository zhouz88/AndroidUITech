...
public final class AppSearchSession implements Closeable {
    ...
    static void createSearchSession(
            ...
            @NonNull Consumer<android.app.appsearch.AppSearchResult<AppSearchSession>> callback) {
                    ...
                    new IAppSearchResultCallback.Stub() {
                        ...
                        public void onResult(AppSearchResultParcel resultParcel) {
                            safeExecute(executor, callback, () -> {
                                android.app.appsearch.AppSearchResult<Void> result = resultParcel.getResult();
                                if (result.isSuccess()) {
                                    callback.accept(
                                            android.app.appsearch.AppSearchResult.newSuccessfulResult(
                                                    AppSearchSession.this));
                                } else {
                                    callback.accept(android.app.appsearch.AppSearchResult.newFailedResult(result));
                                }
                            });
                        }
                    });
    ...
    public void setSchema(
            ...
            @NonNull Consumer<android.app.appsearch.AppSearchResult<SetSchemaResponse>> callback) {
        ...
        for (android.app.appsearch.AppSearchSchema schema : request.getSchemas()) {
    ...
    public void getSchema(
            @NonNull @CallbackExecutor Executor executor,
            @NonNull Consumer<android.app.appsearch.AppSearchResult<GetSchemaResponse>> callback) {
        ...
        try {
            mService.getSchema(
                    ...
                    new IAppSearchResultCallback.Stub() {
                        ...
                        public void onResult(AppSearchResultParcel resultParcel) {
                            safeExecute(executor, callback, () -> {
                                android.app.appsearch.AppSearchResult<Bundle> result = resultParcel.getResult();
                                if (result.isSuccess()) {
                                    GetSchemaResponse response = new GetSchemaResponse(
                                        Objects.requireNonNull(result.getResultValue()));
                                    callback.accept(android.app.appsearch.AppSearchResult.newSuccessfulResult(response));
                                } else {
                                    callback.accept(android.app.appsearch.AppSearchResult.newFailedResult(result));
                                }
                            });
    ...
    public void getNamespaces(
            @NonNull @CallbackExecutor Executor executor,
            @NonNull Consumer<android.app.appsearch.AppSearchResult<Set<String>>> callback) {
        Objects.requireNonNull(executor);
        Objects.requireNonNull(callback);
        Preconditions.checkState(!mIsClosed, "AppSearchSession has already been closed");
        try {
            mService.getNamespaces(
                    ...
                    new IAppSearchResultCallback.Stub() {
                        ...
                        public void onResult(AppSearchResultParcel resultParcel) {
                            safeExecute(executor, callback, () -> {
                                android.app.appsearch.AppSearchResult<List<String>> result = resultParcel.getResult();
                                if (result.isSuccess()) {
                                    Set<String> namespaces =
                                            new ArraySet<>(result.getResultValue());
                                    callback.accept(
                                            android.app.appsearch.AppSearchResult.newSuccessfulResult(namespaces));
                                } else {
                                    callback.accept(android.app.appsearch.AppSearchResult.newFailedResult(result));
                                }
                            });
     ...
     *
     * <p>Each {@link android.app.appsearch.GenericDocument} object must have a {@code schemaType} field set to an {@link
     * android.app.appsearch.AppSearchSchema} type that has been previously registered by calling the {@link #setSchema}
     * method.
     *
     ...
     *                 or a failed {@link android.app.appsearch.AppSearchResult} otherwise. If an unexpected internal
    ...
    /**
     * Gets {@link android.app.appsearch.GenericDocument} objects by document IDs in a namespace from the {@link
     ...
     *                 are the returned {@link android.app.appsearch.GenericDocument}s on success, or a failed
     *                 {@link android.app.appsearch.AppSearchResult} otherwise. IDs that are not found will return a
     *                 failed {@link android.app.appsearch.AppSearchResult} with a result code of
     *                 {@link android.app.appsearch.AppSearchResult#RESULT_NOT_FOUND}. If an unexpected internal error
     ...
     * and operators.
     *
     * <p>For query strings that are empty, all documents that match the {@link android.app.appsearch.SearchSpec} will be
     * returned.
     *
     * <p>For query strings with a single term and no operators, documents that match the provided
     * query string and {@link android.app.appsearch.SearchSpec} will be returned.
     *
     ...
     *       <p>For queries that require a term to match a specific {@link android.app.appsearch.AppSearchSchema} property
     ...
     * adding projection, can be set by calling the corresponding {@link android.app.appsearch.SearchSpec.Builder} setter.
     *
     * <p>This method is lightweight. The heavy work will be done in {@link
     * android.app.appsearch.SearchResults#getNextPage}.
     *
     * @param queryExpression query string to search.
     * @param searchSpec spec for setting document filters, adding projection, setting term match
     *     type, etc.
     * @return a {@link android.app.appsearch.SearchResults} object for retrieved matched documents.
     */
    @NonNull
    public android.app.appsearch.SearchResults search(@NonNull String queryExpression, @NonNull android.app.appsearch.SearchSpec searchSpec) {
     ...
     * {@link #search(String, android.app.appsearch.SearchSpec)} API.
     *
     ...
     *     {@link android.app.appsearch.SearchResult}s, which contains document 1, 2 and 3.
     *     <li>"term2" - Use it to be queryExpression in {@link #search} could get 2
     *     {@link android.app.appsearch.SearchResult}s, which contains document 2 and 3.
     *     <li>"term3" - Use it to be queryExpression in {@link #search} could get 1
     *     {@link android.app.appsearch.SearchResult}, which contains document 3.
     * </ul>
     *
     ...
     * {@link android.app.appsearch.AppSearchResult#RESULT_INVALID_ARGUMENT}.
     ...
     *
     * @see #search(String, android.app.appsearch.SearchSpec)
     */
    public void searchSuggestion(
            @NonNull String suggestionQueryExpression,
            @NonNull SearchSuggestionSpec searchSuggestionSpec,
            @NonNull @CallbackExecutor Executor executor,
            @NonNull Consumer<android.app.appsearch.AppSearchResult<List<SearchSuggestionResult>>> callback) {
            ...
            mService.searchSuggestion(
                    ...
                    new IAppSearchResultCallback.Stub() {
                        ...
                        public void onResult(AppSearchResultParcel resultParcel) {
                            safeExecute(executor, callback, () -> {
                                try {
                                    android.app.appsearch.AppSearchResult<List<Bundle>> result = resultParcel.getResult();
                                    if (result.isSuccess()) {
                                    ...
                                    callback.accept(android.app.appsearch.AppSearchResult.throwableToFailedResult(e));
                                }
                            });
                        }
                    }
     ...
     * results by the {@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_USAGE_COUNT} and {@link
     * android.app.appsearch.SearchSpec#RANKING_STRATEGY_USAGE_LAST_USED_TIMESTAMP} ranking strategies.
     *
    ...
    public void reportUsage(
            ...
            @NonNull @CallbackExecutor Executor executor,
            @NonNull Consumer<android.app.appsearch.AppSearchResult<Void>> callback) {
        Objects.requireNonNull(request);
        Objects.requireNonNull(executor);
        Objects.requireNonNull(callback);
        String targetPackageName =
    ...
    /**
     * Removes {@link android.app.appsearch.GenericDocument} objects by document IDs in a namespace from the {@link
     * AppSearchSession} database.
     *
     ...
     *                 values are {@code null} on success, or a failed {@link android.app.appsearch.AppSearchResult}
     *                 otherwise. IDs that are not found will return a failed
     *                 {@link android.app.appsearch.AppSearchResult} with a result code of
     *                 {@link android.app.appsearch.AppSearchResult#RESULT_NOT_FOUND}. If an unexpected internal error
     *                 occurs in the AppSearch service, {@link BatchResultCallback#onSystemError}
     *                 will be invoked with a {@link Throwable}.
     */
     ...
     * android.app.appsearch.SearchSpec.Builder#addFilterNamespaces} and {@link android.app.appsearch.SearchSpec.Builder#addFilterSchemas}.
     *
    ...
    public void getStorageInfo(
            @NonNull @CallbackExecutor Executor executor,
            @NonNull Consumer<android.app.appsearch.AppSearchResult<android.app.appsearch.StorageInfo>> callback) {
        Objects.requireNonNull(executor);
        Objects.requireNonNull(callback);
        Preconditions.checkState(!mIsClosed, "AppSearchSession has already been closed");
        try {
                    ...
                    new IAppSearchResultCallback.Stub() {
                        ...
                        public void onResult(AppSearchResultParcel resultParcel) {
                            safeExecute(executor, callback, () -> {
                                android.app.appsearch.AppSearchResult<Bundle> result = resultParcel.getResult();
                                if (result.isSuccess()) {
                                    android.app.appsearch.StorageInfo response = new StorageInfo(
                                        Objects.requireNonNull(result.getResultValue()));
                                    callback.accept(android.app.appsearch.AppSearchResult.newSuccessfulResult(response));
                                } else {
                                    callback.accept(android.app.appsearch.AppSearchResult.newFailedResult(result));
                                ...
                                if (result.isSuccess()) {
                                    try {
                                        ...
                                        if (!internalSetSchemaResponse.isSuccess()) {
                                            ...
                                            callback.accept(android.app.appsearch.AppSearchResult.newFailedResult(
                                                    android.app.appsearch.AppSearchResult.RESULT_INVALID_SCHEMA,
                                                    internalSetSchemaResponse.getErrorMessage()));
                                            return;
                                        }
                                        callback.accept(android.app.appsearch.AppSearchResult.newSuccessfulResult(
                                                internalSetSchemaResponse.getSetSchemaResponse()));
                                    } catch (Throwable t) {
                                        // TODO(b/261897334) save SDK errors/crashes and send to
                                        //  server for logging.
                                        callback.accept(android.app.appsearch.AppSearchResult.throwableToFailedResult(t));
                                    }
                                } else {
                                    callback.accept(android.app.appsearch.AppSearchResult.newFailedResult(result));
                                }
    ...
    private void setSchemaWithMigrations(
        ...
        safeExecute(workExecutor, callback, () -> {
            try {
                ...
                AtomicReference<android.app.appsearch.AppSearchResult<GetSchemaResponse>> getSchemaResultRef =
                        new AtomicReference<>();
                ...
                android.app.appsearch.AppSearchResult<GetSchemaResponse> getSchemaResult = getSchemaResultRef.get();
                if (!getSchemaResult.isSuccess()) {
                    ...
                    safeExecute(
                            ...
                            callback,
                            () -> callback.accept(
                                    android.app.appsearch.AppSearchResult.newFailedResult(getSchemaResult)));
                    return;
                }
                ...
                Map<String, android.app.appsearch.Migrator> activeMigrators = SchemaMigrationUtil.getActiveMigrators(
                ...
                AtomicReference<android.app.appsearch.AppSearchResult<Bundle>> setSchemaResultRef =
                        new AtomicReference<>();
                ...
                android.app.appsearch.AppSearchResult<Bundle> setSchemaResult = setSchemaResultRef.get();
                if (!setSchemaResult.isSuccess()) {
                    ...
                    safeExecute(
                            ...
                            callback,
                            () -> callback.accept(
                                    android.app.appsearch.AppSearchResult.newFailedResult(setSchemaResult)));
                    return;
                }
                ...
                try (AppSearchMigrationHelper migrationHelper = new AppSearchMigrationHelper(
                    ...
                    if (internalSetSchemaResponse1.isSuccess()) {
                        ...
                        AtomicReference<android.app.appsearch.AppSearchResult<Bundle>> setSchema2ResultRef =
                                new AtomicReference<>();
                        ...
                        android.app.appsearch.AppSearchResult<Bundle> setSchema2Result = setSchema2ResultRef.get();
                        if (!setSchema2Result.isSuccess()) {
                            ...
                            safeExecute(
                                    ...
                                    callback,
                                    () -> callback.accept(
                                            android.app.appsearch.AppSearchResult.newFailedResult(setSchema2Result)));
                            return;
                        }
                        ...
                        if (!internalSetSchemaResponse2.isSuccess()) {
                            ...
                            safeExecute(
                                    ...
                                    callback,
                                    () -> callback.accept(
                                            android.app.appsearch.AppSearchResult.newFailedResult(
                    ...
                    // set.
                    android.app.appsearch.AppSearchResult<SetSchemaResponse> putResult =
