 ...
 * {@link Build.VERSION_CODES#P} {@link #onSaveInstanceState(Bundle)}
 ...
 * stopped (or paused on platform versions before {@link Build.VERSION_CODES#HONEYCOMB}).
...
public class Activity extends ContextThemeWrapper
    ...
    /*package*/ android.app.ActionBar mActionBar = null;
    ...
    /**
     * Sets the {@link LocusId} for this activity. The locus id
     ...
     *
     * @deprecated starting with {@link Build.VERSION_CODES#P} onSaveInstanceState is
     ...
     *
     * <p>Starting with {@link Build.VERSION_CODES#Q} multiple activities can be resumed
    ...
    /**
     * Set a {@link Toolbar Toolbar} to act as the {@link android.app.ActionBar} for this
     * Activity window.
     *
     ...
     *
     * <ul>
     *     <li>On platform versions prior to {@link Build.VERSION_CODES#S}, it
     *         finishes the current activity, but you can override this to do whatever you want.
     *
     *     <li><p>Starting with platform version {@link Build.VERSION_CODES#S}, for
     ...
     *
     *      <li><p>If you target version {@link Build.VERSION_CODES#S} and
     ...
     *
     *      <li><p>If you target version {@link Build.VERSION_CODES#TIRAMISU} or later,
     ...
     *
     * <p>Starting with {@link Build.VERSION_CODES#Q} there can be
     ...
     * versions prior to {@link Build.VERSION_CODES#Q},
     ...
     *
     * <p>Af of {@link Build.VERSION_CODES#S} application can only specify
    ...
    public Uri getReferrer() {
        ...
        if (intent != null) {
            try {
                Uri referrer = intent.getParcelableExtra(Intent.EXTRA_REFERRER, Uri.class);
                if (referrer != null) {
                    return referrer;
                }
     ...
     * {@link Build.VERSION_CODES#TIRAMISU} or later if the dump request starts with one
     ...
     * or finish the task.
     * <p>
     * Starting from Target SDK Level {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, apps
