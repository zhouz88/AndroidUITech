...
public class ApplicationErrorReport implements Parcelable {
    ...
    public static class ParcelableCrashInfo extends CrashInfo implements Parcelable {
        ...
        public static final @android.annotation.NonNull Creator<ParcelableCrashInfo> CREATOR =
    ...
    public static final @android.annotation.NonNull Creator<ApplicationErrorReport> CREATOR
