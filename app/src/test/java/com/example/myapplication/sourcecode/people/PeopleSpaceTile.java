...
package com.example.myapplication.sourcecode.people;
...
public class PeopleSpaceTile implements Parcelable {
     ...
     * click, rather than calling {@link LauncherApps} to launch the shortcut ID.
     *
    ...
    /** Converts a {@link PeopleSpaceTile} into a {@link Builder}. */
    ...
    public PeopleSpaceTile(Parcel in) {
        ...
        mUserIcon = in.readParcelable(Icon.class.getClassLoader(), Icon.class);
        mContactUri = in.readParcelable(Uri.class.getClassLoader(), Uri.class);
        mUserHandle = in.readParcelable(UserHandle.class.getClassLoader(), UserHandle.class);
        ...
        mNotificationDataUri = in.readParcelable(Uri.class.getClassLoader(), Uri.class);
        mMessagesCount = in.readInt();
        mIntent = in.readParcelable(Intent.class.getClassLoader(), Intent.class);
        mNotificationTimestamp = in.readLong();
        mStatuses = new ArrayList<>();
        in.readParcelableList(mStatuses, ConversationStatus.class.getClassLoader(), ConversationStatus.class);
