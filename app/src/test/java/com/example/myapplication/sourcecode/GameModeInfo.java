...
/**
 * GameModeInfo returned from {@link android.app.GameManager#getGameModeInfo(String)}.
 *
...
public final class GameModeInfo implements Parcelable {
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder setAvailableGameModes(
                @NonNull @android.app.GameManager.GameMode int[] availableGameModes) {
         ...
         */
        @NonNull
        public Builder setOverriddenGameModes(
                @NonNull @android.app.GameManager.GameMode int[] overriddenGameModes) {
         ...
         */
        @NonNull
        public Builder setActiveGameMode(
                @NonNull @android.app.GameManager.GameMode int activeGameMode) {
        ...
        public Builder setGameModeConfiguration(
                @android.app.GameManager.GameMode int gameMode,
        ...
        private @android.app.GameManager.GameMode int[] mAvailableGameModes = new int[]{};
        private @android.app.GameManager.GameMode int[] mOverriddenGameModes = new int[]{};
        private @android.app.GameManager.GameMode int mActiveGameMode;
     ...
     */
    public GameModeInfo(@android.app.GameManager.GameMode int activeGameMode,
            @NonNull @android.app.GameManager.GameMode int[] availableGameModes) {
        this(activeGameMode, availableGameModes, new int[]{}, true, true, new ArrayMap<>());
    }

    private GameModeInfo(@android.app.GameManager.GameMode int activeGameMode,
                         @NonNull @android.app.GameManager.GameMode int[] availableGameModes,
                         @NonNull @android.app.GameManager.GameMode int[] overriddenGameModes, boolean isDownscalingAllowed,
    ...
    /**
     * Returns the {@link android.app.GameManager.GameMode} the application is currently using.
     */
    public @android.app.GameManager.GameMode int getActiveGameMode() {
        return mActiveGameMode;
    }

    /**
     * Gets the collection of {@link android.app.GameManager.GameMode} that can be applied to the game.
     * <p>
     ...
     * enabled modes for any game including {@link android.app.GameManager#GAME_MODE_STANDARD} and
     * {@link android.app.GameManager#GAME_MODE_CUSTOM}.
     * <p>
     * Also see {@link GameModeInfo}.
     */
    @NonNull
    public @android.app.GameManager.GameMode int[] getAvailableGameModes() {
        return Arrays.copyOf(mAvailableGameModes, mAvailableGameModes.length);
    }

    /**
     * Gets the collection of {@link android.app.GameManager.GameMode} that are overridden by the game.
     * <p>
     * Also see {@link GameModeInfo}.
     */
    @NonNull
    public @android.app.GameManager.GameMode int[] getOverriddenGameModes() {
    ...
    private final @android.app.GameManager.GameMode int[] mAvailableGameModes;
    private final @android.app.GameManager.GameMode int[] mOverriddenGameModes;
