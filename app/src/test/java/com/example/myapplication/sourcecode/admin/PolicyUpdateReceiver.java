 ...
 *
 * <p>Admins can implement {@link android.app.admin.DeviceAdminService} to ensure they receive all policy updates
...
public abstract class PolicyUpdateReceiver extends BroadcastReceiver {
    ...
    /**
     * Int extra containing the {@link android.app.admin.PolicyUpdateResult} code.
     *
     * @hide
     */
    @TestApi
     ...
     */
    @NonNull
    static android.app.admin.PolicyUpdateResult getPolicyChangedReason(Intent intent) {
        ...
        int reasonCode = intent.getIntExtra(
                EXTRA_POLICY_UPDATE_RESULT_KEY, android.app.admin.PolicyUpdateResult.RESULT_FAILURE_UNKNOWN);
        return new android.app.admin.PolicyUpdateResult(reasonCode);
    }
     ...
     */
    @NonNull
    static android.app.admin.TargetUser getTargetUser(Intent intent) {
        ...
        int targetUserId = intent.getIntExtra(
                EXTRA_POLICY_TARGET_USER_ID, android.app.admin.TargetUser.LOCAL_USER_ID);
        return new android.app.admin.TargetUser(targetUserId);
    }
     ...
     *                               needed.
     * @param targetUser The {@link android.app.admin.TargetUser} which this policy relates to.
     * @param policyUpdateResult Indicates whether the policy has been set successfully
     *                           ({@link android.app.admin.PolicyUpdateResult#RESULT_POLICY_SET}) or the reason it
     *                           failed to apply (e.g.
     *                           {@link android.app.admin.PolicyUpdateResult#RESULT_FAILURE_CONFLICTING_ADMIN_POLICY},
     *                           etc).
     */
    public void onPolicySetResult(
            ...
            @NonNull android.app.admin.TargetUser targetUser,
            @NonNull android.app.admin.PolicyUpdateResult policyUpdateResult) {}
     ...
     *                           (e.g. {@link android.app.admin.PolicyUpdateResult#RESULT_POLICY_SET} if the policy
