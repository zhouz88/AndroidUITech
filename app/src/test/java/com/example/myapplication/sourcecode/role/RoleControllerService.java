...
package com.example.myapplication.sourcecode.role;
...
public abstract class RoleControllerService extends Service {
    ...
    private void onAddRoleHolder(@NonNull String roleName, @NonNull String packageName,
                                 @android.app.role.RoleManager.ManageHoldersFlags int flags, @NonNull RemoteCallback callback) {
     ...
     * @return whether this call was successful
     *
     * @see android.app.role.RoleManager#addRoleHolderAsUser(String, String, int, UserHandle, Executor,
     *      RemoteCallback)
     */
    @WorkerThread
    public abstract boolean onAddRoleHolder(@NonNull String roleName, @NonNull String packageName,
            @android.app.role.RoleManager.ManageHoldersFlags int flags);
     ...
     * @return whether this call was successful
     *
     * @see android.app.role.RoleManager#removeRoleHolderAsUser(String, String, int, UserHandle, Executor,
     *      RemoteCallback)
     */
    @WorkerThread
    public abstract boolean onRemoveRoleHolder(@NonNull String roleName,
            @NonNull String packageName, @android.app.role.RoleManager.ManageHoldersFlags int flags);
     ...
     * @return whether this call was successful
     *
     * @see android.app.role.RoleManager#clearRoleHoldersAsUser(String, int, UserHandle, Executor, RemoteCallback)
     */
    @WorkerThread
