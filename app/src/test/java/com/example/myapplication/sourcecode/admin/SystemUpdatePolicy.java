...
public final class SystemUpdatePolicy implements Parcelable {
    ...
    public static final class ValidationFailedException extends IllegalArgumentException
        ...
        public static final @android.annotation.NonNull Creator<ValidationFailedException> CREATOR =
                new Creator<ValidationFailedException>() {
            @Override
    ...
    private final ArrayList<android.app.admin.FreezePeriod> mFreezePeriods;
     ...
     */
    public SystemUpdatePolicy setFreezePeriods(List<android.app.admin.FreezePeriod> freezePeriods) {
        android.app.admin.FreezePeriod.validatePeriods(freezePeriods);
     ...
     */
    public List<android.app.admin.FreezePeriod> getFreezePeriods() {
    ...
    public Pair<LocalDate, LocalDate> getCurrentFreezePeriod(LocalDate now) {
        for (android.app.admin.FreezePeriod interval : mFreezePeriods) {
    ...
    private long timeUntilNextFreezePeriod(long now) {
        List<android.app.admin.FreezePeriod> sortedPeriods = android.app.admin.FreezePeriod.canonicalizePeriods(mFreezePeriods);
        LocalDate nowDate = millisToDate(now);
        LocalDate nextFreezeStart = null;
        for (android.app.admin.FreezePeriod interval : sortedPeriods) {
    ...
    public void validateFreezePeriods() {
        android.app.admin.FreezePeriod.validatePeriods(mFreezePeriods);
    }

    /** @hide */
    public void validateAgainstPreviousFreezePeriod(LocalDate prevPeriodStart,
            LocalDate prevPeriodEnd, LocalDate now) {
        android.app.admin.FreezePeriod.validateAgainstPreviousFreezePeriod(mFreezePeriods, prevPeriodStart,
                prevPeriodEnd, now);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        for (int i = 0; i < freezeCount; i++) {
            android.app.admin.FreezePeriod interval = mFreezePeriods.get(i);
    ...
    public static final @android.annotation.NonNull Creator<SystemUpdatePolicy> CREATOR =
            new Creator<SystemUpdatePolicy>() {
                ...
                public SystemUpdatePolicy createFromParcel(Parcel source) {
                    ...
                    for (int i = 0; i < freezeCount; i++) {
                        ...
                        policy.mFreezePeriods.add(new android.app.admin.FreezePeriod(start, end));
                    }
                    return policy;
                }
    ...
    public static SystemUpdatePolicy restoreFromXml(TypedXmlPullParser parser) {
        try {
            ...
            while ((type = parser.next()) != END_DOCUMENT
                ...
                policy.mFreezePeriods.add(new android.app.admin.FreezePeriod(
