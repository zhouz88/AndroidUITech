...
class LoaderManagerImpl extends LoaderManager {
    ...
    LoaderManagerImpl(String who, android.app.FragmentHostCallback host, boolean started) {
        mWho = who;
        mHost = host;
        mStarted = started;
    }
     ...
     * {@link android.app.LoaderManager.LoaderCallbacks#onCreateLoader(int, Bundle) LoaderCallbacks.onCreateLoader()}.
