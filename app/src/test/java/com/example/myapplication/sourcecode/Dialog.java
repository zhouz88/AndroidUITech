 ...
 * restoring of dialogs. See {@link android.app.Activity#onCreateDialog(int)},
 * {@link android.app.Activity#onPrepareDialog(int, Dialog)},
 * {@link android.app.Activity#showDialog(int)}, and {@link android.app.Activity#dismissDialog(int)}. If
...
public class Dialog implements DialogInterface, Window.Callback,
    ...
    /**
     * Retrieve the {@link android.app.ActionBar} attached to this dialog, if present.
     *
     ...
     */
    public final void setOwnerActivity(@NonNull android.app.Activity activity) {
     ...
     * {@link android.app.Activity#showDialog(int)} is used to show this Dialog, that
     ...
     */
    public final @Nullable android.app.Activity getOwnerActivity() {
    ...
    /**
     * Similar to {@link android.app.Activity#onCreate}, you should initialize your dialog
     ...
     * dialog has not yet been fully created (for example, via {@link #}
     * or {@link #create()}).
     * <p>
     ...
     * @param params Layout parameters for the view.
     */
    public void addContentView(@NonNull View view, @Nullable LayoutParams params) {
     ...
     * and, as of {@link Build.VERSION_CODES#P P}, {@link KeyEvent#KEYCODE_ESCAPE
     ...
     *
     * <p>
     * If you target version {@link Build.VERSION_CODES#TIRAMISU} or later, you
     ...
     * {@link android.app.Activity#onCreateOptionsMenu(Menu)} if the client desires the same
    ...
    /**
     * It is usually safe to proxy this call to the owner activity's
     * {@link android.app.Activity#onPrepareOptionsMenu(Menu)} if the client desires the
     ...
     * @see #setOwnerActivity(android.app.Activity)
     */
