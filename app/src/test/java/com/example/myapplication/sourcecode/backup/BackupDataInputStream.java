...
package com.example.myapplication.sourcecode.backup;
...
/**
 * Provides an {@link InputStream}-like interface for accessing an
 * entity's data during a restore operation. Used by {@link android.app.backup.BackupHelper} classes within the {@link
 * android.app.backup.BackupAgentHelper} mechanism.
 * <p>
 * When {@link android.app.backup.BackupHelper#restoreEntity(BackupDataInputStream) BackupHelper.restoreEntity()}
 * is called, the current entity's header has already been read from the underlying
 * {@link android.app.backup.BackupDataInput}.  The entity's key string and total data size are available
...
public class BackupDataInputStream extends InputStream {
    ...
    /** @hide */
    BackupDataInputStream(android.app.backup.BackupDataInput data) {
        mData = data;
    }
     ...
     *   {@link android.app.backup.BackupDataInput#getKey()} on the underlying {@link android.app.backup.BackupDataInput}.
     */
     ...
     *   {@link android.app.backup.BackupDataInput#getDataSize()} on the underlying {@link BackupDataInput}.
     */
    public int size() {
