...
public class StatusBarManager {
     ...
     * Build.VERSION_CODES.S} or higher will need {@link Manifest.permission.STATUS_BAR}
     * permission to call this API.
     *
     * @hide
     */
    @RequiresPermission(Manifest.permission.STATUS_BAR)
   ...
   /**
     ...
     * @hide
     */
    @RequiresPermission(allOf = {Manifest.permission.READ_COMPAT_CHANGE_CONFIG,
    ...
    /**
     * Checks whether the supplied activity can {@link android.app.Activity#startActivityForResult(Intent, int)}
     ...
     * activity.
     *
     * <p>When {@code true}, callers can use {@link android.app.Activity#startActivityForResult(Intent, int)}
