...
public class Instrumentation {
    ...
    public void addResults(Bundle results) {
        IActivityManager am = android.app.ActivityManager.getService();
        try {
     ...
     */
    public android.app.Activity startActivitySync(Intent intent) {
     ...
     */
    @NonNull
    public android.app.Activity startActivitySync(@NonNull Intent intent, @Nullable Bundle options) {
        validateNotAppThread();
    ...
    public static class ActivityMonitor {
        ...
        /*package*/ android.app.Activity mLastActivity = null;
         ...
         * {@link android.app.ActivityManager}, like {@link android.app.ActivityManager#START_SUCCESS}.
         *
         * @param result the result code that returns after starting an Activity.
         * @param bOptions the bundle generated from {@link android.app.ActivityOptions} that originally
     ...
     */
    public android.app.Activity waitForMonitor(ActivityMonitor monitor) {
     ...
     * @return The Activity object that matched the monitor.
     */
    public android.app.Activity waitForMonitorWithTimeout(ActivityMonitor monitor, long timeOut) {
     ...
     */
    public boolean invokeMenuActionSync(android.app.Activity targetActivity,
                                        int id, int flag) {
        class MenuRunnable implements Runnable {
            ...
            public MenuRunnable(android.app.Activity _activity, int _identifier,
                                int _flags) {
                activity = _activity;
    ...
    public boolean invokeContextMenuAction(android.app.Activity targetActivity, int id, int flag) {
        ...
        class ContextMenuRunnable implements Runnable {
            ...
            public ContextMenuRunnable(android.app.Activity _activity, int _identifier,
                                       int _flags) {
                activity = _activity;
                identifier = _identifier;
                flags = _flags;
    ...
    /**
     * Perform instantiation of the process's {@link android.app.Application} object.  The
     ...
     */
    public android.app.Application newApplication(ClassLoader cl, String className, Context context)
            throws InstantiationException, IllegalAccessException, 
            ClassNotFoundException {
        android.app.Application app = getFactory(context.getPackageName())
     ...
     * @return The newly instantiated Application object.
     */
    static public android.app.Application newApplication(Class<?> clazz, Context context)
            throws InstantiationException, IllegalAccessException, 
            ClassNotFoundException {
    ...
    /**
     * Perform calling of the application's {@link android.app.Application#onCreate}
    ...
    /**
     * Perform instantiation of an {@link android.app.Activity} object.  This method is intended for use with
     ...
     * available via {@link android.app.Activity#getLastNonConfigurationInstance()
     * Activity.getLastNonConfigurationInstance()}.
     * @return Returns the instantiated activity
     * @throws InstantiationException
     * @throws IllegalAccessException
     */
    public android.app.Activity newActivity(Class<?> clazz, Context context,
                                            IBinder token, android.app.Application application, Intent intent, ActivityInfo info,
                                            CharSequence title, android.app.Activity parent, String id,
        ...
        activity.attach(context, aThread, this, token, 0 /* ident */, application, intent,
                ...
                (android.app.Activity.NonConfigurationInstances)lastNonConfigurationInstance,
    ...
    /**
     * Perform instantiation of the process's {@link android.app.Activity} object.  The
     * default implementation provides the normal system behavior.
     * 
     * @param cl The ClassLoader with which to instantiate the object.
     ...
     */
    public android.app.Activity newActivity(ClassLoader cl, String className,
                                            Intent intent)
            throws InstantiationException, IllegalAccessException,
            ClassNotFoundException {
    ...
    private android.app.AppComponentFactory getFactory(String pkg) {
        if (pkg == null) {
        ...
        synchronized (mSync) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (am.ignoreMatchingSpecificIntents()) {
                    if (options == null) {
                        options = android.app.ActivityOptions.makeBasic().toBundle();
                    }
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onCreate}
     * method.  The default implementation simply calls through to that method.
     *
...
//      }
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onRestoreInstanceState}
     * method.  The default implementation simply calls through to that method.
     *
     * @param activity The activity being restored.
     * @param savedInstanceState The previously saved state being restored.
     */
    public void callActivityOnRestoreInstanceState(@NonNull android.app.Activity activity,
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onPostCreate} method.
     ...
     *               onPostCreate().
     */
    public void callActivityOnPostCreate(@NonNull android.app.Activity activity,
            @Nullable Bundle savedInstanceState) {
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onNewIntent}
     * method.  The default implementation simply calls through to that method.
     * 
     * @param activity The activity receiving a new Intent.
     * @param intent The new intent being received.
     */
    public void callActivityOnNewIntent(android.app.Activity activity, Intent intent) {
    ...
    public void callActivityOnNewIntent(android.app.Activity activity, ReferrerIntent intent) {
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onStart}
     * method.  The default implementation simply calls through to that method.
     * 
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onRestart}
     * method.  The default implementation simply calls through to that method.
     * 
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onResume} method.  The
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onStop}
     * method.  The default implementation simply calls through to that method.
     * 
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onSaveInstanceState}
     * method.  The default implementation simply calls through to that method.
     *
     * @param activity The activity being saved.
     * @param outState The bundle to pass to the call.
     */
    public void callActivityOnSaveInstanceState(@NonNull android.app.Activity activity,
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onPause} method.  The
     * default implementation simply calls through to that method.
     * 
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onUserLeaveHint} method.
     * The default implementation simply calls through to that method.
     * 
    ...
    /**
     * Perform calling of an activity's {@link android.app.Activity#onPictureInPictureRequested} method.
     * The default implementation simply calls through to that method.
     *
     * @param activity The activity being notified that picture-in-picture is being requested.
     */
    public void callActivityOnPictureInPictureRequested(@NonNull android.app.Activity activity) {
    ...
    public static final class ActivityResult {
        /**
         * Create a new activity result.  See {@link android.app.Activity#setResult} for
         * more information. 
         *  
    ...
    /**
     * Like {@link #execStartActivity(Context, IBinder, IBinder, android.app.Activity, Intent, int, Bundle)},
    ...
    public void execStartActivities(Context who, IBinder contextThread,
                                    IBinder token, android.app.Activity target, Intent[] intents, Bundle options) {
     ...
     * the array.
     *
     * @return The corresponding flag {@link android.app.ActivityManager#START_CANCELED},
     *         {@link android.app.ActivityManager#START_SUCCESS} etc. indicating whether the launch was
     *         successful.
     *
     * {@hide}
     */
        ...
        if (mActivityMonitors != null) {
            synchronized (mSync) {
                ...
                for (int i=0; i<N; i++) {
                    ...
                    if (result != null) {
                        am.mHits++;
                        return android.app.ActivityManager.START_CANCELED;
    ...
    public static void checkStartActivityResult(int res, Object intent) {
        if (!android.app.ActivityManager.isStartResultFatalError(res)) {
            return;
        }
        ...
        switch (res) {
            ...
            case android.app.ActivityManager.START_ASSISTANT_NOT_ACTIVE_SESSION:
                throw new IllegalStateException(
                        "Session calling startAssistantActivity does not match active session");
            case android.app.ActivityManager.START_ASSISTANT_HIDDEN_SESSION:
                throw new IllegalStateException(
