...
class FragmentTransition {
     ...
     * set on the leaving Fragment's {@link android.app.Fragment#getExitTransition()}, the
     * entering Fragment's {@link android.app.Fragment#getEnterTransition()} and
     * {@link android.app.Fragment#getSharedElementEnterTransition()}. When popping,
     * the leaving Fragment's {@link android.app.Fragment#getReturnTransition()} and
     * {@link android.app.Fragment#getSharedElementReturnTransition()} and the entering
     * {@link android.app.Fragment#getReenterTransition()} will be run.
     * <p>
    ...
    static void startTransitions(FragmentManagerImpl fragmentManager,
        ...
        if (fragmentManager.mCurState < android.app.Fragment.CREATED) {
            return;
        }
     ...
     *                      {@link android.app.FragmentTransaction#addSharedElement(View, String)}.
     */
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentManager,
        ...
        final android.app.Fragment inFragment = fragments.lastIn;
        final android.app.Fragment outFragment = fragments.firstOut;
     ...
     */
    private static void replaceHide(Transition exitTransition, android.app.Fragment exitingFragment,
    ...
    private static void scheduleTargetChange(final ViewGroup sceneRoot,
                                             final android.app.Fragment inFragment, final View nonExistentView,
     ...
     * exists.
     */
    private static TransitionSet getSharedElementTransition(android.app.Fragment inFragment,
                                                            android.app.Fragment outFragment, boolean isPop) {
     ...
     */
    private static Transition getEnterTransition(android.app.Fragment inFragment, boolean isPop) {
        if (inFragment == null) {
            return null;
        }
     ...
     */
    private static Transition getExitTransition(android.app.Fragment outFragment, boolean isPop) {
        if (outFragment == null) {
            return null;
        }
    ...
    private static ArrayMap<String, View> captureInSharedElements(
            ArrayMap<String, String> nameOverrides, TransitionSet sharedElementTransition,
            FragmentContainerTransition fragments) {
        android.app.Fragment inFragment = fragments.lastIn;
     ...
     */
    private static void callSharedElementStartEnd(android.app.Fragment inFragment, android.app.Fragment outFragment,
    ...
    private static ArrayList<View> configureEnteringExitingViews(Transition transition,
                                                                 android.app.Fragment fragment, ArrayList<View> sharedElements, View nonExistentView) {
    ...
    private static Transition mergeTransitions(Transition enterTransition,
            Transition exitTransition, Transition sharedElementTransition, android.app.Fragment inFragment,
            boolean isPop) {
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, BackStackRecord.Op op,
        ...
        final android.app.Fragment fragment = op.fragment;
        if (fragment == null) {
        ...
        if (!isReorderedTransaction && wasAdded) {
            ...
            if (fragment.mState < android.app.Fragment.CREATED && manager.mCurState >= android.app.Fragment.CREATED &&
                    manager.mHost.getContext().getApplicationInfo().targetSdkVersion >=
                            Build.VERSION_CODES.N && !transaction.mReorderingAllowed) {
                manager.makeActive(fragment);
                manager.moveToState(fragment, android.app.Fragment.CREATED, 0, 0, false);
            }
        }
