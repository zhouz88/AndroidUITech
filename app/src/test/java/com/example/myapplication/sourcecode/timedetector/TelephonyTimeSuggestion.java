...
package com.example.myapplication.sourcecode.timedetector;
...
public final class TelephonyTimeSuggestion implements Parcelable {
    ...
    /** @hide */
    public static final @NonNull Creator<TelephonyTimeSuggestion> CREATOR =
            new Creator<TelephonyTimeSuggestion>() {
    ...
    private static TelephonyTimeSuggestion createFromParcel(Parcel in) {
        ...
        TelephonyTimeSuggestion suggestion = new Builder(slotIndex)
                .setUnixEpochTime(unixEpochTime)
                .build();
        @SuppressWarnings("unchecked")
        ArrayList<String> debugInfo = in.readArrayList(
                null /* classLoader */, String.class);
        if (debugInfo != null) {
