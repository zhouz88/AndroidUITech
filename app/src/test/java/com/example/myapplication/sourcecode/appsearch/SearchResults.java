 ...
 *
 * <p>Each {@link AppSearchSession#search} operation returns a list of {@link android.app.appsearch.SearchResult} objects,
 * referred to as a "page", limited by the size configured by {@link
 * android.app.appsearch.SearchSpec.Builder#setResultCountPerPage}.
 *
...
public class SearchResults implements Closeable {
    ...
    private final android.app.appsearch.SearchSpec mSearchSpec;
    ...
    SearchResults(
            ...
            @NonNull android.app.appsearch.SearchSpec searchSpec,
    ...
    /**
     * Retrieves the next page of {@link android.app.appsearch.SearchResult} objects.
     *
    ...
    public void getNextPage(
            ...
            @NonNull Consumer<AppSearchResult<List<android.app.appsearch.SearchResult>>> callback) {
