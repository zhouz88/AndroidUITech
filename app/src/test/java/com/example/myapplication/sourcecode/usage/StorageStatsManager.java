...
public class StorageStatsManager {
     ...
     */
    @WorkerThread
    public @NonNull android.app.usage.StorageStats queryStatsForPackage(@NonNull UUID storageUuid,
    ...
    /** @removed */
    @Deprecated
    public android.app.usage.StorageStats queryStatsForPackage(String uuid, String packageName,
     ...
     */
    @WorkerThread
    public @NonNull android.app.usage.StorageStats queryStatsForUid(@NonNull UUID storageUuid, int uid)
            throws IOException {
        try {
    ...
    /** @removed */
    @Deprecated
    public android.app.usage.StorageStats queryStatsForUid(String uuid, int uid) throws IOException {
     ...
     */
    @WorkerThread
    public @NonNull android.app.usage.StorageStats queryStatsForUser(@NonNull UUID storageUuid,
