...
public final class Slice implements Parcelable {
    ...
    public static class Builder {
         ...
         * @see SliceItem#getSubType()
         */
        public Builder addAction(@NonNull PendingIntent action, @NonNull Slice s,
         ...
         */
        @Deprecated
        public Builder addTimestamp(long time, @Nullable @SliceSubtype String subType,
                @SliceHint List<String> hints) {
         ...
         * @see SliceItem#getSubType()
         */
        public Builder addLong(long value, @Nullable @SliceSubtype String subType,
                @SliceHint List<String> hints) {
         ...
         * @see SliceItem#getSubType()
         */
        public Builder addBundle(Bundle bundle, @Nullable @SliceSubtype String subType,
                @SliceHint List<String> hints) {
    ...
    public static final @NonNull Creator<Slice> CREATOR = new Creator<Slice>() {
        @Override
