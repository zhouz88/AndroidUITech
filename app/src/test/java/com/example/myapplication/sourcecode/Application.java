...
public class Application extends ContextWrapper implements ComponentCallbacks2 {
    ...
    public interface ActivityLifecycleCallbacks {
         ...
         */
        default void onActivityPreCreated(@NonNull android.app.Activity activity,
                @Nullable Bundle savedInstanceState) {
        }

        /**
         * Called when the Activity calls {@link android.app.Activity#onCreate super.onCreate()}.
         */
        void onActivityCreated(@NonNull android.app.Activity activity, @Nullable Bundle savedInstanceState);

        /**
         * Called as the last step of the Activity being created. This is always called after
         * {@link android.app.Activity#onCreate}.
         */
        default void onActivityPostCreated(@NonNull android.app.Activity activity,
                @Nullable Bundle savedInstanceState) {
        }
         ...
         */
        default void onActivityPreStarted(@NonNull android.app.Activity activity) {
        }

        /**
         * Called when the Activity calls {@link android.app.Activity#onStart super.onStart()}.
         */
        void onActivityStarted(@NonNull android.app.Activity activity);

        /**
         * Called as the last step of the Activity being started. This is always called after
         * {@link android.app.Activity#onStart}.
         */
        default void onActivityPostStarted(@NonNull android.app.Activity activity) {
        }
         ...
         */
        default void onActivityPreResumed(@NonNull android.app.Activity activity) {
        }

        /**
         * Called when the Activity calls {@link android.app.Activity#onResume super.onResume()}.
         */
        void onActivityResumed(@NonNull android.app.Activity activity);

        /**
         * Called as the last step of the Activity being resumed. This is always called after
         * {@link android.app.Activity#onResume} and {@link android.app.Activity#onPostResume}.
         */
        default void onActivityPostResumed(@NonNull android.app.Activity activity) {
        }
         ...
         */
        default void onActivityPrePaused(@NonNull android.app.Activity activity) {
        }

        /**
         * Called when the Activity calls {@link android.app.Activity#onPause super.onPause()}.
         */
        void onActivityPaused(@NonNull android.app.Activity activity);

        /**
         * Called as the last step of the Activity being paused. This is always called after
         * {@link android.app.Activity#onPause}.
         */
        default void onActivityPostPaused(@NonNull android.app.Activity activity) {
        }
         ...
         */
        default void onActivityPreStopped(@NonNull android.app.Activity activity) {
        }

        /**
         * Called when the Activity calls {@link android.app.Activity#onStop super.onStop()}.
         */
        void onActivityStopped(@NonNull android.app.Activity activity);

        /**
         * Called as the last step of the Activity being stopped. This is always called after
         * {@link android.app.Activity#onStop}.
         */
        default void onActivityPostStopped(@NonNull android.app.Activity activity) {
        }

        /**
         * Called as the first step of the Activity saving its instance state. This is always
         * called before {@link android.app.Activity#onSaveInstanceState}.
         */
        default void onActivityPreSaveInstanceState(@NonNull android.app.Activity activity,
                @NonNull Bundle outState) {
        }

        /**
         * Called when the Activity calls
         * {@link android.app.Activity#onSaveInstanceState super.onSaveInstanceState()}.
         */
        void onActivitySaveInstanceState(@NonNull android.app.Activity activity, @NonNull Bundle outState);

        /**
         * Called as the last step of the Activity saving its instance state. This is always
         * called after{@link android.app.Activity#onSaveInstanceState}.
         */
        default void onActivityPostSaveInstanceState(@NonNull android.app.Activity activity,
                @NonNull Bundle outState) {
        }
         ...
         */
        default void onActivityPreDestroyed(@NonNull android.app.Activity activity) {
        }

        /**
         * Called when the Activity calls {@link android.app.Activity#onDestroy super.onDestroy()}.
         */
        void onActivityDestroyed(@NonNull android.app.Activity activity);

        /**
         * Called as the last step of the Activity being destroyed. This is always called after
         * {@link android.app.Activity#onDestroy}.
         */
        default void onActivityPostDestroyed(@NonNull android.app.Activity activity) {
        }
         ...
         * @hide
         */
        default void onActivityConfigurationChanged(@NonNull android.app.Activity activity) {
        }
    }
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPreCreated(@NonNull android.app.Activity activity,
            @Nullable Bundle savedInstanceState) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivityCreated(@NonNull android.app.Activity activity,
            @Nullable Bundle savedInstanceState) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostCreated(@NonNull android.app.Activity activity,
            @Nullable Bundle savedInstanceState) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPreStarted(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivityStarted(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostStarted(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPreResumed(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivityResumed(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostResumed(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPrePaused(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivityPaused(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostPaused(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPreStopped(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivityStopped(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostStopped(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPreSaveInstanceState(@NonNull android.app.Activity activity,
            @NonNull Bundle outState) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivitySaveInstanceState(@NonNull android.app.Activity activity,
            @NonNull Bundle outState) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostSaveInstanceState(@NonNull android.app.Activity activity,
            @NonNull Bundle outState) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPreDestroyed(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    @UnsupportedAppUsage
    /* package */ void dispatchActivityDestroyed(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i=0; i<callbacks.length; i++) {
    ...
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
        /* package */ void dispatchActivityPostDestroyed(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    /* package */ void dispatchActivityConfigurationChanged(@NonNull android.app.Activity activity) {
        Object[] callbacks = collectActivityLifecycleCallbacks();
        if (callbacks != null) {
            for (int i = 0; i < callbacks.length; i++) {
    ...
    /* package */ void dispatchOnProvideAssistData(android.app.Activity activity, Bundle data) {
        Object[] callbacks;
        synchronized (this) {
            if (mAssistCallbacks == null) {
                return;
