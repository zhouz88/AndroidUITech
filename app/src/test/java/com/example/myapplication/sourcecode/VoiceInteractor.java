...
/**
 * Interface for an {@link android.app.Activity} to interact with the user through voice.  Use
...
public final class VoiceInteractor {
    ...
    public static abstract class Request {
        ...
        /**
         * Return the current {@link android.app.Activity} this request is associated with.  Will change
    ...
    public static class PickOptionRequest extends Request {
        ...
        public static final class Option implements Parcelable {
            ...
            public static final @NonNull Creator<Option> CREATOR
                    = new Creator<Option>() {
    ...
    public static class Prompt implements Parcelable {
        ...
        public static final @NonNull Creator<Prompt> CREATOR
                = new Creator<Prompt>() {
    ...
    VoiceInteractor(IVoiceInteractor interactor, Context context, android.app.Activity activity,
            Looper looper) {
