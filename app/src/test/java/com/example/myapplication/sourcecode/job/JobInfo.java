...
public class JobInfo implements Parcelable {
     ...
     *             {@link NetworkRequest.Builder#addTransportType(int)}
     ...
     * {@link JobService#startForeground(int, Notification)} to run
     * in the foreground.
     * <p>
    ...
    /**
     * @see Builder#setTransientExtras(Bundle)
     */
    ...
    /**
     * @see Builder#setClipData(ClipData, int)
     */
    ...
    /**
     * @hide
     * @see Builder#setPrefersBatteryNotLow(boolean)
     */
    ...
    /**
     * @hide
     * @see Builder#setPrefersCharging(boolean)
     */
    ...
    /**
     * @hide
     * @see Builder#setPrefersDeviceIdle(boolean)
     */
    ...
    /**
     * @see Builder#setRequiresCharging(boolean)
     */
    ...
    /**
     * @see Builder#setRequiresBatteryNotLow(boolean)
     */
    ...
    /**
     * @see Builder#setRequiresDeviceIdle(boolean)
     */
    ...
    /**
     * @see Builder#setRequiresStorageNotLow(boolean)
     */
     ...
     * @see Builder#addTriggerContentUri(TriggerContentUri)
     */
     ...
     * @see Builder#setTriggerContentUpdateDelay(long)
     */
     ...
     * @see Builder#setTriggerContentMaxDelay(long)
     */
     ...
     * @see Builder#setMinimumLatency(long)
     */
    ...
    /**
     * @see Builder#setOverrideDeadline(long)
     */
    ...
    /**
     * @see Builder#setPersisted(boolean)
     */
     ...
     * @see Builder#setBackoffCriteria(long, int)
     */
    ...
    /**
     * @see Builder#setExpedited(boolean)
     */
    ...
    /**
     * @see Builder#setUserInitiated(boolean)
     */
    ...
    /**
     * @see Builder#setImportantWhileForeground(boolean)
     */
    ...
    /**
     * @see Builder#setPrefetch(boolean)
     */
    ...
    public static final class TriggerContentUri implements Parcelable {
        ...
        public static final @NonNull Creator<TriggerContentUri> CREATOR = new Creator<TriggerContentUri>() {
            @Override
    ...
    public static final class Builder {
         ...
         * provided to {@link Builder#setEstimatedNetworkBytes(long, long)}.
         *
         * <p>
         ...
         * will result in an {@link IllegalArgumentException} when
         ...
         *
         * <p>
         * In {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, user-initiated jobs can only
