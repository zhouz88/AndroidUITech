...
public final class SearchResult {
     ...
     *
     * @return List of matches based on {@link android.app.appsearch.SearchSpec}. If snippeting is disabled using {@link
     *     android.app.appsearch.SearchSpec.Builder#setSnippetCount} or {@link
     *     android.app.appsearch.SearchSpec.Builder#setSnippetCountPerProperty}, for all results after that value, this
     ...
     * set in {@link android.app.appsearch.SearchSpec.Builder#setRankingStrategy(int)}.
     *
     * <p>The meaning of the ranking signal and its value is determined by the selected ranking
     * strategy:
     *
     * <ul>
     *   <li>{@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_NONE} - this value will be 0
     *   <li>{@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_DOCUMENT_SCORE} - the value returned by calling
     *       {@link GenericDocument#getScore()} on the document returned by {@link
     *       #getGenericDocument()}
     *   <li>{@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_CREATION_TIMESTAMP} - the value returned by calling
     *       {@link GenericDocument#getCreationTimestampMillis()} on the document returned by {@link
     *       #getGenericDocument()}
     *   <li>{@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_RELEVANCE_SCORE} - an arbitrary double value where a
     *       higher value means more relevant
     *   <li>{@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_USAGE_COUNT} - the number of times usage has been
     *       reported for the document returned by {@link #getGenericDocument()}
     *   <li>{@link android.app.appsearch.SearchSpec#RANKING_STRATEGY_USAGE_LAST_USED_TIMESTAMP} - the timestamp of the
     ...
     *
     * <p>These joined documents match the outer document as specified in the {@link android.app.appsearch.JoinSpec} with
     * parentPropertyExpression and childPropertyExpression. They are ordered according to the
     * {@link android.app.appsearch.JoinSpec#getNestedSearchSpec}, and as many SearchResults as specified by {@link
     * android.app.appsearch.JoinSpec#getMaxJoinedResultCount} will be returned. If no {@link android.app.appsearch.JoinSpec} was specified,
     ...
     *       android.app.appsearch.SearchSpec.Builder#setMaxSnippetSize}
     * </ul>
     *
     ...
     *
     * <p>If the queryExpression is "foo" and {@link android.app.appsearch.SearchSpec#getMaxSnippetSize} is 10,
     *
     * <ul>
     ...
     *
     * <p>If the queryExpression is "Test" with {@link android.app.appsearch.SearchSpec#TERM_MATCH_PREFIX} and {@link
     * android.app.appsearch.SearchSpec#getMaxSnippetSize} is 10. We will have 2 matches:
     *
     * <p>Match-1
     *
     * <ul>
    ...
    public static final class MatchInfo {
        ...
        @Nullable private android.app.appsearch.PropertyPath mPropertyPathObject = null;
        ...
        /**
         * Gets a {@link android.app.appsearch.PropertyPath} object representing the property path corresponding to the
         * given entry.
         *
         * <p>Methods such as {@link GenericDocument#getPropertyDocument} accept a path as a string
         * rather than a {@link android.app.appsearch.PropertyPath} object. However, you may want to manipulate the path
         * before getting a property document. This method returns a {@link android.app.appsearch.PropertyPath} rather
        ...
        public static final class Builder {
            ...
            /**
             * Creates a new {@link Builder} reporting a match with the given property
             * path.
             *
            ...
            public MatchInfo build() {
                Bundle bundle = new Bundle();
                bundle.putString(MatchInfo.PROPERTY_PATH_FIELD, mPropertyPath);
