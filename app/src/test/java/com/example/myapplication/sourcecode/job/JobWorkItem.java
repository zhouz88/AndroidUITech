 ...
 * {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, JobWorkItems can be persisted alongside
...
final public class JobWorkItem implements Parcelable {
     ...
     * {@link JobScheduler#enqueue JobScheduler.enqueue}.
     * <p>
     * See {@link android.app.job.JobInfo.Builder#setEstimatedNetworkBytes(long, long)} for
    ...
    public JobWorkItem(@Nullable Intent intent, @BytesLong long downloadBytes,
        ...
        enforceValidity(Compatibility.isChangeEnabled(android.app.job.JobInfo.REJECT_NEGATIVE_NETWORK_ESTIMATES));
    }
     ...
     *         {@link android.app.job.JobInfo#NETWORK_BYTES_UNKNOWN} when unknown.
     */
    ...
    public static final class Builder {
         ...
         *
         * See {@link android.app.job.JobInfo.Builder#setMinimumNetworkChunkBytes(long)} for
         ...
         *                       resumed, in bytes.
         * @return This object for method chaining
         * @see android.app.job.JobInfo.Builder#setMinimumNetworkChunkBytes(long)
         * @see JobWorkItem#getMinimumNetworkChunkBytes()
         * @see JobWorkItem#JobWorkItem(Intent, long, long, long)
         */
        @NonNull
    ...
    public static final @NonNull Creator<JobWorkItem> CREATOR
