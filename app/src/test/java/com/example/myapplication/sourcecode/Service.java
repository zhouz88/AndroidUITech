...
public abstract class Service extends ContextWrapper implements ComponentCallbacks2,
     ...
     * {@link #startForeground(int, android.app.Notification)} instead.  This method
     ...
     *
     * <p>Apps targeting API {@link Build.VERSION_CODES#P} or later must request
     * the permission {@link android.Manifest.permission#FOREGROUND_SERVICE} in order to use
     * this API.</p>
     *
     * <p>Apps built with SDK version {@link Build.VERSION_CODES#Q} or later can specify
     ...
     * Beginning with SDK Version {@link Build.VERSION_CODES#S},
     * apps targeting SDK Version {@link Build.VERSION_CODES#S}
     ...
     * <div class="caution">
     * <p><strong>Note:</strong>
     * Beginning with SDK Version {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
     * apps targeting SDK Version {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}
     ...
     * {@link Build.VERSION_CODES#S} or later, and the service is restricted from
     * becoming foreground service due to background restriction.
     * @throws android.app.InvalidForegroundServiceTypeException
     * If the app targeting API is
     * {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} or later, and the manifest attribute
     * {@link android.R.attr#foregroundServiceType} is set to invalid types(i.e.
     * {@link ServiceInfo#FOREGROUND_SERVICE_TYPE_NONE}).
     * @throws android.app.MissingForegroundServiceTypeException
     * If the app targeting API is
     * {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} or later, and the manifest attribute
     * {@link android.R.attr#foregroundServiceType} is not set.
     * @throws SecurityException If the app targeting API is
     * {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE} or later and doesn't have the
     * permission to start the foreground service with the specified type in the manifest attribute
     * {@link android.R.attr#foregroundServiceType}.
     *
     * @param id The identifier for this notification as per
     * {@link android.app.NotificationManager#notify(int, android.app.Notification)
     ...
     * {@link ServiceInfo#FOREGROUND_SERVICE_TYPE_MANIFEST} to use all flags that
     ...
     *
     * @param id The identifier for this notification as per
     * {@link NotificationManager#notify(int, android.app.Notification)
     * NotificationManager.notify(int, Notification)}; must not be 0.
     * @param notification The Notification to be displayed.
     ...
     * {@link android.R.attr#foregroundServiceType}.
     *
     * @see ServiceInfo#FOREGROUND_SERVICE_TYPE_MANIFEST
     */
    public final void startForeground(int id, @NonNull android.app.Notification notification,
     ...
     * @see #startForeground(int, android.app.Notification)
     *
    ...
    public final void attach(
            ...
            android.app.Application application, Object activityManager) {
     ...
     * {@link ServiceInfo#FOREGROUND_SERVICE_TYPE_SHORT_SERVICE}
     * was added
     * on Android version {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
