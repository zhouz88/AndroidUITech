 ...
 * Profile Owner or Device Owner when {@link android.app.admin.DevicePolicyManager#setSecondaryLockscreenEnabled} is
 * set to true and the service must be declared in the manifest as handling the action
 * {@link android.app.admin.DevicePolicyManager#ACTION_BIND_SECONDARY_LOCKSCREEN_SERVICE}, otherwise the keyguard
