 ...
 * </p>
 * <p>
 * Starting in Android version {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
 ...
 *
 * <p> Prior to Android version {@link Build.VERSION_CODES#S}, jobs could only have
 * a maximum of 100 jobs scheduled at a time. Starting with Android version
 * {@link Build.VERSION_CODES#S}, that limit has been increased to 150.
 * Expedited jobs also count towards the limit.
 *
 * <p> In Android version {@link Build.VERSION_CODES#LOLLIPOP}, jobs had a maximum
 * execution time of one minute. Starting with Android version
 * {@link Build.VERSION_CODES#M} and ending with Android version
 * {@link Build.VERSION_CODES#R}, jobs had a maximum execution time of 10 minutes.
 * Starting from Android version {@link Build.VERSION_CODES#S}, jobs will still be
 ...
 * ({@link Build.VERSION_CODES#R}), JobScheduler will throttle runaway applications.
 * Calling {@link #schedule(android.app.job.JobInfo)} and other such methods with very high frequency can have a
...
public abstract class JobScheduler {
    ...
    /**
     * Returned from {@link #schedule(android.app.job.JobInfo)} if a job wasn't scheduled successfully. Scheduling
     ...
     * system can't resolve the requisite {@link android.app.job.JobService} in your package)</li>
     ...
     * (eg. the {@link android.app.job.JobService} component is disabled).
     */
     ...
     * ID with the new information in the {@link android.app.job.JobInfo}.  If a job with the given ID is currently
     ...
     * version {@link Build.VERSION_CODES#Q}. As such, the system may throttle calls to
     ...
     * @throws IllegalArgumentException if the specified {@link android.app.job.JobService} doesn't exist or is
     * disabled.
     */
    public abstract @Result int schedule(@NonNull android.app.job.JobInfo job);
     ...
     * {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, JobWorkItems could not be persisted.
     ...
     * {@link android.app.job.JobWorkItem.Builder#setExtras(PersistableBundle)} for any information that needs
     * to be persisted.
     *
     * <p>Note: The JobService component needs to be enabled in order to successfully schedule a
     * job.
     ...
     * disabled.
     */
    public abstract @Result int enqueue(@NonNull android.app.job.JobInfo job, @NonNull JobWorkItem work);
    ...
    public abstract @Result int scheduleAsPackage(@NonNull android.app.job.JobInfo job, @NonNull String packageName,
     ...
     *
     * <p>
     * Starting with Android version {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, this
     ...
     */
    public abstract @NonNull List<android.app.job.JobInfo> getAllPendingJobs();
     ...
     */
    @NonNull
    public Map<String, List<android.app.job.JobInfo>> getPendingJobsInAllNamespaces() {
        throw new RuntimeException("Not implemented. Must override in a subclass.");
    }
     ...
     *
     * @return The {@link android.app.job.JobInfo} description of the given scheduled job, or {@code null}
     *     if the supplied job ID does not correspond to any job.
     */
    public abstract @Nullable android.app.job.JobInfo getPendingJob(int jobId);
     ...
     * {@link #scheduleAsPackage(android.app.job.JobInfo, String, int, String)}
     */
