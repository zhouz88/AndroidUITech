...
public final class RecoverableSecurityException extends SecurityException implements Parcelable {
     ...
     *            {@link android.app.Activity#setResult(int)} before finishing to
     *            communicate the final status of the recovery. For example,
     *            apps that observe {@link android.app.Activity#RESULT_OK} may choose to
     ...
     * {@link android.app.Activity#startIntentSenderForResult} to launch the
     * {@link android.app.PendingIntent#getIntentSender()} from {@link #getUserAction()}
     * when requested. If the result of that activity is
     * {@link android.app.Activity#RESULT_OK}, you should consider retrying.
     * <p>
     ...
     *            {@link android.app.NotificationManager#createNotificationChannel}.
     * @hide
     */
    public void showAsNotification(Context context, String channelId) {
        final android.app.NotificationManager nm = context.getSystemService(NotificationManager.class);
        final android.app.Notification.Builder builder = new android.app.Notification.Builder(context, channelId)
    ...
    public static final @NonNull Creator<RecoverableSecurityException> CREATOR =
