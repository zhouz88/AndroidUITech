...
package com.example.myapplication.sourcecode.job;
...
public abstract class JobServiceEngine {
     ...
     * {@link #getTransferredDownloadBytes(android.app.job.JobParameters, android.app.job.JobWorkItem)}.
     */
    private static final int MSG_GET_TRANSFERRED_DOWNLOAD_BYTES = 3;
    /**
     * Message that will result in a call to
     * {@link #getTransferredUploadBytes(android.app.job.JobParameters, android.app.job.JobWorkItem)}.
     */
    ...
    static final class JobInterface extends IJobService.Stub {
        ...
        @Override
        public void getTransferredDownloadBytes(@NonNull android.app.job.JobParameters jobParams,
                @Nullable android.app.job.JobWorkItem jobWorkItem) throws RemoteException {
        ...
        @Override
        public void getTransferredUploadBytes(@NonNull android.app.job.JobParameters jobParams,
                @Nullable android.app.job.JobWorkItem jobWorkItem) throws RemoteException {
            JobServiceEngine service = mService.get();
            if (service != null) {
                SomeArgs args = SomeArgs.obtain();
        ...
        @Override
        public void onNetworkChanged(android.app.job.JobParameters jobParams) throws RemoteException {
            JobServiceEngine service = mService.get();
            if (service != null) {
    ...
    class JobHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_GET_TRANSFERRED_DOWNLOAD_BYTES: {
                    ...
                    final android.app.job.JobParameters params = (android.app.job.JobParameters) args.arg1;
                    final android.app.job.JobWorkItem item = (android.app.job.JobWorkItem) args.arg2;
                    try {
                    ...
                    if (callback != null) {
                        try {
                            callback.updateTransferredNetworkBytes(params.getJobId(),
                                    (android.app.job.JobWorkItem) args.arg2, args.argl1, args.argl2);
                        } catch (RemoteException e) {
        ...
        private void ackGetTransferredDownloadBytesMessage(@NonNull android.app.job.JobParameters params,
                                                           @Nullable android.app.job.JobWorkItem item, long progress) {
        ...
        private void ackGetTransferredUploadBytesMessage(@NonNull android.app.job.JobParameters params,
                                                         @Nullable android.app.job.JobWorkItem item, long progress) {
            final IJobCallback callback = params.getCallback();
            final int jobId = params.getJobId();
            final int workId = item == null ? -1 : item.getWorkId();
     ...
     * {@link android.app.job.JobService#onStartJob(android.app.job.JobParameters) JobService.onStartJob} for more information.
     */
    public abstract boolean onStartJob(android.app.job.JobParameters params);

    /**
     * Engine's report that a job has stopped.  See
     * {@link android.app.job.JobService#onStopJob(android.app.job.JobParameters) JobService.onStopJob} for more information.
     */
     ...
     * {@link android.app.job.JobService#jobFinished(android.app.job.JobParameters, boolean)} for more information.
     */
    public void jobFinished(android.app.job.JobParameters params, boolean needsReschedule) {
        if (params == null) {
     ...
     *
     * @see android.app.job.JobService#onNetworkChanged(android.app.job.JobParameters)
     */
    public void onNetworkChanged(@NonNull android.app.job.JobParameters params) {
     ...
     *
     * @hide
     * @see android.app.job.JobService#getTransferredDownloadBytes()
     */
    @BytesLong
    public long getTransferredDownloadBytes(@NonNull android.app.job.JobParameters params,
            @Nullable android.app.job.JobWorkItem item) {
     ...
     *
     * @hide
     * @see android.app.job.JobService#getTransferredUploadBytes()
     */
    @BytesLong
    public long getTransferredUploadBytes(@NonNull android.app.job.JobParameters params,
            @Nullable android.app.job.JobWorkItem item) {
        if (Compatibility.isChangeEnabled(THROW_ON_INVALID_DATA_TRANSFER_IMPLEMENTATION)) {
            throw new RuntimeException("Not implemented. Must override in a subclass.");
        }
     ...
     *
     * @see android.app.job.JobService#updateTransferredNetworkBytes(android.app.job.JobParameters, long, long)
     * @see android.app.job.JobService#updateTransferredNetworkBytes(android.app.job.JobParameters, android.app.job.JobWorkItem, long, long)
     */
    public void updateTransferredNetworkBytes(@NonNull android.app.job.JobParameters params,
            @Nullable android.app.job.JobWorkItem item,
     ...
     * Call in to engine to report data transfer progress.
     *
     * @see android.app.job.JobService#updateEstimatedNetworkBytes(android.app.job.JobParameters, long, long)
     * @see android.app.job.JobService#updateEstimatedNetworkBytes(android.app.job.JobParameters, android.app.job.JobWorkItem, long, long)
     */
    public void updateEstimatedNetworkBytes(@NonNull android.app.job.JobParameters params,
     ...
     *
     * @see android.app.job.JobService#setNotification(android.app.job.JobParameters, int, Notification, int)
     */
