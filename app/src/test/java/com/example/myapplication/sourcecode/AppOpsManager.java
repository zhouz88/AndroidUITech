...
public class AppOpsManager {
     ...
     *
     * @see Manifest.permission#MANAGE_MEDIA
    ...
    static final AppOpInfo[] sAppOpInfos = new AppOpInfo[]{
        ...
        new AppOpInfo.Builder(OP_VIBRATE, OPSTR_VIBRATE, "VIBRATE")
            .setSwitchCode(OP_VIBRATE).setPermission(Manifest.permission.VIBRATE)
            .setDefaultMode(AppOpsManager.MODE_ALLOWED).build(),
        ...
        new AppOpInfo.Builder(OP_CALL_PHONE, OPSTR_CALL_PHONE, "CALL_PHONE")
            .setSwitchCode(OP_CALL_PHONE).setPermission(Manifest.permission.CALL_PHONE)
            .setDefaultMode(AppOpsManager.MODE_ALLOWED).build(),
        ...
        new AppOpInfo.Builder(OP_READ_ICC_SMS, OPSTR_READ_ICC_SMS, "READ_ICC_SMS")
            .setSwitchCode(OP_READ_SMS).setPermission(Manifest.permission.READ_SMS)
            .setRestriction(UserManager.DISALLOW_SMS).setDefaultMode(AppOpsManager.MODE_ALLOWED)
            .build(),
    ...
    public static final class HistoricalOpsRequest {
        ...
        public static final class Builder {
             ...
             *
             * @param uid The uid. Pass {@link Process#INVALID_UID} for any uid.
             * @return This builder.
             */
    ...
    public static final class HistoricalOps implements Parcelable {
        ...
        public static final @NonNull Creator<HistoricalOps> CREATOR = new Creator<HistoricalOps>() {
            @Override
    ...
    public static final class HistoricalUidOps implements Parcelable {
        ...
        public static final @NonNull Creator<HistoricalUidOps> CREATOR = new Creator<HistoricalUidOps>() {
            @Override
    ...
    public static final class HistoricalPackageOps implements Parcelable {
        ...
        public static final @NonNull Creator<HistoricalPackageOps> CREATOR =
    ...
    public static final class AttributedHistoricalOps implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<AttributedHistoricalOps> CREATOR
                = new Creator<AttributedHistoricalOps>() {
            @Override
    ...
    public static final class HistoricalOp implements Parcelable {
        ...
        public static final @NonNull Creator<HistoricalOp> CREATOR =
    ...
    public @NonNull List<PackageOps> getPackagesForOps(@Nullable String[] ops) {
        final int[] opCodes;
        if (ops != null) {
        ...
        final List<PackageOps> result = getPackagesForOps(opCodes);
    ...
    @SystemApi
    @RequiresPermission(Manifest.permission.GET_APP_OPS_STATS)
    public @NonNull List<PackageOps> getOpsForPackage(int uid,
     ...
     * Monitor for changes to the operating mode for the given op in the given app package.
     *
     * <p> If you don't hold the {@link Manifest.permission#WATCH_APPOPS} permission
     ...
     * again.
     *
     * <p> If you don't hold the {@link Manifest.permission#WATCH_APPOPS} permission you can
     ...
     * again.
     *
     * <p> If you don't hold the {@link Manifest.permission#WATCH_APPOPS} permission you
    ...
    /**
     * @deprecated Use own local {@link Binder#Binder()}
     *
     * @hide
     */
    @Deprecated
