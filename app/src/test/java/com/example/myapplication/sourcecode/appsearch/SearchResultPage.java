...
/**
 * This class represents a page of {@link android.app.appsearch.SearchResult}s
 *
 * @hide
 */
public class SearchResultPage {
    ...
    @Nullable private List<android.app.appsearch.SearchResult> mResults;
    ...
    public List<android.app.appsearch.SearchResult> getResults() {
        if (mResults == null) {
