 ...
 * @hide
 */
public class VisibilityPermissionDocument extends android.app.appsearch.GenericDocument {
    ...
    VisibilityPermissionDocument(@NonNull android.app.appsearch.GenericDocument genericDocument) {
