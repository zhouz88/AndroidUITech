 ...
 * Register this callback via {@link android.app.ActivityManager#addHomeVisibilityListener}
 * @hide
 */
...
public abstract class HomeVisibilityListener {
    ...
    private boolean isHomeActivityVisible() {
        List<android.app.ActivityManager.RunningTaskInfo> tasksTopToBottom = mActivityTaskManager.getTasks(
