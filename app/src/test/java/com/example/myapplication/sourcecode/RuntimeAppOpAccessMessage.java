...
public final class RuntimeAppOpAccessMessage implements Parcelable {
    ...
    public RuntimeAppOpAccessMessage(
            ...
            @android.app.AppOpsManager.SamplingStrategy int samplingStrategy) {
        this.mUid = uid;
        ...
        com.android.internal.util.AnnotationValidations.validate(
                android.app.AppOpsManager.SamplingStrategy.class, null, mSamplingStrategy);
     ...
     */
    @DataClass.Generated.Member
    public @android.app.AppOpsManager.SamplingStrategy int getSamplingStrategy() {
    ...
    public static final @NonNull Parcelable.Creator<RuntimeAppOpAccessMessage> CREATOR
            = new Creator<RuntimeAppOpAccessMessage>() {
        @Override
