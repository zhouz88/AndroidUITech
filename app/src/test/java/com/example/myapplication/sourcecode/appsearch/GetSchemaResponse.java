...
/** The response class of {@link android.app.appsearch.AppSearchSession#getSchema} */
public final class GetSchemaResponse {
     ...
     * constructed in ANY-ALL cases. The querier could read the {@link android.app.appsearch.GenericDocument} objects
    ...
    public Set<android.app.appsearch.AppSearchSchema> getSchemas() {
        ...
        Set<android.app.appsearch.AppSearchSchema> schemas = new ArraySet<>(schemaBundles.size());
        for (int i = 0; i < schemaBundles.size(); i++) {
            schemas.add(new android.app.appsearch.AppSearchSchema(schemaBundles.get(i)));
        }
        return schemas;
    }
     ...
     *     to access it. The supported Permission are {@link android.app.appsearch.SetSchemaRequest#READ_SMS}, {@link
     *     android.app.appsearch.SetSchemaRequest#READ_CALENDAR}, {@link android.app.appsearch.SetSchemaRequest#READ_CONTACTS}, {@link
     *     android.app.appsearch.SetSchemaRequest#READ_EXTERNAL_STORAGE}, {@link
     *     android.app.appsearch.SetSchemaRequest#READ_HOME_APP_SEARCH_DATA} and {@link
     *     android.app.appsearch.SetSchemaRequest#READ_ASSISTANT_APP_SEARCH_DATA}.
     */
    @NonNull
    @SuppressWarnings("deprecation")
    ...
    public static final class Builder {
        ...
        /** Adds one {@link android.app.appsearch.AppSearchSchema} to the schema list. */
        @CanIgnoreReturnValue
        @NonNull
        public Builder addSchema(@NonNull android.app.appsearch.AppSearchSchema schema) {
        ...
        public Builder setRequiredPermissionsForSchemaTypeVisibility(
                ...
                @android.app.appsearch.SetSchemaRequest.AppSearchSupportedPermission @NonNull
            ...
            for (Set<Integer> allRequiredPermissions : visibleToPermissions) {
                for (int permission : allRequiredPermissions) {
                    Preconditions.checkArgumentInRange(
                            permission,
                            android.app.appsearch.SetSchemaRequest.READ_SMS,
