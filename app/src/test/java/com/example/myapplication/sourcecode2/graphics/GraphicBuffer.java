...
public class GraphicBuffer implements Parcelable {
     ...
     * @param format The format of each pixel as specified in {@link android.graphics.PixelFormat}
    ...
    private static native boolean nLockCanvas(long nativeObject, android.graphics.Canvas canvas, Rect dirty);
