...
public class RadialGradient extends Shader {
    ...
    public RadialGradient(float centerX, float centerY, float radius,
        ...
        this(centerX, centerY, 0f, centerX, centerY, radius, convertColors(colors),
                stops, tileMode, android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.SRGB));
    }
     ...
     *      not share the same {@link android.graphics.ColorSpace} or do not use a valid one, or {@code stops}
     ...
     *          <li>The colors do not share the same {@link android.graphics.ColorSpace}</li>
     *          <li>The colors do not use a valid {@link android.graphics.ColorSpace}</li>
     *          <li>
    ...
    private RadialGradient(float startX, float startY, float startRadius, float endX, float endY,
            ...
            @NonNull TileMode tileMode, android.graphics.ColorSpace colorSpace
    ) {
        super(colorSpace);
    ...
    public RadialGradient(float centerX, float centerY, float radius,
        ...
        this(centerX, centerY, radius, android.graphics.Color.pack(centerColor), Color.pack(edgeColor), tileMode);
    }
