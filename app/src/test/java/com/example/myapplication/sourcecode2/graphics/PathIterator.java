...
/**
 * <code>PathIterator</code> can be used to query a given {@link android.graphics.Path} object, to discover its
...
public class PathIterator implements Iterator<PathIterator.Segment> {
     ...
     * operations correspond exactly to the primitive operations on {@link android.graphics.Path}, such as
     * {@link android.graphics.Path#moveTo(float, float)} and {@link android.graphics.Path#lineTo(float, float)}, except for
     ...
     *
     * @param path The {@link android.graphics.Path} for which this iterator can be queried.
     */
    PathIterator(@NonNull android.graphics.Path path) {
        mPath = path;
    ...
    /**
     * Returns the next verb in this iterator's {@link android.graphics.Path}, and fills entries in the
