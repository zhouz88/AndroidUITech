...
package com.example.myapplication.sourcecode2.graphics.text;
 ...
 * {@link android.graphics.text.TextRunShaper#shapeTextRun(char[], int, int, int, int, float, float, boolean, Paint)} and
 * {@link android.graphics.text.TextRunShaper#shapeTextRun(CharSequence, int, int, int, int, float, float, boolean,
 * Paint)}.
 *
 * @see android.graphics.text.TextRunShaper#shapeTextRun(char[], int, int, int, int, float, float, boolean, Paint)
