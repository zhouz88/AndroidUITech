...
/**
 * Class responsible for holding specifications for {@link android.graphics.Mesh} creations. This class generates a
 ...
 * optional {@link android.graphics.ColorSpace} as well as an alpha type.
 *
...
public class MeshSpecification {
     ...
     * {@link MeshSpecification#make(Attribute[], int, Varying[], String, String, android.graphics.ColorSpace, int)}
    ...
    /**
     * Creates a {@link MeshSpecification} object for use within {@link android.graphics.Mesh}. This uses a default
     * color space of {@link android.graphics.ColorSpace.Named#SRGB} and alphaType of
     ...
     *                       implementation
     * @return {@link MeshSpecification} object for use when creating {@link android.graphics.Mesh}
     */
    @NonNull
     ...
     *                       See {@link MeshSpecification} for an example fragment shader
     *                       implementation
     * @param colorSpace     {@link android.graphics.ColorSpace} to tell what color space to work in.
     * @return {@link MeshSpecification} object for use when creating {@link android.graphics.Mesh}
     */
    @NonNull
    public static MeshSpecification make(
            ...
            @NonNull String vertexShader,
            @NonNull String fragmentShader,
            @NonNull android.graphics.ColorSpace colorSpace
    ) {
