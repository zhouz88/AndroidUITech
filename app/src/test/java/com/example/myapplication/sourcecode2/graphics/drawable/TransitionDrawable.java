 ...
 *
 */
public class TransitionDrawable extends LayerDrawable implements android.graphics.drawable.Drawable.Callback {
     ...
     *
     * @see #TransitionDrawable(android.graphics.drawable.Drawable[])
     */
    TransitionDrawable() {
    ...
    private TransitionDrawable(TransitionState state, android.graphics.drawable.Drawable[] layers) {
        super(layers, state);
    }
