...
public class Shader {
     ...
     * @return true if the shader has a non-identity local matrix
     */
    public boolean getLocalMatrix(@NonNull android.graphics.Matrix localM) {
     ...
     */
    public void setLocalMatrix(@Nullable android.graphics.Matrix localM) {
    ...
    protected static @ColorLong long[] convertColors(@NonNull @ColorInt int[] colors) {
        ...
        for (int i = 0; i < colors.length; ++i) {
            colorLongs[i] = android.graphics.Color.pack(colors[i]);
        }
    ...
    protected static ColorSpace detectColorSpace(@NonNull @ColorLong long[] colors) {
        ...
        final ColorSpace colorSpace = android.graphics.Color.colorSpace(colors[0]);
