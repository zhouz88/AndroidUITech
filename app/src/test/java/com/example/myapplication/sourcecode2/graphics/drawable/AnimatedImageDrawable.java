...
/**
 * {@link android.graphics.drawable.Drawable} for drawing animated images (like GIF).
 *
...
public class AnimatedImageDrawable extends android.graphics.drawable.Drawable implements android.graphics.drawable.Animatable2 {
     ...
     *
     *  <p>{@link AnimationCallback#onAnimationEnd} will never be
     ...
     *  {@link AnimationCallback#onAnimationStart} will be called.</p>
     */
    @Override
    public void start() {
        if (mState.mNativePtr == 0) {
    ...
    public void registerAnimationCallback(@NonNull AnimationCallback callback) {
        ...
        if (mAnimationCallbacks == null) {
            mAnimationCallbacks = new ArrayList<AnimationCallback>();
    ...
    private void postOnAnimationStart() {
        ...
        getHandler().post(() -> {
            for (AnimationCallback callback : mAnimationCallbacks) {
