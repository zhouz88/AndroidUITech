...
public final class Bitmap implements Parcelable {
    ...
    public enum Config {
         ...
         * configuration.
         *
         * Note: as of {@link Build.VERSION_CODES#KITKAT},
         ...
         * {@link Half half-precision floating point value}.
         *
    ...
    public static Bitmap createBitmap(@NonNull Bitmap source, int x, int y, int width, int height,
        ...
        android.graphics.RectF deviceR = new RectF();
     ...
     * bitmap is in the {@link ColorSpace.Named#SRGB sRGB} color space.
     *
     * @param colors   Array of sRGB {@link android.graphics.Color colors} used to initialize the pixels.
    ...
    public enum CompressFormat {
         ...
         * compress for the smallest size. {@code 100} means compress for max
         * visual quality. As of {@link Build.VERSION_CODES#Q}, a
     ...
     *
     * <p>As of {@link Build.VERSION_CODES#KITKAT}, this method
     ...
     *
     * <p>As of {@link Build.VERSION_CODES#KITKAT}, the result of this method can
     ...
     *         {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE}, the color spaces with non
    ...
    /**
     * Fills the bitmap's pixels with the specified {@link android.graphics.Color}.
     *
     ...
     *
     * @param color The color to fill as packed by the {@link android.graphics.Color} class.
     * @throws IllegalStateException if the bitmap is not mutable.
    ...
    /**
     * Returns the {@link android.graphics.Color} at the specified location. Throws an exception
     ...
     * @return     The argb {@link android.graphics.Color} at the specified coordinate
     ...
     * @param x    The x coordinate (0...width-1) of the pixel to return
     * @param y    The y coordinate (0...height-1) of the pixel to return
     * @return     The {@link android.graphics.Color} at the specified coordinate
     * @throws IllegalArgumentException if x, y exceed the bitmap's bounds
     * @throws IllegalStateException if the bitmap's config is {@link Config#HARDWARE}
     *
     */
    @NonNull
    public android.graphics.Color getColor(int x, int y) {
        ...
        if (cs == null || cs.equals(ColorSpace.get(ColorSpace.Named.SRGB))) {
            return android.graphics.Color.valueOf(nativeGetPixel(mNativePtr, x, y));
        }
        ...
        return android.graphics.Color.valueOf(clamp(r, cs, 0), clamp(g, cs, 1), clamp(b, cs, 2), a, cs);
    }

    /**
     * Returns in pixels[] a copy of the data in the bitmap. Each value is
     * a packed int representing a {@link android.graphics.Color}. The stride parameter allows
    ...
    */
    ...
    /**
     * <p>Write the specified {@link android.graphics.Color} into the bitmap (assuming it is
    ...
    public static final @NonNull Creator<Bitmap> CREATOR
            = new Creator<Bitmap>() {
                /**
     ...
     *
     * <p>Starting in {@link Build.VERSION_CODES#N}, this call initiates an asynchronous
     ...
     *
     * In {@link Build.VERSION_CODES#KITKAT} and below, for purgeable bitmaps, this call
