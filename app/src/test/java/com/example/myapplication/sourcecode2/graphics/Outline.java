...
public final class Outline {
     ...
     */
    public void setRect(@NonNull android.graphics.Rect rect) {
     ...
     */
    public void setRoundRect(@NonNull android.graphics.Rect rect, float radius) {
     ...
     * via {@link #setPath(android.graphics.Path)}, returns {@code false}.
     *
     ...
     */
    public boolean getRect(@NonNull android.graphics.Rect outRect) {
     ...
     * been set via {@link #setPath(android.graphics.Path)}. A return value of {@code 0}
     ...
     */
    @Deprecated
    public void setConvexPath(@NonNull android.graphics.Path convexPath) {
        setPath(convexPath);
    }
     ...
     */
    public void setPath(@NonNull android.graphics.Path path) {
        if (path.isEmpty()) {
            setEmpty();
            return;
        }
