...
public class AnimatedStateListDrawable extends StateListDrawable {
     ...
     */
    public void addState(@NonNull int[] stateSet, @NonNull android.graphics.drawable.Drawable drawable, int id) {
        if (drawable == null) {
     ...
     * @param transition An {@link android.graphics.drawable.Animatable} drawable to use as a transition, may not be null
     * @param reversible Whether the transition can be reversed
     */
    public <T extends android.graphics.drawable.Drawable & android.graphics.drawable.Animatable> void addTransition(int fromId, int toId,
    ...
    private boolean selectTransition(int toIndex) {
        ...
        if (d instanceof android.graphics.drawable.AnimationDrawable) {
            ...
            transition = new AnimationDrawableTransition((android.graphics.drawable.AnimationDrawable) d,
                    reversed, hasReversibleFlag);
        } else if (d instanceof android.graphics.drawable.AnimatedVectorDrawable) {
            final boolean reversed = state.isTransitionReversed(fromId, toId);

            transition = new AnimatedVectorDrawableTransition((android.graphics.drawable.AnimatedVectorDrawable) d,
                    reversed, hasReversibleFlag);
        } else if (d instanceof android.graphics.drawable.Animatable) {
            transition = new AnimatableTransition((android.graphics.drawable.Animatable) d);
        } else {
    ...
    private static class AnimationDrawableTransition  extends Transition {
        ...
        public AnimationDrawableTransition(android.graphics.drawable.AnimationDrawable ad,
    ...
    private int parseTransition(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        android.graphics.drawable.Drawable dr = a.getDrawable(
    ...
    static class AnimatedStateListState extends StateListState {
        ...
        int addTransition(int fromId, int toId, @NonNull android.graphics.drawable.Drawable anim, boolean reversible) {
        ...
        int addStateSet(@NonNull int[] stateSet, @NonNull android.graphics.drawable.Drawable drawable, int id) {
