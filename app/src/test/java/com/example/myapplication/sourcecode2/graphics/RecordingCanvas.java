 ...
 *
 * This is obtained by calling {@link android.graphics.RenderNode#beginRecording()} and is valid until the matching
 * {@link android.graphics.RenderNode#endRecording()} is called. It must not be retained beyond that as it is
 * internally reused.
 */
public final class RecordingCanvas extends BaseRecordingCanvas {
    ...
    /*package*/
    static RecordingCanvas obtain(@NonNull android.graphics.RenderNode node, int width, int height) {
    ...
    /*package*/
    void finishRecording(android.graphics.RenderNode node) {
    ...
    private RecordingCanvas(@NonNull android.graphics.RenderNode node, int width, int height) {
    ...
    public void drawCircle(CanvasProperty<Float> cx, CanvasProperty<Float> cy,
            CanvasProperty<Float> radius, CanvasProperty<android.graphics.Paint> paint) {
