...
public class Canvas extends BaseCanvas {
     ...
     * draw into.  The initial target density is {@link android.graphics.Bitmap#DENSITY_NONE};
     ...
     */
    public Canvas(@NonNull android.graphics.Bitmap bitmap) {
        if (!bitmap.isMutable()) {
    ...
    public Canvas(long nativeCanvas) {
        ...
        mFinalizer = NoImagePreloadHolder.sRegistry.registerNativeAllocation(
                this, mNativeCanvasWrapper);
        mDensity = android.graphics.Bitmap.getDefaultDensity();
    }
     ...
     * @removed
     * @deprecated Use the flagless version of {@link #save()}, {@link #saveLayer(android.graphics.RectF, android.graphics.Paint)} or
     *             {@link #saveLayerAlpha(android.graphics.RectF, int)}. For saveLayer() calls the matrix
     ...
     * @removed
     * @deprecated Use the flagless version of {@link #save()}, {@link #saveLayer(android.graphics.RectF, android.graphics.Paint)} or
     *             {@link #saveLayerAlpha(android.graphics.RectF, int)}. For saveLayer() calls the clip
     *             was always restored for {@link #isHardwareAccelerated() Hardware accelerated}
     *             canvases and as of API level {@value Build.VERSION_CODES#O} that is the default
     *             behavior for all canvas types.
     */
     ...
     *
     * @removed
     * @deprecated This flag is ignored. Use the flagless version of {@link #saveLayer(android.graphics.RectF, android.graphics.Paint)}
     *             {@link #saveLayerAlpha(android.graphics.RectF, int)}.
     */
     ...
     * {@link android.graphics.Paint#getXfermode() Xfermode}, and
     * {@link android.graphics.Paint#getColorFilter() ColorFilter} are applied when the
     ...
     */
    public int saveLayer(@Nullable android.graphics.RectF bounds, @Nullable android.graphics.Paint paint, @Saveflags int saveFlags) {
        if (bounds == null) {
            bounds = new android.graphics.RectF(getClipBounds());
        }
     ...
     * @return       value to pass to restoreToCount() to balance this save()
     */
    public int saveLayer(@Nullable android.graphics.RectF bounds, @Nullable android.graphics.Paint paint) {
     ...
     */
    public void restoreUnclippedLayer(int saveCount, android.graphics.Paint paint) {
     ...
     */
    public int saveLayer(float left, float top, float right, float bottom, @Nullable android.graphics.Paint paint,
     ...
     */
    public int saveLayerAlpha(@Nullable android.graphics.RectF bounds, int alpha, @Saveflags int saveFlags) {
        if (bounds == null) {
            bounds = new android.graphics.RectF(getClipBounds());
        }
        checkValidSaveFlags(saveFlags);
     ...
     * @param alpha     The alpha to apply to the offscreen when it is
                        drawn during restore()
     */
    public int saveLayerAlpha(@Nullable android.graphics.RectF bounds, int alpha) {
    ...
    */
     ...
     */
    @Deprecated
    public boolean clipRect(@NonNull android.graphics.RectF rect, @NonNull Region.Op op) {
        checkValidClipOp(op);
     ...
     */
    @Deprecated
    public boolean clipRect(@NonNull android.graphics.Rect rect, @NonNull Region.Op op) {
        checkValidClipOp(op);
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
                op.nativeInt);
    }
     ...
     * @hide
     */
    public boolean clipRectUnion(@NonNull android.graphics.Rect rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
     ...
     * @return true if the resulting clip is non-empty
     */
    public boolean clipRect(@NonNull android.graphics.RectF rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
     ...
     * @return true if the resulting clip is non-empty
     */
    public boolean clipOutRect(@NonNull android.graphics.RectF rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
     ...
     * @return true if the resulting clip is non-empty
     */
    public boolean clipRect(@NonNull android.graphics.Rect rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
                Region.Op.INTERSECT.nativeInt);
    }
     ...
     * @return true if the resulting clip is non-empty
     */
    public boolean clipOutRect(@NonNull android.graphics.Rect rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
                Region.Op.DIFFERENCE.nativeInt);
    }
     ...
     */
    @Deprecated
    public boolean clipPath(@NonNull android.graphics.Path path, @NonNull Region.Op op) {
        checkValidClipOp(op);
     ...
     * @return     true if the resulting clip is non-empty
     */
    public boolean clipPath(@NonNull android.graphics.Path path) {
     ...
     * @return     true if the resulting clip is non-empty
     */
    public boolean clipOutPath(@NonNull android.graphics.Path path) {
     ...
     *             current matrix. Use {@link #clipRect(android.graphics.Rect)} as an alternative.
     */
    @Deprecated
     ...
     * @see #quickReject(android.graphics.Path, EdgeType)
     * @see #quickReject(android.graphics.RectF, EdgeType)
     ...
     * @deprecated The EdgeType is ignored. Use {@link #quickReject(android.graphics.RectF)} instead.
     */
    @Deprecated
    public boolean quickReject(@NonNull android.graphics.RectF rect, @NonNull EdgeType type) {
     ...
     *              does not intersect with the canvas' clip
     */
    public boolean quickReject(@NonNull android.graphics.RectF rect) {
        return nQuickReject(mNativeCanvasWrapper,
                rect.left, rect.top, rect.right, rect.bottom);
    }
     ...
     *                    does not intersect with the canvas' clip
     * @deprecated The EdgeType is ignored. Use {@link #quickReject(android.graphics.Path)} instead.
     */
    @Deprecated
    public boolean quickReject(@NonNull android.graphics.Path path, @NonNull EdgeType type) {
     ...
     *                    does not intersect with the canvas' clip
     */
    public boolean quickReject(@NonNull android.graphics.Path path) {
        return nQuickReject(mNativeCanvasWrapper, path.readOnlyNI());
    }
     ...
     */
    public boolean getClipBounds(@NonNull android.graphics.Rect bounds) {
     ...
     */
    public final @NonNull android.graphics.Rect getClipBounds() {
     ...
     */
    public void drawPicture(@NonNull Picture picture, @NonNull android.graphics.RectF dst) {
        save();
     ...
     * Draw the picture, stretched to fit into the dst rectangle.
     */
    public void drawPicture(@NonNull Picture picture, @NonNull android.graphics.Rect dst) {
        save();
        translate(dst.left, dst.top);
        if (picture.getWidth() > 0 && picture.getHeight() > 0) {
    ...
    @FastNative
    private static native boolean nGetClipBounds(long nativeCanvas, android.graphics.Rect bounds);
     ...
     */
    public void drawArc(@NonNull android.graphics.RectF oval, float startAngle, float sweepAngle, boolean useCenter,
    ...
    public void drawArc(float left, float top, float right, float bottom, float startAngle,
            float sweepAngle, boolean useCenter, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawBitmap(@NonNull android.graphics.Bitmap bitmap, float left, float top, @Nullable android.graphics.Paint paint) {
     ...
     */
    public void drawBitmap(@NonNull android.graphics.Bitmap bitmap, @Nullable android.graphics.Rect src, @NonNull android.graphics.RectF dst,
                           @Nullable android.graphics.Paint paint) {
     ...
     * @param paint May be null. The paint used to draw the bitmap
     */
    public void drawBitmap(@NonNull android.graphics.Bitmap bitmap, @Nullable android.graphics.Rect src, @NonNull android.graphics.Rect dst,
                           @Nullable android.graphics.Paint paint) {
        super.drawBitmap(bitmap, src, dst, paint);
    }
    ...
    public void drawBitmap(@NonNull int[] colors, int offset, int stride, float x, float y,
            int width, int height, boolean hasAlpha, @Nullable android.graphics.Paint paint) {
     ...
     * @param paint May be null. The paint used to draw the bitmap
     */
    public void drawBitmap(@NonNull android.graphics.Bitmap bitmap, @NonNull Matrix matrix, @Nullable android.graphics.Paint paint) {
     ...
     *
     * <p>Note: antialiasing is not supported, therefore {@link android.graphics.Paint#ANTI_ALIAS_FLAG} is
     * ignored.</p>
     *
     ...
     */
    public void drawCircle(float cx, float cy, float radius, @NonNull android.graphics.Paint paint) {
     ...
     * using srcover porterduff mode.
     *
     * @param color the {@code ColorLong} to draw onto the canvas. See the {@link android.graphics.Color}
    ...
    public void drawLines(@Size(multiple = 4) @NonNull float[] pts, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawOval(@NonNull android.graphics.RectF oval, @NonNull android.graphics.Paint paint) {
     ...
     * the Style in the paint.
     */
    public void drawOval(float left, float top, float right, float bottom, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawPaint(@NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawPatch(@NonNull NinePatch patch, @NonNull android.graphics.Rect dst, @Nullable android.graphics.Paint paint) {
     ...
     * @param paint The paint to draw the bitmap with. May be null. Antialiasing is not supported.
     */
    public void drawPatch(@NonNull NinePatch patch, @NonNull android.graphics.RectF dst, @Nullable android.graphics.Paint paint) {
        super.drawPatch(patch, dst, paint);
    }
     ...
     */
    public void drawPath(@NonNull android.graphics.Path path, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawPoint(float x, float y, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawPoints(@Size(multiple = 2) @NonNull float[] pts, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawRect(@NonNull android.graphics.RectF rect, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawRect(@NonNull Rect r, @NonNull android.graphics.Paint paint) {
     ...
     * @param paint The paint used to draw the rect
     */
    public void drawRect(float left, float top, float right, float bottom, @NonNull android.graphics.Paint paint) {
     ...
     */
    public void drawRoundRect(@NonNull android.graphics.RectF rect, float rx, float ry, @NonNull android.graphics.Paint paint) {
     ...
     */
    @Override
    public void drawDoubleRoundRect(@NonNull android.graphics.RectF outer, float outerRx, float outerRy,
                                    @NonNull android.graphics.RectF inner, float innerRx, float innerRy, @NonNull android.graphics.Paint paint) {
     ...
     */
    @Override
    public void drawDoubleRoundRect(@NonNull android.graphics.RectF outer, @NonNull float[] outerRadii,
                                    @NonNull RectF inner, @NonNull float[] innerRadii, @NonNull android.graphics.Paint paint) {
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    public void drawText(@NonNull String text, float x, float y, @NonNull android.graphics.Paint paint) {
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    public void drawTextOnPath(@NonNull char[] text, int index, int count, @NonNull android.graphics.Path path,
            float hOffset, float vOffset, @NonNull android.graphics.Paint paint) {
    ...
    public void drawTextOnPath(@NonNull String text, @NonNull Path path, float hOffset,
                               float vOffset, @NonNull android.graphics.Paint paint) {
     ...
     * @param isRtl whether the run is in RTL direction
     * @param paint the paint
     * @see #drawTextRun(char[], int, int, int, int, float, float, boolean, android.graphics.Paint)
     */
    public void drawTextRun(@NonNull CharSequence text, int start, int end, int contextStart,
            int contextEnd, float x, float y, boolean isRtl, @NonNull android.graphics.Paint paint) {
