 ...
 * {@link Build.VERSION_CODES#N API 24}, custom drawables classes
...
public abstract class Drawable {
     ...
     * of {@link BlendModeColorFilter}
     */
    @Deprecated
    public void setColorFilter(@ColorInt int color, @NonNull Mode mode) {
    ...
    @Nullable PorterDuffColorFilter updateTintFilter(@Nullable PorterDuffColorFilter tintFilter,
            @Nullable ColorStateList tint, @Nullable Mode tintMode) {
