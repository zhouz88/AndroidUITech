...
public abstract class ColorSpace {
    ...
    public enum Named {
        ...
        CIE_LAB,
        /**
         * <p>{@link Rgb RGB} color space BT.2100 standardized as
    ...
    /**
     * Create a {@link ColorSpace} object using a {@link DataSpace DataSpace}
     * value.
     *
    ...
    /**
     * Retrieve the {@link DataSpace DataSpace} value from a {@link ColorSpace}
     * object.
     *
     * <p>If this {@link ColorSpace} object has no matching {@code dataSpace} value,
     * {@link DataSpace#DATASPACE_UNKNOWN DATASPACE_UNKNOWN} will return.</p>
     *
    ...
    static {
        ...
        sNamedColorSpaces[Named.BT2020_HLG.ordinal()] = new Rgb(
        ...
        sNamedColorSpaces[Named.BT2020_PQ.ordinal()] = new Rgb(
    ...
    public static class Rgb extends ColorSpace {
         ...
         * </ul>
         *
         * @see #get(android.graphics.ColorSpace.Named)
         */
        public Rgb(
        ...
        private static class NoImagePreloadHolder {
            public static final NativeAllocationRegistry sRegistry = new NativeAllocationRegistry(
                Rgb.class.getClassLoader(), nativeGetNativeFinalizer(), 0);
        }
         ...
         */
        private Rgb(android.graphics.ColorSpace.Rgb colorSpace,
        ...
        private static boolean isSrgb(
            ...
            Rgb srgb = (Rgb) get(android.graphics.ColorSpace.Named.SRGB);
