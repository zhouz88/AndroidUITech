...
public class LeakyTypefaceStorage {
    ...
    @GuardedBy("sLock")
    private static final ArrayList<android.graphics.Typeface> sStorage = new ArrayList<>();
    @GuardedBy("sLock")
    private static final ArrayMap<android.graphics.Typeface, Integer> sTypefaceMap = new ArrayMap<>();
     ...
     *
     * @param typeface A {@link android.graphics.Typeface} to be written.
     * @param parcel A {@link Parcel} object.
     */
    public static void writeTypefaceToParcel(@Nullable android.graphics.Typeface typeface, @NonNull Parcel parcel) {
     ...
     *
     * If the {@link android.graphics.Typeface} was created in another process, this method returns null.
     *
     * @param parcel A {@link Parcel} object
     * @return A {@link android.graphics.Typeface} object.
     */
