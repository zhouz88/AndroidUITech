...
public class Matrix {
     ...
     */
    public boolean setRectToRect(android.graphics.RectF src, android.graphics.RectF dst, ScaleToFit stf) {
    ...
    public boolean mapRect(android.graphics.RectF dst, android.graphics.RectF src) {
        ...
        return nMapRect(native_instance, dst, src);'c'
    }
    ...
    @FastNative
    private static native boolean nMapRect(long nObject, android.graphics.RectF dst, RectF src);
    @FastNative
