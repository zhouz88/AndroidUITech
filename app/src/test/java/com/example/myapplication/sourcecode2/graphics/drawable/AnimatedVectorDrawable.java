...
package com.example.myapplication.sourcecode2.graphics.drawable;
 ...
 * {@link android.graphics.drawable.Animatable2.AnimationCallback#onAnimationEnd(android.graphics.drawable.Drawable)} will be
...
public class AnimatedVectorDrawable extends android.graphics.drawable.Drawable implements android.graphics.drawable.Animatable2 {
        ...
        while (eventType != XmlPullParser.END_DOCUMENT
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (ANIMATED_VECTOR.equals(tagName)) {
                    ...
                    if (drawableRes != 0) {
                        android.graphics.drawable.VectorDrawable vectorDrawable = (android.graphics.drawable.VectorDrawable) res.getDrawable(
    ...
    private static void updateAnimatorProperty(Animator animator, String targetName,
                                               android.graphics.drawable.VectorDrawable vectorDrawable, boolean ignoreInvalidAnim) {
        if (animator instanceof ObjectAnimator) {
            ...
            for (int i = 0; i < holders.length; i++) {
                ...
                } else if (targetNameObj instanceof android.graphics.drawable.VectorDrawable.VectorDrawableState) {
                    property = ((android.graphics.drawable.VectorDrawable.VectorDrawableState) targetNameObj)
    ...
    private static class AnimatedVectorDrawableState extends ConstantState {
        ...
        @Override
        public android.graphics.drawable.Drawable newDrawable(Resources res) {
        ...
        private Animator prepareLocalAnimator(int index) {
            ...
            if (!mShouldIgnoreInvalidAnim) {
                ...
                } else if (!(target instanceof android.graphics.drawable.VectorDrawable.VectorDrawableState)
                        && !(target instanceof android.graphics.drawable.VectorDrawable.VObject)) {
    ...
    public void reset() {
        ...
        if (DBG_ANIMATION_VECTOR_DRAWABLE) {
            Log.w(LOGTAG, "calling reset on AVD: " +
                    ((android.graphics.drawable.VectorDrawable.VectorDrawableState) ((AnimatedVectorDrawableState)
    ...
    private final Callback mCallback = new Callback() {
        @Override
        public void invalidateDrawable(@NonNull android.graphics.drawable.Drawable who) {
            invalidateSelf();
        }

        @Override
        public void scheduleDrawable(@NonNull android.graphics.drawable.Drawable who, @NonNull Runnable what, long when) {
            scheduleSelf(what, when);
        }

        @Override
        public void unscheduleDrawable(@NonNull android.graphics.drawable.Drawable who, @NonNull Runnable what) {
            unscheduleSelf(what);
        }
    };
    ...
    public static class VectorDrawableAnimatorRT implements VectorDrawableAnimator,
        ...
        private void createRTAnimator(ObjectAnimator animator, long startTime) {
            ...
            if (target instanceof android.graphics.drawable.VectorDrawable.VGroup) {
                createRTAnimatorForGroup(values, animator, (android.graphics.drawable.VectorDrawable.VGroup) target,
                        startTime);
            } else if (target instanceof android.graphics.drawable.VectorDrawable.VPath) {
                for (int i = 0; i < values.length; i++) {
                    ...
                    if (mTmpValues.endValue instanceof PathParser.PathData &&
                        ...
                        createRTAnimatorForPath(animator, (android.graphics.drawable.VectorDrawable.VPath) target,
                                startTime);
                    }  else if (target instanceof android.graphics.drawable.VectorDrawable.VFullPath) {
                        createRTAnimatorForFullPath(animator, (android.graphics.drawable.VectorDrawable.VFullPath) target,
                                startTime);
                ...
                createRTAnimatorForRootGroup(values, animator,
                        (android.graphics.drawable.VectorDrawable.VectorDrawableState) target, startTime);
            }
        }

        private void createRTAnimatorForGroup(PropertyValuesHolder[] values,
                ObjectAnimator animator, android.graphics.drawable.VectorDrawable.VGroup target,
                long startTime) {
        ...
        private void createRTAnimatorForPath( ObjectAnimator animator, android.graphics.drawable.VectorDrawable.VPath target,
                long startTime) {
        ...
        private void createRTAnimatorForFullPath(ObjectAnimator animator,
                                                 android.graphics.drawable.VectorDrawable.VFullPath target, long startTime) {
        ...
        private void createRTAnimatorForRootGroup(PropertyValuesHolder[] values,
                ObjectAnimator animator, android.graphics.drawable.VectorDrawable.VectorDrawableState target,
                long startTime) {
