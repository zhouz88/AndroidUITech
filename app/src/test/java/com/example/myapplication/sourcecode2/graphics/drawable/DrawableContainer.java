...
/**
 * A helper class that contains several {@link android.graphics.drawable.Drawable}s and selects which one to use.
 *
...
public class DrawableContainer extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    ...
    public boolean selectDrawable(int index) {
        ...
        if (index >= 0 && index < mDrawableContainerState.mNumChildren) {
            final android.graphics.drawable.Drawable d = mDrawableContainerState.getChild(index);
            mCurrDrawable = d;
            mCurIndex = index;
            if (d != null) {
     ...
     */
    private void initializeDrawableForDisplay(android.graphics.drawable.Drawable d) {
    ...
    /**
     * A ConstantState that can contain several {@link android.graphics.drawable.Drawable}s.
     *
    ...
    public abstract static class DrawableContainerState extends ConstantState {
        ...
        protected DrawableContainerState(DrawableContainerState orig, DrawableContainer owner,
            ...
            if (orig != null) {
                ...
                final android.graphics.drawable.Drawable[] origDr = orig.mDrawables;
         ...
         */
        public final int addChild(android.graphics.drawable.Drawable dr) {
        ...
        private android.graphics.drawable.Drawable prepareDrawable(android.graphics.drawable.Drawable child) {
        ...
        public final android.graphics.drawable.Drawable getChild(int index) {
            final android.graphics.drawable.Drawable result = mDrawables[index];
            if (result != null) {
                return result;
            }
            ...
            if (mDrawableFutures != null) {
                ...
                if (keyIndex >= 0) {
                    final ConstantState cs = mDrawableFutures.valueAt(keyIndex);
                    final android.graphics.drawable.Drawable prepared = prepareDrawable(cs.newDrawable(mSourceRes));
        ...
        final boolean setLayoutDirection(int layoutDirection, int currentIndex) {
            ...
            final int N = mNumChildren;
            final android.graphics.drawable.Drawable[] drawables = mDrawables;
            for (int i = 0; i < N; i++) {
                if (drawables[i] != null) {
        ...
        final void updateDensity(Resources res) {
            if (res != null) {
                ...
                final int targetDensity = android.graphics.drawable.Drawable.resolveDensity(res, mDensity);
        ...
        public boolean canApplyTheme() {
            ...
            final android.graphics.drawable.Drawable[] drawables = mDrawables;
            for (int i = 0; i < N; i++) {
                final android.graphics.drawable.Drawable d = drawables[i];
                if (d != null) {
                    if (d.canApplyTheme()) {
                        return true;
                    }
        ...
        protected void computeConstantSize() {
            ...
            for (int i = 0; i < N; i++) {
                final android.graphics.drawable.Drawable dr = drawables[i];
        ...
        public void growArray(int oldSize, int newSize) {
            android.graphics.drawable.Drawable[] newDrawables = new android.graphics.drawable.Drawable[newSize];
