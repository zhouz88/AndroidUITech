...
public final class FontUpdateRequest implements Parcelable {
    ...
    public static final class Font implements Parcelable {
        ...
        private final @NonNull android.graphics.fonts.FontStyle mFontStyle;
        private final @IntRange(from = 0) int mIndex;
        private final @NonNull String mFontVariationSettings;

        public Font(@NonNull String postScriptName, @NonNull android.graphics.fonts.FontStyle fontStyle,
        ...
        public static final @NonNull Creator<Font> CREATOR = new Creator<Font>() {
            ...
            public Font createFromParcel(Parcel source) {
                ...
                return new Font(fontName, new android.graphics.fonts.FontStyle(weight, slant), index, varSettings);
            }
        ...
        public static Font readFromXml(XmlPullParser parser) throws IOException {
            ...
            int weight = getAttributeValueInt(parser, ATTR_WEIGHT, android.graphics.fonts.FontStyle.FONT_WEIGHT_NORMAL);
            int slant = getAttributeValueInt(parser, ATTR_SLANT, android.graphics.fonts.FontStyle.FONT_SLANT_UPRIGHT);
            String varSettings = parser.getAttributeValue(null, ATTR_AXIS);
            if (varSettings == null) {
                varSettings = "";
            }
            return new Font(psName, new android.graphics.fonts.FontStyle(weight, slant), index, varSettings);
        }
    ...
    protected FontUpdateRequest(Parcel in) {
        mType = in.readInt();
        mFd = in.readParcelable(ParcelFileDescriptor.class.getClassLoader(), ParcelFileDescriptor.class);
