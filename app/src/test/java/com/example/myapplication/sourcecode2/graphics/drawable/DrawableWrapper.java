...
public abstract class DrawableWrapper extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
     ...
     */
    public DrawableWrapper(@Nullable android.graphics.drawable.Drawable dr) {
        mState = null;
        setDrawable(dr);
    }
     ...
     */
    public void setDrawable(@Nullable android.graphics.drawable.Drawable dr) {
        if (mDrawable != null) {
    ...
    private void inflateChildDrawable(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (type == XmlPullParser.START_TAG) {
                dr = android.graphics.drawable.Drawable.createFromXmlInnerForDensity(r, parser, attrs,
