...
public final class BitmapRegionDecoder {
    ...
    */
     ...
     *         decoded.
     * @throws IllegalArgumentException if {@link android.graphics.BitmapFactory.Options#inPreferredConfig}
     *         is {@link android.graphics.Bitmap.Config#HARDWARE}
     *         and {@link android.graphics.BitmapFactory.Options#inMutable} is set, if the specified color space
     *         is not {@link android.graphics.ColorSpace.Model#RGB RGB}, or if the specified color space's transfer
     *         function is not an {@link ColorSpace.Rgb.TransferParameters ICC parametric curve}
     */
    public android.graphics.Bitmap decodeRegion(Rect rect, android.graphics.BitmapFactory.Options options) {
        ...
        synchronized (mNativeLock) {
            ...
            return nativeDecodeRegion(mNativeBitmapRegionDecoder, rect.left, rect.top,
                    ...
                    android.graphics.BitmapFactory.Options.nativeInBitmap(options),
                    android.graphics.BitmapFactory.Options.nativeColorSpace(options));
        }
    }
