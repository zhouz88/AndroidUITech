...
public final class Insets implements Parcelable {
     ...
     * @return an Insets instance with the appropriate values
     */
    public static @NonNull Insets of(@Nullable android.graphics.Rect r) {
     ...
     * @hide
     */
    public @NonNull android.graphics.Rect toRect() {
    ...
    public static final @NonNull Creator<Insets> CREATOR = new Creator<Insets>() {
        @Override
