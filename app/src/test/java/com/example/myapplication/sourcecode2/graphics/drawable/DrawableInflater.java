...
public final class DrawableInflater {
    private static final HashMap<String, Constructor<? extends android.graphics.drawable.Drawable>> CONSTRUCTOR_MAP =
            new HashMap<>();
     ...
     */
    public static @Nullable android.graphics.drawable.Drawable loadDrawable(@NonNull Context context, @DrawableRes int id) {
     ...
     * @return a drawable, or {@code null} if the drawable failed to load
     */
    public static @Nullable android.graphics.drawable.Drawable loadDrawable(@NonNull Resources resources,
     ...
     * @throws IOException
     */
    public @NonNull android.graphics.drawable.Drawable inflateFromXml(@NonNull String name, @NonNull XmlPullParser parser,
     ...
     */
    @NonNull
    android.graphics.drawable.Drawable inflateFromXmlForDensity(@NonNull String name, @NonNull XmlPullParser parser,
    ...
    private @Nullable android.graphics.drawable.Drawable inflateFromTag(@NonNull String name) {
        switch (name) {
            case "selector":
    ...
    private @NonNull android.graphics.drawable.Drawable inflateFromClass(@NonNull String className) {
        try {
            Constructor<? extends android.graphics.drawable.Drawable> constructor;
            synchronized (CONSTRUCTOR_MAP) {
                constructor = CONSTRUCTOR_MAP.get(className);
                if (constructor == null) {
                    final Class<? extends android.graphics.drawable.Drawable> clazz =
