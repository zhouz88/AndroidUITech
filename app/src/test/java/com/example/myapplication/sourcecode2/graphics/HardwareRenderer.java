 ...
 * from {@link android.graphics.RenderNode}'s to an output {@link Surface}. There can be as many
...
public class HardwareRenderer {
    ...
    /**
     * The hardware renderer no longer has a valid {@link Surface} to render to.
    ...
    public HardwareRenderer() {
        ...
        mRootNode = android.graphics.RenderNode.adopt(nCreateRootRenderNode());
     ...
     * {@link SurfaceHolder.Callback#surfaceDestroyed(SurfaceHolder)}.
     *
     ...
     */
    public void setContentRoot(@Nullable android.graphics.RenderNode content) {
    ...
    */
    ...
    /** @hide */
    public void buildLayer(android.graphics.RenderNode node) {
    ...
    /** @hide */
    public boolean copyLayerInto(final TextureLayer layer, final android.graphics.Bitmap bitmap) {
     ...
     * @hide
     */
    public void addRenderNode(android.graphics.RenderNode node, boolean placeFront) {
     ...
     * @hide
     */
    public void removeRenderNode(android.graphics.RenderNode node) {
     ...
     * @hide
     */
    public void drawRenderNode(android.graphics.RenderNode node) {
    ...
    static void invokePictureCapturedCallback(long picturePtr, PictureCapturedCallback callback) {
        android.graphics.Picture picture = new android.graphics.Picture(picturePtr);
   ...
   /**
    ...
    public abstract static class CopyRequest {
        ...
        protected CopyRequest(android.graphics.Rect srcRect, android.graphics.Bitmap destinationBitmap) {
        ...
        public long getDestinationBitmap(int srcWidth, int srcHeight) {
            if (mDestinationBitmap == null) {
                mDestinationBitmap =
                        android.graphics.Bitmap.createBitmap(srcWidth, srcHeight, android.graphics.Bitmap.Config.ARGB_8888);
            }
     ...
     * @hide
     **/
    public static android.graphics.Bitmap createHardwareBitmap(RenderNode node, int width, int height) {
    ...
    private static class ProcessInitializer {
        ...
        private void initDisplayInfo() {
            ...
            final android.graphics.ColorSpace defaultWideColorSpace =
