...
public class LayerDrawable extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
     ...
     *               must be non-null
     */
    public LayerDrawable(@NonNull android.graphics.drawable.Drawable[] layers) {
        this(layers, null);
    }
     ...
     */
    LayerDrawable(@NonNull android.graphics.drawable.Drawable[] layers, @Nullable LayerState state) {
        this(state, null);
     ...
     */
    ChildDrawable addLayer(android.graphics.drawable.Drawable dr, int[] themeAttrs, int id,
    ...
    private ChildDrawable createLayer(android.graphics.drawable.Drawable dr) {
     ...
     * @return The {@link android.graphics.drawable.Drawable} for the highest-indexed layer that has the
     ...
     *
     * @param id The layer ID to search for.
     * @param drawable The replacement {@link android.graphics.drawable.Drawable}.
     * @return Whether the {@link android.graphics.drawable.Drawable} was replaced (could return false if
     ...
     *
     * @see #setDrawable(int, android.graphics.drawable.Drawable)
     * @attr ref android.R.styleable#LayerDrawableItem_drawable
     */
    ...
    static class LayerState extends ConstantState {
        ...
        private void applyDensityScaling(int sourceDensity, int targetDensity) {
            if (mPaddingLeft > 0) {
                mPaddingLeft = android.graphics.drawable.Drawable.scaleFromDensity(
                        mPaddingLeft, sourceDensity, targetDensity, false);
            }
            if (mPaddingTop > 0) {
                mPaddingTop = android.graphics.drawable.Drawable.scaleFromDensity(
                        mPaddingTop, sourceDensity, targetDensity, false);
            }
            if (mPaddingRight > 0) {
                mPaddingRight = android.graphics.drawable.Drawable.scaleFromDensity(
                        mPaddingRight, sourceDensity, targetDensity, false);
            }
            if (mPaddingBottom > 0) {
                mPaddingBottom = android.graphics.drawable.Drawable.scaleFromDensity(
                        mPaddingBottom, sourceDensity, targetDensity, false);
            }
            if (mPaddingStart > 0) {
                mPaddingStart = android.graphics.drawable.Drawable.scaleFromDensity(
                        mPaddingStart, sourceDensity, targetDensity, false);
            }
            if (mPaddingEnd > 0) {
                mPaddingEnd = android.graphics.drawable.Drawable.scaleFromDensity(
        ...
        @Override
        public android.graphics.drawable.Drawable newDrawable(@Nullable Resources res) {
