 ...
 * top-level content is desired, and finally calling {@link Surface#unlockCanvasAndPost(android.graphics.Canvas)}.
 * </p>
 */
public final class RenderNode {
     ...
     * way to do the otherwise equivalent {@link #getMatrix(android.graphics.Matrix)} {@link android.graphics.Matrix#isIdentity()}
     ...
     */
    public void getMatrix(@NonNull android.graphics.Matrix outMatrix) {
     ...
     * equivalent {@link #getMatrix(android.graphics.Matrix)} followed by {@link android.graphics.Matrix#invert(android.graphics.Matrix)}
     *
     * @param outMatrix The matrix to store the inverse transform of the RenderNode
     */
    public void getInverseMatrix(@NonNull android.graphics.Matrix outMatrix) {
    ...
    /**
     * @hide
     * @deprecated use {@link #setUseCompositingLayer(boolean, android.graphics.Paint)} instead
     */
    @Deprecated
     ...
     */
    @Deprecated
    public boolean setLayerPaint(@Nullable android.graphics.Paint paint) {
     ...
     */
    public boolean setUseCompositingLayer(boolean forceToLayer, @Nullable android.graphics.Paint paint) {
     ...
     *
     * <p>This is equivalent to do a {@link android.graphics.Canvas#clipRect(android.graphics.Rect)} at the start of this
     ...
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setClipRect(@Nullable android.graphics.Rect rect) {
        if (rect == null) {
     ...
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setOutline(@Nullable android.graphics.Outline outline) {
        if (outline == null) {
        ...
        switch (outline.mMode) {
            ...
            case android.graphics.Outline.MODE_PATH:
     ...
     * @hide TODO Do we want this?
     */
    public boolean setAnimationMatrix(@Nullable android.graphics.Matrix matrix) {
     ...
     * {@link #setAnimationMatrix(android.graphics.Matrix)}.
     *
     * @return the current Animation matrix.
     * @see #setAnimationMatrix(android.graphics.Matrix)
     *
     * @hide
     */
    @Nullable
    public android.graphics.Matrix getAnimationMatrix() {
        android.graphics.Matrix output = new Matrix();
