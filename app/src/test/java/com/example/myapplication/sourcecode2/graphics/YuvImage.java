...
public class YuvImage {
   ...
   /**
     ...
     */
    public boolean compressToJpeg(android.graphics.Rect rectangle, int quality, OutputStream stream) {
        ...
        android.graphics.Rect wholeImage = new android.graphics.Rect(0, 0, mWidth, mHeight);
