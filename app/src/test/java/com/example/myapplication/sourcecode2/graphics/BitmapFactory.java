...
public class BitmapFactory {
    ...
    public static class Options {
         ...
         *
         * <p>As of {@link Build.VERSION_CODES#KITKAT}, any
         ...
         * introduced in {@link Build.VERSION_CODES#JELLY_BEAN}. All
         ...
         *
         * <p class="note">
         * Prior to {@link Build.VERSION_CODES#UPSIDE_DOWN_CAKE},
         ...
         * E.g., {@link android.graphics.ColorSpace.Named#BT2020_HLG BT2020_HLG}.</p>
         *
        ...
        /**
         * @deprecated As of {@link Build.VERSION_CODES#N}, this is
         * ignored.
         *
         * In {@link Build.VERSION_CODES#M} and below, if dither is
        ...
        /**
         * @deprecated As of {@link Build.VERSION_CODES#LOLLIPOP}, this is
         * ignored.
         *
         * In {@link Build.VERSION_CODES#KITKAT} and below, if this
         ...
         * ignored.
         *
         * In {@link Build.VERSION_CODES#KITKAT} and below, this
         ...
         *
         * In {@link Build.VERSION_CODES#M} and below, if
        ...
        /**
         * @deprecated As of {@link Build.VERSION_CODES#N}, see
        ...
        /**
         *  @deprecated As of {@link Build.VERSION_CODES#N}, this
         *  will not affect the decode, though it will still set mCancel.
         *
         *  In {@link Build.VERSION_CODES#M} and below, if this can
        ...
        static void validate(Options opts) {
            ...
            if (opts.inBitmap != null) {
                if (opts.inBitmap.getConfig() == android.graphics.Bitmap.Config.HARDWARE) {
            ...
            if (opts.inMutable && opts.inPreferredConfig == android.graphics.Bitmap.Config.HARDWARE) {
            ...
            if (opts.inPreferredColorSpace != null) {
                if (!(opts.inPreferredColorSpace instanceof android.graphics.ColorSpace.Rgb)) {
                    throw new IllegalArgumentException("The destination color space must use the " +
                            "RGB color model");
                }
                if (!opts.inPreferredColorSpace.equals(android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.BT2020_HLG))
                        && !opts.inPreferredColorSpace.equals(
                            android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.BT2020_PQ))
                        && ((android.graphics.ColorSpace.Rgb) opts.inPreferredColorSpace)
     ...
     *         is not {@link android.graphics.ColorSpace.Model#RGB RGB}, or if the specified color space's transfer
     *         function is not an {@link android.graphics.ColorSpace.Rgb.TransferParameters ICC parametric curve}
     */
    public static android.graphics.Bitmap decodeFile(String pathName, Options opts) {
        validate(opts);
     ...
     */
    @Nullable
    public static android.graphics.Bitmap decodeResourceStream(@Nullable Resources res, @Nullable TypedValue value,
                                                               @Nullable InputStream is, @Nullable android.graphics.Rect pad, @Nullable Options opts) {
        validate(opts);
        if (opts == null) {
            opts = new Options();
        }
     ...
     *         function is not an {@link android.graphics.ColorSpace.Rgb.TransferParameters ICC parametric curve}
     */
    public static android.graphics.Bitmap decodeResource(Resources res, int id, Options opts) {
        validate(opts);
        android.graphics.Bitmap bm = null;
        InputStream is = null; 
     ...
     */
    public static android.graphics.Bitmap decodeResource(Resources res, int id) {
     ...
     *         function is not an {@link android.graphics.ColorSpace.Rgb.TransferParameters ICC parametric curve}
     */
    public static android.graphics.Bitmap decodeByteArray(byte[] data, int offset, int length, Options opts) {
     ...
     */
    private static void setDensityFromOptions(android.graphics.Bitmap outputBitmap, Options opts) {
     ...
     */
    @Nullable
    public static android.graphics.Bitmap decodeStream(@Nullable InputStream is, @Nullable android.graphics.Rect outPadding,
     ...
     */
    private static android.graphics.Bitmap decodeStreamInternal(@NonNull InputStream is,
                                                                @Nullable android.graphics.Rect outPadding, @Nullable Options opts) {
        // ASSERT(is != null);
     ...
     */
    public static android.graphics.Bitmap decodeStream(InputStream is) {
     ...
     */
    public static android.graphics.Bitmap decodeFileDescriptor(FileDescriptor fd, android.graphics.Rect outPadding, Options opts) {
        validate(opts);
        android.graphics.Bitmap bm;
     ...
     * @return the decoded bitmap, or null
     */
    public static android.graphics.Bitmap decodeFileDescriptor(FileDescriptor fd) {
        return decodeFileDescriptor(fd, null, null);
    }

    @UnsupportedAppUsage
    private static native android.graphics.Bitmap nativeDecodeStream(InputStream is, byte[] storage,
                                                                     android.graphics.Rect padding, Options opts, long inBitmapHandle, long colorSpaceHandle);
    @UnsupportedAppUsage
    private static native android.graphics.Bitmap nativeDecodeFileDescriptor(FileDescriptor fd,
                                                                             android.graphics.Rect padding, Options opts, long inBitmapHandle, long colorSpaceHandle);
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.R, trackingBug = 170729553)
    private static native android.graphics.Bitmap nativeDecodeAsset(long nativeAsset, Rect padding, Options opts,
