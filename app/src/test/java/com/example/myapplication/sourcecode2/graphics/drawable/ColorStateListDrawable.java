...
/**
 * A Drawable that manages a {@link android.graphics.drawable.ColorDrawable} to make it stateful and backed by a
 * {@link ColorStateList}.
 */
public class ColorStateListDrawable extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    ...
    @Override
    public @NonNull android.graphics.drawable.Drawable getCurrent() {
    ...
    @Override
    public @NonNull android.graphics.drawable.Drawable mutate() {
