...
public class Paint {
   ...
   /**
    ...
    public Paint(int flags) {
        ...
        mColor = android.graphics.Color.pack(android.graphics.Color.BLACK);
    }
    ...
    public void reset() {
        ...
        mShadowLayerDx = 0.0f;
        mShadowLayerDy = 0.0f;
        mShadowLayerColor = android.graphics.Color.pack(0);
    }
    ...
    @ColorInt
    public int getColor() {
        return android.graphics.Color.toArgb(mColor);
    }
    ...
    public void setColor(@ColorInt int color) {
        ...
        mColor = android.graphics.Color.pack(color);
    }
     ...
     */
    public int getAlpha() {
        return Math.round(android.graphics.Color.alpha(mColor) * 255.0f);
    }
    ...
    public void setAlpha(int a) {
        ...
        // b/122959599
        ColorSpace cs = android.graphics.Color.colorSpace(mColor);
        float r = android.graphics.Color.red(mColor);
        float g = android.graphics.Color.green(mColor);
        float b = android.graphics.Color.blue(mColor);
        mColor = android.graphics.Color.pack(r, g, b, a * (1.0f / 255), cs);
     ...
     */
    public boolean getFillPath(android.graphics.Path src, android.graphics.Path dst) {
    ...
    public void setShadowLayer(float radius, float dx, float dy, @ColorInt int shadowColor) {
        setShadowLayer(radius, dx, dy, android.graphics.Color.pack(shadowColor));
    }
    ...
    public void setShadowLayer(float radius, float dx, float dy, @ColorLong long shadowColor) {
        ColorSpace cs = android.graphics.Color.colorSpace(shadowColor);
    ...
    public @ColorInt int getShadowLayerColor() {
        return android.graphics.Color.toArgb(mShadowLayerColor);
    }
    ...
    public void getTextPath(char[] text, int index, int count,
                            float x, float y, android.graphics.Path path) {
        if ((index | count) < 0 || index + count > text.length) {
            throw new ArrayIndexOutOfBoundsException();
        }
     ...
     */
    public void getTextBounds(String text, int start, int end, android.graphics.Rect bounds) {
        if ((start | end | (end - start) | (text.length() - end)) < 0) {
            throw new IndexOutOfBoundsException();
        }
        if (bounds == null) {
    ...
    public void getTextBounds(@NonNull CharSequence text, int start, int end,
            @NonNull android.graphics.Rect bounds) {
        if ((start | end | (end - start) | (text.length() - end)) < 0) {
            throw new IndexOutOfBoundsException();
        }
        if (bounds == null) {
     ...
     * @param bounds returns the unioned bounds of all the text. Must be allocated by the caller
     */
    public void getTextBounds(char[] text, int index, int count, android.graphics.Rect bounds) {
        if ((index | count) < 0 || index + count > text.length) {
            throw new ArrayIndexOutOfBoundsException();
        }
        if (bounds == null) {
    ...
    private static native void nGetStringBounds(long nativePaint, String text, int start, int end,
            int bidiFlags, android.graphics.Rect bounds);
