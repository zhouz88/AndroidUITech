 ...
 * visual effect. A {@link RenderEffect} can be configured on a {@link android.graphics.RenderNode} through
 * {@link android.graphics.RenderNode#setRenderEffect(RenderEffect)} and will be applied when drawn through
 * {@link Canvas#drawRenderNode(android.graphics.RenderNode)}.
...
public final class RenderEffect {
    ...
    /**
     * Create a {@link RenderEffect} that renders the contents of the input {@link android.graphics.Bitmap}.
     ...
     * {@link RenderEffect#createColorFilterEffect(android.graphics.ColorFilter, RenderEffect)}
     *
     * @param bitmap The source bitmap to be rendered by the created {@link RenderEffect}
     */
    @NonNull
    public static RenderEffect createBitmapEffect(@NonNull android.graphics.Bitmap bitmap) {
     ...
     *            drawn into within the bounds of the {@link android.graphics.RenderNode} this RenderEffect is
     *            installed on
     */
    @NonNull
    public static RenderEffect createBitmapEffect(
            @NonNull Bitmap bitmap,
            @Nullable android.graphics.Rect src,
            @NonNull Rect dst
    ) {
     ...
     * @param renderEffect Source to be transformed by the specified {@link android.graphics.ColorFilter}
     */
    @NonNull
    public static RenderEffect createColorFilterEffect(
            @NonNull android.graphics.ColorFilter colorFilter,
     ...
     */
    @NonNull
    public static RenderEffect createColorFilterEffect(@NonNull android.graphics.ColorFilter colorFilter) {
        return new RenderEffect(
                nativeCreateColorFilterEffect(
                        colorFilter.getNativeInstance(),
                        0
     ...
     * combined by the specified {@link android.graphics.BlendMode}
     *
     * @param dst The Dst pixels used in blending
     * @param src The Src pixels used in blending
     * @param blendMode The {@link android.graphics.BlendMode} to be used to combine colors from the two
     *                  {@link RenderEffect}s
     */
    @NonNull
    ...
    /**
     * Create a {@link RenderEffect} that renders the contents of the input {@link android.graphics.Shader}.
     * This is useful to create an input for other {@link RenderEffect} types such as
