...
public final class SystemFonts {
    ...
    private static @GuardedBy("sLock") Set<android.graphics.fonts.Font> sAvailableFonts;
     ...
     */
    public static @NonNull Set<android.graphics.fonts.Font> getAvailableFonts() {
        synchronized (LOCK) {
    ...
    private static void pushFamilyToFallback(@NonNull FontConfig.FontFamily xmlFamily,
        ...
        final android.graphics.fonts.FontFamily defaultFamily = defaultFonts.isEmpty() ? null : createFontFamily(
        ...
        for (int i = 0; i < fallbackMap.size(); i++) {
            ...
            if (fallback == null) {
                ...
                final android.graphics.fonts.FontFamily family = createFontFamily(fallback, languageTags, variant, false,
                        cache);
                if (family != null) {
    ...
    private static @Nullable android.graphics.fonts.FontFamily createFontFamily(
    ...
    private static void appendNamedFamilyList(@NonNull FontConfig.NamedFamilyList namedFamilyList,
        ...
        for (int i = 0; i < xmlFamilies.size(); ++i) {
            ...
            final android.graphics.fonts.FontFamily family = createFontFamily(
     ...
     */
    @VisibleForTesting
    public static Map<String, android.graphics.fonts.FontFamily[]> buildSystemFallback(FontConfig fontConfig) {
        return buildSystemFallback(fontConfig, new ArrayMap<>());
    }

    private static final class NativeFamilyListSet {
        public List<android.graphics.fonts.FontFamily> familyList = new ArrayList<>();
    ...
    public static Map<String, android.graphics.fonts.FontFamily[]> buildSystemFallback(FontConfig fontConfig,
        ...
        final Map<String, android.graphics.fonts.FontFamily[]> fallbackMap = new ArrayMap<>();
        for (int i = 0; i < fallbackListMap.size(); i++) {
            final String fallbackName = fallbackListMap.keyAt(i);
            final List<android.graphics.fonts.FontFamily> familyList = fallbackListMap.valueAt(i).familyList;
            fallbackMap.put(fallbackName, familyList.toArray(new android.graphics.fonts.FontFamily[0]));
        }
