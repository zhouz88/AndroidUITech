 ...
 * from {@link android.graphics.RenderNode}s to an output {@link HardwareBuffer}. There can be as many
 ...
 * HardwareBuffer}.</p>
 *
 * This is useful in situations where a scene built with {@link android.graphics.RenderNode}s can be consumed
...
public class HardwareBufferRenderer implements AutoCloseable {
    ...
    private static final android.graphics.ColorSpace DEFAULT_COLORSPACE = android.graphics.ColorSpace.get(Named.SRGB);
    ...
    public HardwareBufferRenderer(@NonNull HardwareBuffer buffer) {
        android.graphics.RenderNode rootNode = android.graphics.RenderNode.adopt(nCreateRootRenderNode());
    ...
    public final class RenderRequest {
        ...
        private android.graphics.ColorSpace mColorSpace = DEFAULT_COLORSPACE;
