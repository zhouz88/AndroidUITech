...
/**
 * A {@link Parcelable} wrapper for a {@link android.graphics.ColorSpace}. In order to enable parceling, the
 * ColorSpace must be either a {@link android.graphics.ColorSpace.Named Named} ColorSpace or a
 * {@link android.graphics.ColorSpace.Rgb} instance that has an ICC parametric transfer function as returned by
 * {@link android.graphics.ColorSpace.Rgb#getTransferParameters()}.
 */
public final class ParcelableColorSpace implements Parcelable {
     ...
     * parceled if it is a {@link android.graphics.ColorSpace.Named Named} ColorSpace or a {@link android.graphics.ColorSpace.Rgb}
     * instance that has an ICC parametric transfer function as returned by
     * {@link android.graphics.ColorSpace.Rgb#getTransferParameters()}
     */
    public static boolean isParcelable(@NonNull android.graphics.ColorSpace colorSpace) {
     ...
     * to be parceled. See {@link #isParcelable(android.graphics.ColorSpace)}.
     */
    public ParcelableColorSpace(@NonNull android.graphics.ColorSpace colorSpace) {
     ...
     */
    public @NonNull android.graphics.ColorSpace getColorSpace() {
        return mColorSpace;
    }
    ...
    public static final Creator<ParcelableColorSpace> CREATOR =
            new Creator<ParcelableColorSpace>() {
        ...
        public @NonNull ParcelableColorSpace createFromParcel(@NonNull Parcel in) {
            ...
            if (id == android.graphics.ColorSpace.MIN_ID) {
                ...
                android.graphics.ColorSpace.Rgb.TransferParameters function =
                        new android.graphics.ColorSpace.Rgb.TransferParameters(a, b, c, d, e, f, g);
                return new ParcelableColorSpace(
                        new android.graphics.ColorSpace.Rgb(name, primaries, whitePoint, function));
            } else {
