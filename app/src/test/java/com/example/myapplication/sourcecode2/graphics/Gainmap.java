 ...
 * <p>
 * As such these "gainmap images" consist of 3 parts - a base {@link android.graphics.Bitmap} with a
 * {@link android.graphics.Bitmap#getGainmap()} that returns an instance of this class which in turn contains
...
public final class Gainmap implements Parcelable {
    ...
    // called from JNI
    private Gainmap(android.graphics.Bitmap gainmapContents, long nativeGainmap) {
        if (nativeGainmap == 0) {
     ...
     */
    public Gainmap(@NonNull android.graphics.Bitmap gainmapContents) {
     ...
     * such as {@link android.graphics.Bitmap#getColorSpace()} or {@link android.graphics.Bitmap#getGainmap()} as they are not
     ...
     * certain aspects of the Bitmap are ignored such as {@link android.graphics.Bitmap#getColorSpace()} or
     * {@link android.graphics.Bitmap#getGainmap()} as they are not relevant to the gainmap's enhancement layer.
     *
     * @param bitmap The non-null bitmap to set as the gainmap's contents
     */
    public void setGainmapContents(@NonNull android.graphics.Bitmap bitmap) {
    ...
    public static final @NonNull Creator<Gainmap> CREATOR =
            new Creator<Gainmap>() {
            /**
            ...
            public Gainmap createFromParcel(Parcel in) {
                Gainmap gm = new Gainmap(in.readTypedObject(android.graphics.Bitmap.CREATOR));
