 ...
 * and can then play them back into Canvas (via {@link Picture#draw(android.graphics.Canvas)} or
 * {@link android.graphics.Canvas#drawPicture(Picture)}).For most content (e.g. text, lines, rectangles),
...
public class Picture {
     ...
     * commands (e.g. {@link android.graphics.Canvas#drawRect(Rect, Paint)}) will be recorded.
     ...
     * or {@link android.graphics.Canvas#drawPicture(Picture)} is called.
     */
     ...
     *
     * @see #createFromStream(InputStream)
     * @removed
