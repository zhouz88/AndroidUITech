...
public class Region implements Parcelable {
    ...
    */
    public Region(@NonNull android.graphics.Rect r) {
    ...
    */
    public boolean set(@NonNull android.graphics.Rect r) {
    ...
    */
     ...
     */
    public boolean setPath(@NonNull android.graphics.Path path, @NonNull Region clip) {
     ...
     */
    public boolean getBounds(@NonNull android.graphics.Rect r) {
        if (r == null) {
     ...
     */
    public boolean quickContains(@NonNull android.graphics.Rect r) {
     ...
     */
    public boolean quickReject(@NonNull android.graphics.Rect r) {
    ...
    public final boolean union(@NonNull android.graphics.Rect r) {
     ...
     */
    public boolean op(@NonNull android.graphics.Rect r, @NonNull Op op) {
     ...
     */
    public boolean op(@NonNull android.graphics.Rect rect, @NonNull Region region, @NonNull Op op) {
    ...
    public static final @NonNull Creator<Region> CREATOR
        = new Creator<Region>() {
            /**
