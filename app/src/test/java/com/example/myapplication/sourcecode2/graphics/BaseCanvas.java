...
public abstract class BaseCanvas {
    ...
    protected void throwIfCannotDraw(android.graphics.Bitmap bitmap) {
        ...
        if (!bitmap.isPremultiplied() && bitmap.getConfig() == android.graphics.Bitmap.Config.ARGB_8888 &&
                bitmap.hasAlpha()) {
    ...
    public void drawBitmapMesh(@NonNull android.graphics.Bitmap bitmap, int meshWidth, int meshHeight,
    ...
    public void drawColor(@ColorInt int color) {
        nDrawColor(mNativeCanvasWrapper, color, android.graphics.BlendMode.SRC_OVER.getXfermode().porterDuffMode);
    }
    ...
    /**
     * Make lint happy.
     * See {@link android.graphics.Canvas#drawColor(int, android.graphics.BlendMode)}
     */
    public void drawColor(@ColorInt int color, @NonNull android.graphics.BlendMode mode) {
        nDrawColor(mNativeCanvasWrapper, color, mode.getXfermode().porterDuffMode);
    }

    /**
     * Make lint happy.
     * See {@link android.graphics.Canvas#drawColor(long, android.graphics.BlendMode)}
     */
    public void drawColor(@ColorLong long color, @NonNull android.graphics.BlendMode mode) {
        ColorSpace cs = android.graphics.Color.colorSpace(color);
    ...
    public void drawPatch(@NonNull android.graphics.NinePatch patch, @NonNull android.graphics.Rect dst, @Nullable android.graphics.Paint paint) {
    ...
    /**
     * Make lint happy.
     * See {@link android.graphics.Canvas#drawDoubleRoundRect(android.graphics.RectF, float, float, android.graphics.RectF, float, float, android.graphics.Paint)}
     */
    ...
    /**
     * Make lint happy.
     * See {@link Canvas#drawDoubleRoundRect(android.graphics.RectF, float[], android.graphics.RectF, float[], android.graphics.Paint)}
     */
     ...
     * ignored.</p>
     *
     * @param mesh {@link android.graphics.Mesh} object that will be drawn to the screen
     * @param blendMode {@link android.graphics.BlendMode} used to blend mesh primitives as the destination color
     *            with the Paint color/shader as the source color. This defaults to
     *            {@link android.graphics.BlendMode#MODULATE} if null.
     * @param paint {@link android.graphics.Paint} used to provide a color/shader/blend mode.
     */
    public void drawMesh(@NonNull Mesh mesh, @Nullable android.graphics.BlendMode blendMode, @NonNull android.graphics.Paint paint) {
