...
public class RectF implements Parcelable {
    ...
    public RectF(@Nullable android.graphics.Rect r) {
        if (r == null) {
            left = top = right = bottom = 0.0f;
        } else {
            left = r.left;
     ...
     *           rectangle.
     */
    public void set(@NonNull android.graphics.Rect src) {
        this.left   = src.left;
        this.top    = src.top;
        this.right  = src.right;
        this.bottom = src.bottom;
     ...
     */
    public void round(@NonNull android.graphics.Rect dst) {
    ...
    public static final @NonNull Creator<RectF> CREATOR = new Creator<RectF>() {
        /**
