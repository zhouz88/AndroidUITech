...
public class NinePatch {
     ...
     *
     * @see #setPaint(android.graphics.Paint)
     * @see #draw(android.graphics.Canvas, android.graphics.Rect)
     * @see #draw(android.graphics.Canvas, android.graphics.RectF)
     */
     ...
     */
    public void draw(android.graphics.Canvas canvas, RectF location) {
     ...
     */
    public void draw(Canvas canvas, android.graphics.Rect location, Paint paint) {
     ...
     * report, else a {@link android.graphics.Region} holding the parts of the specified bounds
