...
public class NinePatchDrawable extends android.graphics.drawable.Drawable {
    ...
    private void computeBitmapSize() {
        ...
        mBitmapHeight = android.graphics.drawable.Drawable.scaleFromDensity(
                ninePatch.getHeight(), sourceDensity, targetDensity, true);
        mBitmapWidth = android.graphics.drawable.Drawable.scaleFromDensity(
        ...
        if (insets != null) {
            ...
            mOutlineRadius = android.graphics.drawable.Drawable.scaleFromDensity(
