...
public class SweepGradient extends Shader {
    ...
    public SweepGradient(float cx, float cy, @NonNull @ColorInt int[] colors,
        ...
        this(cx, cy, convertColors(colors), positions, android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.SRGB));
    }
     ...
     *      not share the same {@link android.graphics.ColorSpace} or do not use a valid one, or {@code positions}
    ...
    private SweepGradient(float cx, float cy, @NonNull @ColorLong long[] colors,
            @Nullable float[] positions, android.graphics.ColorSpace colorSpace) {
        super(colorSpace);
    ...
    public SweepGradient(float cx, float cy, @ColorInt int color0, @ColorInt int color1) {
        this(cx, cy, android.graphics.Color.pack(color0), Color.pack(color1));
    }
