...
public class ComposeShader extends android.graphics.Shader {
     ...
     */
    @Deprecated
    public ComposeShader(@NonNull android.graphics.Shader shaderA, @NonNull android.graphics.Shader shaderB, @NonNull Xfermode mode) {
     ...
     *
     */
    public ComposeShader(@NonNull android.graphics.Shader shaderA, @NonNull android.graphics.Shader shaderB,
    ...
    */
    ...
    private ComposeShader(android.graphics.Shader shaderA, Shader shaderB, int nativeMode) {
