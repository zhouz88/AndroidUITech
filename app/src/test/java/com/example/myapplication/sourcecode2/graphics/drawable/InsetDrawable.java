...
public class InsetDrawable extends DrawableWrapper {
     ...
     */
    public InsetDrawable(@Nullable android.graphics.drawable.Drawable drawable, int inset) {
     ...
     */
    public InsetDrawable(@Nullable android.graphics.drawable.Drawable drawable, float inset) {
        this(drawable, inset, inset, inset, inset);
    }
     ...
     */
    public InsetDrawable(@Nullable android.graphics.drawable.Drawable drawable, int insetLeft, int insetTop,
     ...
     */
    public InsetDrawable(@Nullable android.graphics.drawable.Drawable drawable, float insetLeftFraction,
