...
public class BaseRecordingCanvas extends Canvas {
    ...
    @Override
    public final void drawArc(@NonNull android.graphics.RectF oval, float startAngle, float sweepAngle,
                              boolean useCenter, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawBitmap(@NonNull android.graphics.Bitmap bitmap, float left, float top,
    ...
    @Override
    public final void drawBitmap(@NonNull android.graphics.Bitmap bitmap, @NonNull Matrix matrix,
                                 @Nullable android.graphics.Paint paint) {
    ...
    @Override
    public final void drawBitmap(@NonNull android.graphics.Bitmap bitmap, @Nullable android.graphics.Rect src, @NonNull android.graphics.Rect dst,
                                 @Nullable android.graphics.Paint paint) {
        if (dst == null) {
    ...
    @Override
    public final void drawBitmap(@NonNull android.graphics.Bitmap bitmap, @Nullable android.graphics.Rect src, @NonNull android.graphics.RectF dst,
                                 @Nullable android.graphics.Paint paint) {
        if (dst == null) {
            throw new NullPointerException();
        }
    ...
    @Override
    public final void drawBitmapMesh(@NonNull android.graphics.Bitmap bitmap, int meshWidth, int meshHeight,
    ...
    @Override
    public final void drawCircle(float cx, float cy, float radius, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawColor(@ColorInt int color, @NonNull android.graphics.BlendMode mode) {
        nDrawColor(mNativeCanvasWrapper, color, mode.getXfermode().porterDuffMode);
    }

    @Override
    public final void drawColor(@ColorLong long color, @NonNull android.graphics.BlendMode mode) {
    ...
    @Override
    public final void drawLines(@Size(multiple = 4) @NonNull float[] pts, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawOval(@NonNull android.graphics.RectF oval, @NonNull android.graphics.Paint paint) {
        if (oval == null) {
            throw new NullPointerException();
        }
    ...
    @Override
    public final void drawPaint(@NonNull android.graphics.Paint paint) {
        nDrawPaint(mNativeCanvasWrapper, paint.getNativeInstance());
    }

    @Override
    public final void drawPatch(@NonNull android.graphics.NinePatch patch, @NonNull android.graphics.Rect dst,
                                @Nullable android.graphics.Paint paint) {
    ...
    @Override
    public final void drawPatch(@NonNull NinePatch patch, @NonNull android.graphics.RectF dst,
                                @Nullable android.graphics.Paint paint) {
    ...
    @Override
    public final void drawPath(@NonNull android.graphics.Path path, @NonNull android.graphics.Paint paint) {
        nDrawPath(mNativeCanvasWrapper, path.readOnlyNI(), paint.getNativeInstance());
    }

    @Override
    public final void drawPicture(@NonNull android.graphics.Picture picture) {
    ...
    @Override
    public final void drawPicture(@NonNull android.graphics.Picture picture, @NonNull android.graphics.Rect dst) {
        save();
    ...
    @Override
    public final void drawPicture(@NonNull Picture picture, @NonNull android.graphics.RectF dst) {
        save();
        translate(dst.left, dst.top);
        if (picture.getWidth() > 0 && picture.getHeight() > 0) {
    ...
    @Override
    public final void drawPoint(float x, float y, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawPoints(@Size(multiple = 2) @NonNull float[] pts, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawRect(@NonNull Rect r, @NonNull android.graphics.Paint paint) {
        drawRect(r.left, r.top, r.right, r.bottom, paint);
    }

    @Override
    public final void drawRect(@NonNull android.graphics.RectF rect, @NonNull android.graphics.Paint paint) {
    ...
    public final void drawRoundRect(float left, float top, float right, float bottom,
            float rx, float ry, @NonNull android.graphics.Paint paint) {
        nDrawRoundRect(mNativeCanvasWrapper, left, top, right, bottom, rx, ry,
                paint.getNativeInstance());
    }

    @Override
    public final void drawRoundRect(@NonNull android.graphics.RectF rect, float rx, float ry, @NonNull android.graphics.Paint paint) {
        drawRoundRect(rect.left, rect.top, rect.right, rect.bottom, rx, ry, paint);
    }

    @Override
    public final void drawDoubleRoundRect(@NonNull android.graphics.RectF outer, float outerRx, float outerRy,
    ...
    @Override
    public final void drawDoubleRoundRect(@NonNull android.graphics.RectF outer, float[] outerRadii,
                                          @NonNull RectF inner, float[] innerRadii, @NonNull android.graphics.Paint paint) {
        nDrawDoubleRoundRect(mNativeCanvasWrapper,
    ...
    @Override
    public final void drawText(@NonNull String text, float x, float y, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawTextOnPath(@NonNull char[] text, int index, int count, @NonNull android.graphics.Path path,
    ...
    public final void drawVertices(@NonNull VertexMode mode, int vertexCount,
            ...
            int indexCount, @NonNull android.graphics.Paint paint) {
    ...
    @Override
    public final void drawMesh(@NonNull Mesh mesh, android.graphics.BlendMode blendMode, @NonNull Paint paint) {
        if (blendMode == null) {
