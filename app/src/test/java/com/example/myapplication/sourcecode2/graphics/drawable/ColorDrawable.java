...
public class ColorDrawable extends android.graphics.drawable.Drawable {
     ...
     * provided in {@link android.graphics.drawable.Drawable#setAlpha(int)}. Instead this will return the alpha of the color
     ...
     * <p>
     * Only supported on version {@link Build.VERSION_CODES#LOLLIPOP} and
