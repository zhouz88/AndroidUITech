...
public final class FontFamily {
    ...
    public static final class Builder {
        ...
        private final ArrayList<android.graphics.fonts.Font> mFonts = new ArrayList<>();
         ...
         * @param font a font
         */
        public Builder(@NonNull android.graphics.fonts.Font font) {
         ...
         * @return this builder
         */
        public @NonNull Builder addFont(@NonNull android.graphics.fonts.Font font) {
            Preconditions.checkNotNull(font, "font can not be null");
        ...
        private static int makeStyleIdentifier(@NonNull android.graphics.fonts.Font font) {
     ...
     */
    public @NonNull android.graphics.fonts.Font getFont(@IntRange(from = 0) int index) {
