...
public class RippleDrawable extends LayerDrawable {
     ...
     */
    public RippleDrawable(@NonNull ColorStateList color, @Nullable android.graphics.drawable.Drawable content,
            @Nullable android.graphics.drawable.Drawable mask) {
        this(new RippleState(null, null, null), null);
    ...
    static class RippleState extends LayerState {
        ...
        private void applyDensityScaling(int sourceDensity, int targetDensity) {
            if (mMaxRadius != RADIUS_AUTO) {
                mMaxRadius = android.graphics.drawable.Drawable.scaleFromDensity(
